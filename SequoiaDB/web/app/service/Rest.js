...
(function(){
   ...
   sacApp.service( 'SdbRest', function( $q, $rootScope, $location, Loading, SdbFunction ){
      ...
      */
      ...
      g._parseOneJson = function( json_array, str, isParseJson, i, len, errType, errJson )
      {
      ...
      //解析响应的Json
      g._parseJson2 = function( str, isParseJson, errJson )
      {
         var jsonArr = [] ;
         ...
         errType = isArray( errJson ) ;
	      ...
	      while( i < len )
	      {
		      while( i < len )
            {
		      ...
		      i = g._parseOneJson( jsonArr, str, isParseJson, i, len, errType, errJson ) ;
	      }
