...
namespace engine
{
   ...
   /*
      _dcBaseInfo define
   */
   class _dcBaseInfo : public SDBObject
   {
      public:
         _dcBaseInfo() ;
         ~_dcBaseInfo() ;
   ...
   typedef _dcBaseInfo dcBaseInfo ;
   ...
   */
   class _dcMgr :  public SDBObject
   {
      ...
      private:
         ...
         dcBaseInfo                    _baseInfo ;    // this dc base info
