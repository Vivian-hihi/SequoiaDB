...
enum MSG_TYPE
{
   ...
   MSG_SEADPT_Q_REWT_REQ               = 10002,
   MSG_SEADPT_Q_REWT_RES               = MAKE_REPLY_TYPE( MSG_SEADPT_Q_REWT_REQ ),
   MSG_SEADPT_Q_REWT_MORE_REQ          = 10003,
   MSG_SEADPT_Q_REWT_MORE_RES          = MAKE_REPLY_TYPE( MSG_SEADPT_Q_REWT_MORE_REQ ),
