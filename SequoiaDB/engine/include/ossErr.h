...
#define SDB_SEQUENCE_EXIST                 -323  /**< Sequence already exists */
#define SDB_SEQUENCE_NOT_EXIST             -324  /**< Sequence not exists */
#define SDB_SEQUENCE_EXCEEDED              -325  /**< Sequence is exceeded */
#define SDB_DMS_CS_UNIQUEID_CONFLICT       -326  /**< CS uniqueID conflict */
#define SDB_DMS_UNIQUEID_CONFLICT          -327  /**< CL uniqueID conflict */
#define SDB_DMS_CS_REMAIN                  -328  /**< CS uniqueID conflict with remain cs */
#define SDB_DMS_REMAIN                     -329  /**< CL uniqueID conflict with remain cl */
#define SDB_CAT_CS_UNIQUEID_EXCEEDED       -330  /**< CS uniqueID exceeds the maximum */
#define SDB_CAT_CL_UNIQUEID_EXCEEDED       -331  /**< CL uniqueID exceeds the maximum */
#define SDB_AUTOINCREMENT_FIELD_EXIST      -332  /**< Autoincrement field exists on collection */
#define SDB_AUTOINCREMENT_FIELD_NOT_EXIST  -333  /**< Autoincrement field dose not exists on collection */
#endif /* OSSERR_H_ */
