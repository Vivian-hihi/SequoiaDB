...
namespace engine
{
   ...
   /*
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, cond )
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, sel )
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, sort )
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, hint )
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, skip )
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, limit )
   JS_MEMBER_FUNC_DEFINE( _sptDBOptionBase, flags )
   */
   ...
   JS_BEGIN_MAPPING( _sptDBOptionBase, SPT_OPTIONBASE_NAME )
      ...
      /*
      JS_ADD_MEMBER_FUNC( "cond", cond )
      JS_ADD_MEMBER_FUNC( "sel", sel )
      JS_ADD_MEMBER_FUNC( "sort", sort )
      JS_ADD_MEMBER_FUNC( "hint", hint )
      JS_ADD_MEMBER_FUNC( "skip", skip )
      JS_ADD_MEMBER_FUNC( "limit", limit )
      JS_ADD_MEMBER_FUNC( "flags", flags )
      */
   ...
   INT32 _sptDBOptionBase::cond( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      rval.addSelfProperty( SPT_OPTIONBASE_COND_FIELD )->setValue( obj ) ;
   ...
   INT32 _sptDBOptionBase::sel( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      rval.addSelfProperty( SPT_OPTIONBASE_SEL_FIELD )->setValue( obj ) ;
   ...
   INT32 _sptDBOptionBase::sort( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      rval.addSelfProperty( SPT_OPTIONBASE_SORT_FIELD )->setValue( obj ) ;
   ...
   INT32 _sptDBOptionBase::hint( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      rval.addSelfProperty( SPT_OPTIONBASE_HINT_FIELD )->setValue( obj ) ;
   ...
   INT32 _sptDBOptionBase::skip( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      if( !arg.isNull( 0 ) )
      {
         rc = arg.getNative( 0, &numToSkip, SPT_NATIVE_INT32 ) ;
         if( SDB_OK != rc && SDB_OUT_OF_BOUND != rc )
         {
      ...
      rval.addSelfProperty( SPT_OPTIONBASE_SKIP_FIELD )->setValue( numToSkip ) ;
   ...
   INT32 _sptDBOptionBase::limit( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      if( !arg.isNull( 0 ) )
      {
         rc = arg.getNative( 0, &numToRet, SPT_NATIVE_INT32 ) ;
         if( SDB_OK != rc && SDB_OUT_OF_BOUND != rc )
         {
      ...
      rc = rval.setUsrObjectVal< sptDBOptionBase >( this ) ;
      if( SDB_OK != rc )
      {
         detail = BSON( SPT_ERR << "Failed to set ret obj" ) ;
         goto error ;
      }
      rval.addSelfProperty( SPT_OPTIONBASE_LIMIT_FIELD )->setValue( numToRet ) ;
   ...
   INT32 _sptDBOptionBase::flags( const _sptArguments &arg,
                           _sptReturnVal &rval,
                           bson::BSONObj &detail )
   {
      INT32 rc = SDB_OK ;
      ...
      if( !arg.isNull( 0 ) )
      {
         rc = arg.getNative( 0, &flags, SPT_NATIVE_INT32 ) ;
         if( SDB_OK != rc && SDB_OUT_OF_BOUND != rc )
         {
      ...
      rval.addSelfProperty( SPT_OPTIONBASE_FLAGS_FIELD )->setValue( flags ) ;
