...
namespace sdbclient
{
   ...
   */
   ...
   public :
      ...
      virtual INT32 createLobID( bson::OID &oid, INT64 *pSeconds = NULL ) = 0 ;
   ...
   */
   ...
   public :
      ...
      */
      ...
      /** \fn INT32 createLobID( bson::OID &oid )
          \param [in] pSeconds point of seconds since 1970-01-01 00:00:00 UTC.
                               if pSeconds is NULL the seconds will be generted
                               by server
          \param [out] oid The oid generated by server
          \retval SDB_OK Operation Success
          \retval Others Operation Fail
      */
      INT32 createLobID( bson::OID &oid, INT64 *pSeconds = NULL )
      {
         if ( !pCollection )
            return SDB_NOT_CONNECTED ;
         return pCollection->createLobID( oid, pSeconds ) ;
      }
