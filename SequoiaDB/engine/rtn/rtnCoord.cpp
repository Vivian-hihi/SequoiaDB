...
namespace engine
{
   ...
   */
   ...
   RTN_COORD_CMD_ADD( COORD_CMD_LISTUSERS, rtnCoordCMDListUser )
   ...
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTDBINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTSYSINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTCLINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTCSINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTCTXINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTCTXCURINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTSESSINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTSESSCURINTR, rtnCoordCMDSnapshotIntrBase )
   RTN_COORD_CMD_ADD( COORD_CMD_SNAPSHOTCATAINTR, rtnCoordCMDSnapshotCata )
   ...
   RTN_COORD_CMD_ADD( COORD_CMD_ALTER_DC, rtnCoordAlterDC )
   RTN_COORD_CMD_ADD( COORD_CMD_GETDCINFO, rtnCoordGetDCInfo )
