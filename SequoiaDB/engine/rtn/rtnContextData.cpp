...
namespace engine
{
   ...
   */
   ...
   RTN_CTX_AUTO_REGISTER( _rtnContextTSData, RTN_CONTEXT_TS_DATA, "TSDATA")
   _rtnContextTSData::_rtnContextTSData( INT64 contextID, UINT64 eduID )
   : _rtnContextBase( contextID, eduID )
   {
      _eduCB = NULL ;
      _remoteSession = NULL ;
   ...
   std::string _rtnContextTSData::name() const
   {
      return "TSDATA" ;
   }

   RTN_CONTEXT_TYPE _rtnContextTSData::getType() const
   {
      return RTN_CONTEXT_TS_DATA ;
   }

   _dmsStorageUnit* _rtnContextTSData::getSU()
   {
      return NULL ;
   }

   INT32 _rtnContextTSData::open( const rtnQueryOptions &options,
                                  pmdEDUCB *eduCB )
   {
      INT32 rc = SDB_OK ;
   ...
   INT32 _rtnContextTSData::_prepareData( _pmdEDUCB *cb )
   {
      INT32 rc = SDB_OK ;
   ...
   INT32 _rtnContextTSData::_getMoreFromRemote( pmdEDUCB *eduCB )
   {
      INT32 rc = SDB_OK ;
      MsgHeader *msg = NULL ;
      INT32 msgSize = 0 ;
   ...
   INT32 _rtnContextTSData::_sendToRemote( const MsgHeader *msg )
   {
      INT32 rc = SDB_OK ;
   ...
   INT32 _rtnContextTSData::_waitAndProcessRemoteReply()
   {
      INT32 rc = SDB_OK ;
