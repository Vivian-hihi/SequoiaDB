...
namespace engine
{
   ...
   PD_TRACE_DECLARE_FUNCTION ( SDB__RTNSPLIT_INIT, "_rtnSplit::init" )
   ...
   {
      INT32 rc = SDB_OK ;
      PD_TRACE_ENTRY ( SDB__RTNSPLIT_INIT ) ;
      ...
      PD_TRACE_EXITRC ( SDB__RTNSPLIT_INIT, rc ) ;
      return rc ;
   error:
      goto done ;
   }

   PD_TRACE_DECLARE_FUNCTION ( SDB__RTNSPLIT_DOIT, "_rtnSplit::doit" )
   INT32 _rtnSplit::doit ( _pmdEDUCB * cb, _SDB_DMSCB * dmsCB,
                           _SDB_RTNCB * rtnCB, _dpsLogWrapper * dpsCB,
                           INT16 w, INT64 * pContextID )
   {
      INT32 rc = SDB_OK ;
      PD_TRACE_ENTRY ( SDB__RTNSPLIT_DOIT ) ;
      ...
      rc = pClsCB->startTaskCheck ( match ) ;
      PD_TRACE_EXITRC ( SDB__RTNSPLIT_DOIT, rc ) ;
      return rc ;
   }
                               ...
                               INT16 w, INT64 *pContextID )
   {
      ...
      return pmdGetKRCB()->getClsCB()->stopTask( _taskID ) ;
   }
   ...
   PD_TRACE_DECLARE_FUNCTION ( SDB__RTNLINKCL_INIT, "_rtnLinkCollection::init" )
   INT32 _rtnLinkCollection::init ( INT32 flags, INT64 numToSkip,
                                 ...
                                 const CHAR * pHintBuff)
   {
      PD_TRACE_ENTRY ( SDB__RTNLINKCL_INIT ) ;
      INT32 rc = SDB_OK;
      try
      {
         BSONObj arg ( pMatcherBuff ) ;
      ...
      PD_TRACE_EXITRC ( SDB__RTNLINKCL_INIT, rc ) ;
      return rc ;
   error:
      goto done ;
   }
   ...
   PD_TRACE_DECLARE_FUNCTION ( SDB__RTNUNLINKCL_INIT, "_rtnUnlinkCollection::init" )
   INT32 _rtnUnlinkCollection::init ( INT32 flags, INT64 numToSkip,
                                 ...
                                 const CHAR * pHintBuff)
   {
      PD_TRACE_ENTRY ( SDB__RTNUNLINKCL_INIT ) ;
      INT32 rc = SDB_OK;
      try
      {
         BSONObj arg ( pMatcherBuff ) ;
      ...
      PD_TRACE_EXITRC ( SDB__RTNUNLINKCL_INIT, rc ) ;
      return rc ;
   error:
      goto done ;
   }
