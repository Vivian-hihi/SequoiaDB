...
/**
 * @FileName seqDB-11816: insert and pop records in capped CL when primary node is restarted
 * @Author liuxiaoxuan
 * @Date 2017-10-16
 */
public class CurdCappedCLAndRestartMasterNode11816 extends SdbTestBase{

	private GroupMgr groupMgr = null;
	private Sequoiadb sdb = null;
	private boolean isClearEnv = false;
	private DBCollection cappedCL = null;
	private String cappedcsName_11816 = "story_restartNode_cappedcs_11816";
	private String cappedclName_11816 = "restartNode_cappedcl_11816";
	...
	@Test
	public void curdAndRestartNodeTest() {
		try {
			GroupWrapper dataGroup = groupMgr.getGroupByName(dataGroupName);
			NodeWrapper priNode = dataGroup.getMaster();
			
			FaultMakeTask faultMakeTask = NodeRestart.getFaultMakeTask(priNode, 1, 10);
			...
			//check whether the cluster is normal and lsn consistency ,the longest waiting time is 10 minutes
