...
public class Delete12010 extends SdbTestBase {
    private String clName = "ES_cl_delete12010";
    ...
    private String fullIndexName = "fullIndex_delete12010";
    ...
    public void test() {
        ...
        try {
            ...
            if(deleteFlag == true){
                FullTextUtils.checkFullSyncToES(esClient, db, SdbTestBase.csName, clName, fullIndexName, 0);
                actRecords = FullTextDBUtils.getRecordsFromCL(cl, (BSONObject)JSON.parse("{'':{$Text:{query:{match_all:{}}}}}"), 
                             null, (BSONObject)JSON.parse("{_id : 1}"), null, 0, insertNum);
                Assert.assertTrue(actRecords.isEmpty());
            }else{
