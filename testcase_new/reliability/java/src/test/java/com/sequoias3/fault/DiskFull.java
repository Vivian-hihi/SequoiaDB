...
public class DiskFull extends Fault {
	...
	private final String localScriptPath = S3TestBase.scriptDir;
	...
	public DiskFull(String hostName, String padPath) {
		...
		this.user = "root";
		this.passwd = S3TestBase.rootPwd;
		this.padPath = padPath;
		this.remotePath = S3TestBase.workDir;
		this.port = 22;
	 ...
	 * @return
	 */
	public static FaultMakeTask getFaultMakeTask(String hostName, String padPath, int maxDelay, int duration,
			DBCollection sysCataCL, int presetPercent) {
