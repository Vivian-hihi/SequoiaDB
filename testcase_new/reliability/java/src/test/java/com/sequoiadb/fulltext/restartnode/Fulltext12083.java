...
/**
 * @FileName seqDB-12083:创建全文索引时主节点正常重启
 * @Author zhaoyu
 * @Date 2019-08-05
 */

public class Fulltext12083 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String csName = "cs12083";
    private String clName = "cl12083";
    private String indexName = "index12083";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultMakeTask = NodeRestart.getFaultMakeTask(master, 1, 10);
