...
/**
 * @FileName:seqDB-15967：指定自增字段创建集合时catalog主节点异常重启 
 * 测试步骤：指定自增字段创建集合时catalog主节点异常重启2.待集群状态正常后，检查集合信息 
 * 预期结果：1.集合创建失败2.待集群正常后，catalog主备节点上集合及自增字段信息一致；
 * @Author zhaoxiaoni
 * @Date 2018-11-16
 * @Version 1.00
 */
...
public class Create15967 extends SdbTestBase {
	private String clName = "cl_15967";
