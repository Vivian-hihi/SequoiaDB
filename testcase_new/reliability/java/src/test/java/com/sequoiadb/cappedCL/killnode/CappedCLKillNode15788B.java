...
/**
 * @FileName seqDB-15788:插入记录同时主节点异常重启
 * @Author zhaoyu
 * @Date 2019-7-24
 */
public class CappedCLKillNode15788B extends SdbTestBase {

    private GroupMgr groupMgr = null;
    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private DBCollection cl = null;
    private String cappedCLName = "cappedCL_killNode_15788B";
    private String dataGroupName;
    private StringBuffer strBuffer = null;
    private int stringLength = 2000;
