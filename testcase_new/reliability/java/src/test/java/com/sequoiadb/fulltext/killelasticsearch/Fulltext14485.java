...
/**
 * @Description seqDB-14485:删除全文索引时ES异常重启
 * @author yinzhen
 * @date 2019-8-9
 */
public class Fulltext14485 extends SdbTestBase {
    private String clName = "cl14485";
    private String fulltextName = "idx14485";
    ...
    public void test() throws Exception {
        ...
        System.out.println("host: " + node.getHostName() + ":" + node.getPort());
    ...
    private class InsertData extends OperateTask {
        ...
        public void exec() throws Exception {
            ...
            try {
                for (int i = 0; i < 10; i++) {
                    String clName = Fulltext14485.this.clName + "_" + i;
