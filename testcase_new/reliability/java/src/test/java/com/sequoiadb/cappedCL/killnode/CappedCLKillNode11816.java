 ...
 * @Date 2017-10-16
 */
public class CappedCLKillNode11816 extends SdbTestBase{

    private GroupMgr groupMgr = null;
    private Sequoiadb sdb = null;
    private DBCollection cl = null;
    private String clName = "killNode_cappedcl_11816";
    ...
    private class PopTask extends OperateTask{
        ...
        public void exec() throws Exception {
            try (Sequoiadb db = new Sequoiadb(SdbTestBase.coordUrl,"","")) {
                CollectionSpace cs = db.getCollectionSpace(cappedCSName);
                DBCollection cl = cs.getCollection(clName);
                long logicalID = CappedCLUtils.getLogicalID(cl, new Random().nextInt(9000));
                int direction = -1;
