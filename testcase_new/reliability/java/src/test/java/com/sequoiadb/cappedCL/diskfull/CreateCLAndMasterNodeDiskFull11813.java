...
/**
 * @FileName seqDB-11813 creating collection when master node disk is full
 * @author xiejianhong
 * @Date 2017-08-16
 * @version 1.0
 */
public class CreateCLAndMasterNodeDiskFull11813 extends SdbTestBase {
    ...
    private final String CSNAMEBASE = "cs_11813_master";
    private final String CLNAMEBASE = "cs_11813_master";
    ...
    /**
     * 1. make master node disk full
     * 2. loop create capped collection
     * 3. restore master node disk
    ...
    public void test() {
        ...
        try {
            ...
            DiskFull diskFull = new DiskFull(masterNode.hostName(), SdbTestBase.reservedDir,DISKFULL_PRESET_PERCENT);
            diskFull.init();
            diskFull.make();
