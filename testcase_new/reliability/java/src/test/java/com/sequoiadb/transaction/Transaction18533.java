...
/**
 * @Description seqDB-18533:主子表，转账的过程中正常重启转账程序执行的coord节点
 * @author yinzhen
 * @date 2019-6-19
 *
 */
@Test(groups = "rcauto")
public class Transaction18533 extends SdbTestBase {
    private Sequoiadb sdb;
    private Sequoiadb gmrDB;
    private DBCollection cl;
    private String clName = "cl18533";
    ...
    public void setUp() throws ReliabilityException {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub118533");
        sdb.getCollectionSpace(csName).createCollection("sub218533", (BSONObject) JSON
                .parse("{'ShardingKey':{'account':1}, 'ShardingType':'hash', 'AutoSplit':true, 'ReplSize':-1}"));
        cl.attachCollection(csName + ".sub118533",
                (BSONObject) JSON.parse("{LowBound:{'account':{'$minKey':1}}, UpBound:{'account':3000}}"));
        cl.attachCollection(csName + ".sub218533",
