...
/**
 * @FileName:seqDB-15968：指定自增字段创建集合时catalog备节点异常重启
 * 测试步骤：指定自增字段创建集合时catalog备节点异常重启2.待集群状态正常后，插入记录
 * 预期结果：1.集合创建成功，自增字段属性正确，2.待集群正常后，catalog主备节点上集合及自增字段信息一致；
 * @Author zhaoxiaoni
 * @Date 2018-11-16
 * @Version 1.00
 */
...
public class Create15968 extends SdbTestBase {
	...
	public void test() {
		...
		try {
			...
			FaultMakeTask faultTask = KillNode.getFaultMakeTask(cataSlave.hostName(), cataSlave.svcName(), 1);
