...
/**
 * @FileName seqDB-11813:创建集合时，备节点磁盘满
 * @Author liuxiaoxuan
 * @Date 2017-07-31
 */
public class CappedCLSlave11813 extends SdbTestBase {

    private GroupMgr groupMgr = null;
    private Sequoiadb sdb = null;
    private String cappedCSName = "cappedCS_SlaveDIskFull_11813";
    private String cappedCLName = "cappedCL_SlaveDIskFull_11813";
    ...
    public void test() {
        try {
            ...
            FaultMakeTask faultMakeTask = DiskFull.getFaultMakeTask(primaryNode.hostName(), SdbTestBase.reservedDir, 1,
                    10);
