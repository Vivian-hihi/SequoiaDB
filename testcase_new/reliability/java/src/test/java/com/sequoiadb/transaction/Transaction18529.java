...
/**
 * @Description seqDB-18529:主子表，转账的过程中正常部分数据节点主节点断网
 * @author yinzhen
 * @date 2019-6-19
 *
 */
@Test(groups = "rcauto")
public class Transaction18529 extends SdbTestBase {
    private Sequoiadb sdb;
    private DBCollection cl;
    private String clName = "cl18529";
    ...
    public void setUp() throws ReliabilityException {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub118529");
        sdb.getCollectionSpace(csName).createCollection("sub218529", (BSONObject) JSON
                .parse("{'ShardingKey':{'account':1}, 'ShardingType':'hash', 'AutoSplit':true, 'ReplSize':-1}"));
        cl.attachCollection(csName + ".sub118529",
                (BSONObject) JSON.parse("{LowBound:{'account':{'$minKey':1}}, UpBound:{'account':3000}}"));
        cl.attachCollection(csName + ".sub218529",
