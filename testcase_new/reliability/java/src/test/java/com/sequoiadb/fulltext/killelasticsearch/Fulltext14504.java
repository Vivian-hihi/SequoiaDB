...
/**
 * @Description seqDB-14504:删除集合时ES异常重启
 * @author yinzhen
 * @date 2019-8-9
 */
public class Fulltext14504 extends SdbTestBase {
    private String clName = "cl14504";
    private String fulltextName = "idx14504";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask task = KillElasticSearch.geFaultMakeTask(SdbTestBase.esHostName, 1);
    ...
    private class DropCL extends OperateTask {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                for (int i = 0; i < 10; i++) {
                    String clName = Fulltext14504.this.clName + "_" + i;
                    cs.dropCollection(clName);
                }
            } finally {
                db.close();
