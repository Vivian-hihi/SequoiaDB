...
public class CappedCLRestartNode12385 extends SdbTestBase {
    ...
    public void setUp() throws ReliabilityException {
        ...
        cl = cs.createCollection(cappedCLName, (BSONObject) JSON.parse("{Capped:true, Size:10240}"));
    ...
    public void test() throws ReliabilityException {
        ...
        FaultMakeTask faultMakeTask = NodeRestart.getFaultMakeTask(dataGroup.getNodes().get(0),
        ...
        for (int i = 1; i < nodeNum; i++) {
            ...
            for (int j = 0; j < nodeNum; j++) {
                ...
                if (!nodes.contains(nodesi.hostName())) {
                    faultMakeTask = NodeRestart.getFaultMakeTask(nodesi, new Random().nextInt(10), 10);
                    mgr.addTask(faultMakeTask);
