...
public class Transaction18599 extends SdbTestBase {
    ...
    public void setUp() throws ReliabilityException {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub118599");
        sdb.getCollectionSpace(csName).createCollection("sub218599", (BSONObject) JSON
                .parse("{'ShardingKey':{'account':1}, 'ShardingType':'hash', 'AutoSplit':true, 'ReplSize':-1}"));
        mainCL.attachCollection(csName + ".sub118599",
                (BSONObject) JSON.parse("{LowBound:{'account':{'$minKey':1}}, UpBound:{'account':3000}}"));
        mainCL.attachCollection(csName + ".sub218599",
