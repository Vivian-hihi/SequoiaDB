...
/**
 * @Description seqDB-18530:主子表，转账的过程中异常重启所有数据节点主节点
 * @author yinzhen
 * @date 2019-6-19
 *
 */
@Test(groups = "rcauto")
public class Transaction18530 extends SdbTestBase {
    private Sequoiadb sdb;
    private DBCollection cl;
    private String clName = "cl18530";
    ...
    public void setUp() throws ReliabilityException {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub118530");
        sdb.getCollectionSpace(csName).createCollection("sub218530", (BSONObject) JSON
                .parse("{'ShardingKey':{'account':1}, 'ShardingType':'hash', 'AutoSplit':true, 'ReplSize':-1}"));
        cl.attachCollection(csName + ".sub118530",
                (BSONObject) JSON.parse("{LowBound:{'account':{'$minKey':1}}, UpBound:{'account':3000}}"));
        cl.attachCollection(csName + ".sub218530",
