...
/**
 * @FileName seqDB-14476:删除全文索引时数据主节点断网
 * @Author zhaoyu
 * @Date 2019-08-08
 */

public class Fulltext14476 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String csName = "cs14476";
    private String clName = "cl14476";
    private String indexName = "index14476";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultMakeTask = BrokenNetwork.getFaultMakeTask(master.hostName(),
                new java.util.Random().nextInt(10), 10);
    ...
    private class DropIndexThread extends OperateTask {
        ...
        public void exec() throws Exception {
            try (Sequoiadb db = new Sequoiadb(SdbTestBase.coordUrl, "", "")) {
                for (int i = 0; i < clNum; i++) {
                    DBCollection cl = db.getCollectionSpace(csName).getCollection(clName + "_" + i);
