...
public class RestartSlaveNode14407 extends SdbTestBase {
    ...
    public void test() throws Exception {
        ...
        Sequoiadb preSlaveNodeDB = new Sequoiadb(preSlaveHostName, preSlaveSvcName, "", "");
        ...
        cursor = preMasterNodeDB.getCollectionSpace(SdbTestBase.csName).getCollection(this.clName).query(matcher, null,
                null, null);
        count = 0;
        while (cursor.hasNext()) {
            BSONObject obj = cursor.getNext();
