...
public class OperateDataAndMasterNodeDiskFull11819 extends SdbTestBase {
    ...
    /**
     * 1. operating data and master node disk full 2. restore master node disk
     * 3. check whether InsertTask and PopTask worked successfully 4. check
     * whether environment is normal and LSN is consistent 5. check whether data
     * group lsn is consistent
     */
    @Test
    public void test() {
        Sequoiadb db = null;
