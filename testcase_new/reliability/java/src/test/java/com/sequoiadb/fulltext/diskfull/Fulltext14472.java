...
/**
 * @FileName seqDB-14472:创建全文索引时主节点磁盘满
 * @Author zhaoyu
 * @Date 2019-08-05
 */

public class Fulltext14472 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String csName = "cs14472";
    private String clName = "cl14472";
    private String indexName = "index14472";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultMakeTask = DiskFull.getFaultMakeTask(master.hostName(), master.dbPath(), 0, 10);
