...
public class Transaction18645 extends SdbTestBase {
    ...
    public void test() throws ReliabilityException {
        ...
        // 非事务表扫描/索引扫描
        long actCount = cl.getCount(null, (BSONObject) JSON.parse("{'':null}"));
        ...
        actCount = cl.getCount(null, (BSONObject) JSON.parse("{'':'idx18645'}"));
        Assert.assertEquals(actCount, expList.size());
        ...
        actCount = cl2.getCount(null, (BSONObject) JSON.parse("{'':null}"));
        Assert.assertEquals(actCount, expList.size());
        ...
        actCount = cl2.getCount(null, (BSONObject) JSON.parse("{'':'idx18645'}"));
        Assert.assertEquals(actCount, expList.size());
