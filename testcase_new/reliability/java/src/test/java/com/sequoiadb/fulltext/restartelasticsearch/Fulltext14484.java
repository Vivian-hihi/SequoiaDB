...
/**
 * @Description seqDB-14484: 删除全文索引时ES正常重启
 * @author yinzhen
 * @date 2019-8-9
 */
public class Fulltext14484 extends SdbTestBase {
    private String clName = "cl14484";
    private String fulltextName = "idx14484";
    ...
    private class InsertData extends OperateTask {
        ...
        public void exec() throws Exception {
            ...
            try {
                for (int i = 0; i < 10; i++) {
                    String clName = Fulltext14484.this.clName + "_" + i;
