...
public class LobUtil {
    ...
    public static void createLobCsAndCl(String csName, String clName) {
        ...
        createCS(csName);
        BSONObject option = (BSONObject) JSON.parse("{ ShardingKey: { \"age\": 1 }," + " ShardingType: \"hash\", "
                + "Partition: 1024, ReplSize: 1," + " Compressed: true ," + "Group:\"group1\"}");
    ...
    public static List<ObjectId> createAndWriteLob(DBCollection cl, byte[] data) {
        ...
        return createAndWriteLob(cl, data, "YYYYMMDD", 20, 1, sf.format(date));
    }
