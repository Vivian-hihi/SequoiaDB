...
/**
 * @Description seqDB-14491: 数据操作时ES与适配器断网
 * @author yinzhen
 * @date 2019-8-9
 */
public class Fulltext14491 extends SdbTestBase {
    private String clName = "cl14491";
    private String fulltextName = "idx14491";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask task = BrokenNetwork.getFaultMakeTask(SdbTestBase.esHostName, 1, 3);
