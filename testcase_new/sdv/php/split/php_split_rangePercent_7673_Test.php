...
class SplitOper01 extends BaseOperator 
{  
   ...
   {
      $clDB -> split( $groupNames[0], $groupNames[1], 50 );
   }
...
class TestSplit01 extends PHPUnit_Framework_TestCase
{
   ...
   {
      self::$dbh = new SplitOper01();
      
      if( self::$dbh -> commIsStandlone() === false )
      {
         if( self::$groupNames < 2 )
         {
