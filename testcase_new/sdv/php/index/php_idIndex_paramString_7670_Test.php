/****************************************************
@description:      createIdIndex / getIndex / dropIdIndex, cover all parameter
@testlink cases:   seqDB-7669
@input:        1 createCL
               2 createIndex, cover all paramer, $args: array
               3 getIndex
               4 dropIndex
@output:     success
@modify list:
...
class IndexOper03 extends BaseOperator 
{  
   ...
   {
      $arg = json_encode( array( 'SortBufferSize' => 128 ) );
      $clDB -> createIdIndex( $arg );
   }
...
class TestIndex03 extends PHPUnit_Framework_TestCase
{
