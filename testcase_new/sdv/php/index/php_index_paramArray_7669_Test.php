...
class IndexOper06 extends BaseOperator 
{  
   ...
   function explain( $clDB, $idxName )
   {
      ...
      //$cursor = $clDB -> explain( $condition, $selector, $orderby, $hint, $flag, $numToSkip, $numToReturn, $options );
      $errno = $this -> getErrno();
      if( $errno !== 0 )
      {
...
class TestIndex06 extends PHPUnit_Framework_TestCase
{
