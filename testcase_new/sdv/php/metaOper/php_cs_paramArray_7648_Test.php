/****************************************************
@description:      createCS / listCS, cover all param, and type is array
@testlink cases:   seqDB-7645 / seqDB-7650
@input:      1 test_createCS, $options: array
...
class CSOperator04 extends BaseOperator 
{  
...
class TestCS04 extends PHPUnit_Framework_TestCase
{
   ...
   {
      self::$dbh = new CSOperator04();
      
      echo "\n---Begin to ready parameter.\n";
      self::$csName = self::$dbh -> COMMCSNAME."_arr7648";
      self::$clName = self::$dbh -> COMMCLNAME."_arr7648";
