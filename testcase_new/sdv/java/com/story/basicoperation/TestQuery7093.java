...
public class TestQuery7093 extends SdbTestBase{
    ...
    public void setUp() {
        ...
        try {
            ...
            System.out.println("Sequoiadb driver TestQuery7093 setUp error, error description:" + e.getMessage());
    ...
    public void insertData() {
        try{
            ...
            System.out.println("Sequoiadb driver TestQuery7093 insert recods error, error description:" + e.getMessage());
