...
public class TestQuery7086 extends SdbTestBase{
    ...
    public void setUp() {
        ...
        try {
            ...
            System.out.println("Sequoiadb driver TestQuery7086 setUp error, error description:" + e.getMessage());
    ...
    public void checkQuery() {
        ...
        try {
          ...
          Assert.assertEquals(actualList, expectedList, "actualList:" +actualList.toString() 
            ...
            System.out.println("Sequoiadb driver TestQuery7086 checkQuery error, error description:" + e.getMessage());
