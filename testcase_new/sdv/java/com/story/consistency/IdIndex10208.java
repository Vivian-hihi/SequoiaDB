...
/**
* TestLink: seqDB-10208
* @author xiaoni huang init
* @Date   2016.10.20
*/

public class IdIndex10208 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			IdIndex10208 IdIndex10208 = new IdIndex10208();
			IdIndex10208.createMainCL(sdb);
			IdIndex10208.createSubCL(sdb);
			IdIndex10208.attachCL(sdb);
			//create index
	...
	@Parameters({"coordAddr"})
	public void testIndex10208(String coordAddr){
		Sequoiadb db  = null;
