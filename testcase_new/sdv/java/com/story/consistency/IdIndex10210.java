...
/**
* TestLink: seqDB-10210
* @author xiaoni huang init
* @Date   2016.10.17
*/

public class IdIndex10210 {
	...
	@Parameters({"coordAddr"})
	public void testIdIndex10210(String coordAddr){
		Sequoiadb db  = null;
		...
		try{
			...
			clDB.dropIdIndex();
			//check results
			IdIndex10210 IdIndex10210 = new IdIndex10210();
			if( db.isCollectionSpaceExist(csName)){
				IdIndex10210.checkResult(db);
			}
		}catch(BaseException e){
