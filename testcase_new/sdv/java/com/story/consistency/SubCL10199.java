...
public class SubCL10199 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			SubCL10199 SubCL10199 = new SubCL10199();
			SubCL10199.createMainCL(sdb);
			SubCL10199.createSubCL(sdb);
	...
	@Parameters({"coordAddr"})
	public void testSubCL10199(String coordAddr){
		Sequoiadb db  = null;
