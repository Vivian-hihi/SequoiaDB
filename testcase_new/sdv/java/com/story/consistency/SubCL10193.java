...
/**
* TestLink: seqDB-10193
* @author xiaoni huang init
* @Date   2016.10.11
*/

public class SubCL10193 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			SubCL10193 SubCL10193 = new SubCL10193();
			SubCL10193.createMainCL(sdb);
			SubCL10193.createSubCL(sdb);
			SubCL10193.attachCL(sdb);
	...
	@Parameters({"coordAddr"})
	public void testSubCL10193(String coordAddr){
		Sequoiadb db  = null;
		SubCL10193 SubCL10193 = new SubCL10193();
		//-----detachCL-----
		try{
