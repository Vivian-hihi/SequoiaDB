...
/**
* TestLink: seqDB-10190
* @author xiaoni huang init
* @Date   2016.10.14
*/

public class SubCL10190 {
	...
	@Parameters({"coordAddr"})
	public void testSubCL10190(String coordAddr){
		Sequoiadb db  = null;
		//-----create cs/mainCL
		try{
			db = new Sequoiadb(coordAddr, "", "");
			
			SubCL10190 SubCL10190 = new SubCL10190();
			SubCL10190.createSubCL(db);
		}catch(BaseException e){
