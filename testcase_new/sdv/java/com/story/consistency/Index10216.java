...
/**
* TestLink: seqDB-10215
* @author xiaoni huang init
* @Date   2016.10.24
*/

public class Index10216 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			Index10216 Index10216 = new Index10216();
			Index10216.createMainCL(sdb);
			Index10216.createSubCL(sdb);
			Index10216.attachCL(sdb);
			//create index
