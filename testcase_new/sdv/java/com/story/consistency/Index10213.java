...
/**
* TestLink: seqDB-10213
* @author xiaoni huang init
* @Date   2016.10.20
*/

public class Index10213 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			Index10213 Index10213 = new Index10213();
			Index10213.createMainCL(sdb);
			Index10213.createSubCL(sdb);
			Index10213.attachCL(sdb);
