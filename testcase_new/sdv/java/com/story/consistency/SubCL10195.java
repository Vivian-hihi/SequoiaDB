...
/**
* TestLink: seqDB-10195
* @author xiaoni huang init
* @Date   2016.10.17
*/

public class SubCL10195 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			SubCL10195 SubCL10195 = new SubCL10195();
			SubCL10195.createMainCL(sdb);
			SubCL10195.createSubCL(sdb);
			SubCL10195.attachCL(sdb);
	...
	@Parameters({"coordAddr"})
	public void testSubCL10195(String coordAddr){
		Sequoiadb db  = null;
		SubCL10195 SubCL10195 = new SubCL10195();
		//-----detachCL-----
		try{
