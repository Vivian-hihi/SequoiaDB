...
/**
* TestLink: seqDB-10206
* @author xiaoni huang init
* @Date   2016.10.17
*/

public class IdIndex10206 {
	...
	@Parameters({"coordAddr"})
	public void testIndex10206(String coordAddr){
		Sequoiadb db  = null;
		...
		try{
			...
			//check results
			IdIndex10206 IdIndex10206 = new IdIndex10206();
			IdIndex10206.checkResult(db);
		}catch(BaseException e){
