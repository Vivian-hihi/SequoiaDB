...
/**
* TestLink: seqDB-10205
* @author xiaoni huang init
* @Date   2016.10.17
*/

public class Index10205 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			Index10205 Index10205 = new Index10205();
			Index10205.createMainCL(sdb);
			Index10205.createSubCL(sdb);
			Index10205.attachCL(sdb);
	...
	@Parameters({"coordAddr"})
	public void testIndex10205(String coordAddr){
		Sequoiadb db  = null;
		...
		try{
			...
			//check results
			Index10204 Index10204 = new Index10204();
			Index10204.checkResult(db);
		}catch(BaseException e){
