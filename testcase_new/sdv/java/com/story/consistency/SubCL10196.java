...
/**
* TestLink: seqDB-10196
* @author xiaoni huang init
* @Date   2016.10.17
*/

public class SubCL10196 {
	...
	public void setUp(String coordAddr){
		...
		try{
			...
			//create subCL
			SubCL10196 SubCL10196 = new SubCL10196();
			SubCL10196.createMainCL(sdb);
			SubCL10196.createSubCL(sdb);
			SubCL10196.attachCL(sdb);
	...
	@Parameters({"coordAddr"})
	public void testSubCL10196(String coordAddr){
		Sequoiadb db  = null;
		SubCL10196 SubCL10196 = new SubCL10196();
		//-----detachCL-----
		try{
