    ...
    public void test() {
        ...
        try{
            ...
            try{
                ...
                throw new BaseException("cl is created successfully with a wrong parameter 'Compress'");
            }catch(BaseException e){
            ...
            try{
                ...
                throw new BaseException("cl is created successfully with a wrong parameter 'Compression'");
            }catch(BaseException e){
                Assert.assertEquals(e.getErrorCode(), -6, e.getMessage());
            }
        }catch(BaseException e){
