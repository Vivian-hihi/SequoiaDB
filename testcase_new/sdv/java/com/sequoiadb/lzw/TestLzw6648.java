...
public class TestLzw6648 extends SdbTestBase {
    ...
    private String bigStr = Commlib2.getRandomString(1024 * 1024);
    private String smallStr = Commlib2.getRandomString(1024);
    ...
    public void test() {
        ...
        try{
            ...
            Assert.assertEquals(Commlib2.isDictExist(cl, dataGroupName), false, 
