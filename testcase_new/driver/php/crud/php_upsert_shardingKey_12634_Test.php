...
class UpdateShardingKey12634 extends BaseOperator 
{  
   ...
   function upsertRecs( $clDB )
   {
      ...
      $clDB -> upsert( $rule, null, null, null, SDB_FLG_UPDATE_KEEP_SHARDINGKEY );
   } 
...
class TestUpdateShardingKey12634 extends PHPUnit_Framework_TestCase
{
   ...
   public static function setUpBeforeClass()
   {
      ...
      self::$dbh = new UpdateShardingKey12634();
      
      if( self::$dbh -> commIsStandlone() === false )
      {      
         echo "\n---Begin to ready parameter.\n";
         self::$csName = self::$dbh -> COMMCSNAME;
         self::$clName = self::$dbh -> COMMCLNAME.'12634';
   ...
   public static function tearDownAfterClass()
   {
      ...
      echo "\n---Test 12634 spend time: " . ( self::$endTime - self::$beginTime ) . " seconds.\n";
   }
