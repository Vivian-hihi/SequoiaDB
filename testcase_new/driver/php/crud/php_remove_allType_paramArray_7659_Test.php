...
class DataOperator11 extends BaseOperator 
{  
...
class TestData11 extends PHPUnit_Framework_TestCase
{
   ...
   public static function setUpBeforeClass()
   {
      ...
      self::$dbh = new DataOperator11();
      
      echo "\n---Begin to ready parameter.\n";
      self::$csName = self::$dbh -> COMMCSNAME;
      self::$clName = self::$dbh -> COMMCLNAME . '_7659_01';
   ...
   public static function tearDownAfterClass()
   {
      ...
      echo "\n---Test 7659_01 spend time: " . ( self::$endTime - self::$beginTime ) . " seconds.\n";
   }
