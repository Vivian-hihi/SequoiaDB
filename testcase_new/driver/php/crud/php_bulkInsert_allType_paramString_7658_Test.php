/****************************************************
@description:      bulkInsert, cover all parameter
@testlink cases:   seqDB-7657
@input:        1 test_createCL
               2 bulkInsert, $records: string, cover all data type:
...
class DataOperator02 extends BaseOperator 
{  
   ...
   function insertRecs( $clDB )
   {
      ...
      $clDB -> bulkInsert( $recsArray, SDB_FLG_INSERT_CONTONDUP );
...
class TestData02 extends PHPUnit_Framework_TestCase
{
   ...
   public static function setUpBeforeClass()
   {
      ...
      self::$dbh = new DataOperator02();
      
      echo "\n---Begin to ready parameter.\n";
      self::$csName = self::$dbh -> COMMCSNAME;
      self::$clName = self::$dbh -> COMMCLNAME . '_7658_02';
   ...
   public static function tearDownAfterClass()
   {
      ...
      echo "\n---Test 7658_02 spend time: " . ( self::$endTime - self::$beginTime ) . " seconds.\n";
   }
}
?>