...
class AggregateOper02 extends BaseOperator 
{  
   ...
   {
      $aggrObj = array( '{$sort:{no:1}}', 
                        '{$project:{no:1,score:1,name:1}}', 
                        '{$match:{score:80}}', 
                        '{$limit:4}', 
                        '{$skip:1}', 
...
class testAggregate02 extends PHPUnit_Framework_TestCase
{
   ...
   public static function setUpBeforeClass()
   {
      ...
      self::$dbh = new AggregateOper02();
      
      echo "\n---Begin to ready parameter.\n";
      self::$csName = self::$dbh -> COMMCSNAME;
      self::$clName = self::$dbh -> COMMCLNAME . '_7679String';
   ...
   public static function tearDownAfterClass()
   {
      ...
      echo "\n---Test 7679 String spend time: " . ( self::$endTime - self::$beginTime ) . " seconds.\n";
   }
