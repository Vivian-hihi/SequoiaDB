...
@input:        1 test_createCL
               ...
               4 update, with condition cover all data type, $rule/$condition: array
...
class DataOperator14 extends BaseOperator 
{  
...
class TestData14 extends PHPUnit_Framework_TestCase
{
