...
@input:        1 test_createCL
               ...
               4 upsert, with condition cover all data type, $rule/$condition: string
...
class DataOperator17 extends BaseOperator 
{  
...
class TestData17 extends PHPUnit_Framework_TestCase
{
   ...
   public static function setUpBeforeClass()
   {
      ...
      self::$dbh = new DataOperator17();
      
      echo "\n---Begin to ready parameter.\n";
      self::$csName = self::$dbh -> COMMCSNAME;
      self::$clName = self::$dbh -> COMMCLNAME . '_7661_02';
   ...
   public static function tearDownAfterClass()
   {
      ...
      echo "\n---Test 7661_02 spend time: " . ( self::$endTime - self::$beginTime ) . " seconds.\n";
   }
