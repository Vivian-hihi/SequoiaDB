...
class CSOperator15156_01 extends BaseOperator 
{  
...
class TestCS15156_01 extends PHPUnit_Framework_TestCase
{
   ...
   {
		echo "\n---Begin to run[seqDB-15156_01].\n"; 
      self::$dbh = new CSOperator15156_01();
      
      if( self::$dbh -> commIsStandlone() === false )
		{      
			echo "   Begin to ready parameter.\n";
			self::$dmName1 = self::$dbh -> COMMDOMAINNAME .'_15156_01_01';
			self::$dmName2 = self::$dbh -> COMMDOMAINNAME .'_15156_01_02';
			self::$csName = self::$dbh -> COMMCSNAME.'_15156_01';
			self::$clName = 'cl_15156_01';
   ...
   {
      echo "\n---Begin to alter[Domain, PageSise, LobPageSize].\n"; 
      $options = array( 'Domain' => self::$dmName2, 'PageSize' => 4096, 'LobPageSize' => 4096 );
