/****************************************************
@description:      listCS / listCL / listGroups, cover all param, and type is string
...
class DomainOper05 extends BaseOperator 
{  
   ...
   {
      $options = json_encode( array( 'Domain' => $dmName ) );
...
class TestDomain05 extends PHPUnit_Framework_TestCase
{
