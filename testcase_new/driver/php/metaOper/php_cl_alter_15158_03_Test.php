/****************************************************
@description:      cl, alter, nomar cl, batch modify attributes
@testlink cases:   seqDB-15158_03
@input:      alter[ReplSize, ShardingKey, ShardingType, AutoSplit, EnsureShardingIndex, 
...
class CSOperator15158_03 extends BaseOperator 
{  
...
class TestCS15158_03 extends PHPUnit_Framework_TestCase
{
   ...
   function test_alterCL01()
   {
      echo "\n---Begin to setAttributes, cover all valid attributes.\n"; 
		$options = '{ Alter:[ {Name:"set attributes", Args:{ReplSize:7, Compressed:true, CompressionType:"lzw", StrictDataMode:true}}, {Name:"set attributes", Args:{Name:"test15221"}}, {Name:"set attributes", Args:{ShardingKey:{a:1}, ShardingType:"hash", Partition:2048, AutoSplit:true, EnsureShardingIndex:false}} ], Options:{IgnoreException:true} }'; //true
   ...
   function test_alterCL02()
   {
      echo "\n---Begin to setAttributes, cover all valid attributes.\n"; 
		$options = '{ Alter:[ {Name:"set attributes", Args:{ReplSize:1}}, {Name:"set attributes", Args:{Test:"test15221"}}, {Name:"set attributes", Args:{Partition:1024}} ], Options:{IgnoreException:false} }'; //false
      self::$dbh -> alterCL( self::$clObj, $options );
      ...
      $this -> assertEquals( 0, self::$dbh -> getErrno() );
      $this -> assertEquals( self::$csName.'.'.self::$clName,  $clInfo["Name"] );		
      //$this -> assertEquals( 1, $clInfo["ReplSize"] );
      $this -> assertEquals( 2048, $clInfo["Partition"] );
   }
