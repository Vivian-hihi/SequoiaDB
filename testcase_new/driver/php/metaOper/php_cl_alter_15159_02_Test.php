/****************************************************
@description:      cl, setAttributes, capped cl
@testlink cases:   seqDB-15159_02
@input:      setAttributes[Size, Max, OverWrite]
@output:     fail: name
				 success
@modify list:
...
class CSOperator15159_02 extends BaseOperator 
{  
...
class TestCS15159_02 extends PHPUnit_Framework_TestCase
{
   ...
   {
		echo "\n---Begin to run[seqDB-15159_02].\n"; 
      self::$dbh = new CSOperator15159_02();
      
      if( self::$dbh -> commIsStandlone() === false )
		{      
			echo "   Begin to ready parameter.\n";
			self::$csName = self::$dbh -> COMMCSNAME."_15159_02";
			self::$clName = 'cl_15159_02';
