...
@input:        1 createCL
               2 insert, data type is numberLong
...
class NumerLongType02 extends BaseOperator 
{  
   ...
   {
      // numberLong's minValue/maxValue
...
class TestNumberLong02 extends PHPUnit_Framework_TestCase
{
