...
@input:        1 createCL 
               2 insert records
               3 split, range, cover required parameter[$sourceGroup, $targetGroup, $condition]
...
class SplitOper03 extends BaseOperator 
{  
   ...
   function split( $clDB, $groupNames )
   {
      ...
      $clDB -> split( $groupNames[0], $groupNames[1], $condition );
   }
...
class TestSplit03 extends PHPUnit_Framework_TestCase
{
