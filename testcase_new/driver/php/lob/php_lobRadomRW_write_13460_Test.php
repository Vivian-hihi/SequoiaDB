...
class LobTest13460 extends PHPUnit_Framework_TestCase
{
   ...
   private static $db;
   private static $cl;
   private static $csName = "php13460";
   ...
   public function test_writeLob()
   {
      ...
      $lobObj2 = self::$cl -> openLob( self::$oid, SDB_LOB_READ );
      $this -> assertEquals( -317, self::$db -> getError()['errno'] );
