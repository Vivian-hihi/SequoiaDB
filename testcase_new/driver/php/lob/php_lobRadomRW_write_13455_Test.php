...
class LobTest13455 extends PHPUnit_Framework_TestCase
{
   ...
   private static $db;
   private static $cl;
   private static $csName = "php13455";
   ...
   public function test_writeLob01()
   {
   ...
   public function test_writeLob02()
   {
      echo "\n---Begin to write lob[ lockAndseek ].\n"; 
