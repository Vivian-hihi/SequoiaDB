...
class LobTest13453 extends PHPUnit_Framework_TestCase
{
   ...
   private static $db;
   private static $cl;
   private static $csName = "php13453";
   ...
   {
      echo "\n---Begin to write lob[ unlock, seek ].\n"; 
      $offset = 50;
      $writeLen2 = 20;
      $whence = SDB_LOB_SET;
      ...
      $oldPreStr = subStr( self::$writeStr, 0, $offset );      
      $newStr = $writeStr2;
      
      $oldEndStrLen = self::$writeLen - ( $offset + $writeLen2 );
      $oldEndStr = subStr( self::$writeStr, $offset + $writeLen2, $oldEndStrLen );
      
      $readStr = $oldPreStr.$writeStr2.$oldEndStr;
