# @decription: analyze all
# @testlink:   seqDB-14214
# @interface:  analyze(self)
...
class TestAnalyzeAll14214(testlib.SdbTestBase):
   def setUp(self):
      # skip standalone
      ...
      self.cs_name1 = 'testanalyzecs14214_1'
      self.cs_name2 = 'testanalyzecs14214_2'
   ...
   def test_analyze_all_14214(self):
      # get groups
      ...
      # create CLs
      cl_name11 = 'cll14214_11'
      cl_name12 = 'cll14214_12'
      cl_name21 = 'cll14214_21'
      cl_name22 = 'cll14214_22'
      ...
      self.cl2 = self.cs1.create_collection(cl_name21, {'ReplSize': 0})
      options = {'Group': src_groupname, 'ShardingKey' : {'a' : 1}, 'ShardingType': 'range', 'ReplSize': 0}
      self.rangecl = self.cs1.create_collection(cl_name22, options)
      ...
      print('------check explain success after analyze------') 
