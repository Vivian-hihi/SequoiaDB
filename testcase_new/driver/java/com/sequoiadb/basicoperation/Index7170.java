...
public class Index7170 extends SdbTestBase{
	...
	public void test(){
		...
		CollectionSpace csConcurrency = sdbConcurrency.getCollectionSpace(commCSName);
	...
	public void createIndex(DBCollection cl, int dataNum){
		...
		try{
			...
			if(e.getErrorCode() != -247){
				Assert.fail("create or drop index name : " + indexName +" failed, errMsg:" + e.getMessage());
	 		}
		}
	}
	...
	public void insertData(DBCollection cl,int dataNum ){
		...
		try{
			...
			Assert.fail("insert data:"+ dataObj + " failed, errMsg:" + e.getMessage());
		}
	}
	...
	public void updateData(DBCollection cl,int dataNum){
		...
		try{
			...
			Assert.fail("update data:"+ modifier + " failed, errMsg:" + e.getMessage());
		}
	}
	...
	public void deleteData(DBCollection cl,int dataNum){
		...
		try{
			...
			Assert.fail("delete data:"+ match + " failed, errMsg:" + e.getMessage());
		}
	}
