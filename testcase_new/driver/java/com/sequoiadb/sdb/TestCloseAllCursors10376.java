...
public class TestCloseAllCursors10376 extends SdbTestBase{
    ...
    public void testCloseAllCursors() {
        ...
        try {
            ...
            Assert.fail("Sequoiadb driver TestCloseAllCursors10376 testServerAddress should fail!");
        } catch (BaseException e) {
        ...
        try {
            ...
            Assert.fail("Sequoiadb driver TestCloseAllCursors10376 testReleaseResource should fail!");
        } catch (BaseException e) {
            Assert.assertEquals(e.getErrorCode(), -36);
        }
