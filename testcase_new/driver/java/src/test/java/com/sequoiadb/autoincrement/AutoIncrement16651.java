...
public class AutoIncrement16651 extends SdbTestBase{
    ...
    public void CreateAutoIncrementCL(){
    	...
    	BSONObject autoIncrementInfo = Commlib.GetAutoIncrement(sdb, SdbTestBase.csName + "." + clName);
    	Assert.assertEquals(autoIncrementInfo.get("Field").toString(), "number16651");
