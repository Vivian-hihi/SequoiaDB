...
public class ParseCipherFile17880 extends SdbTestBase {
    ...
    private void cleanEnvAndPrepare() throws Exception {
        ...
        Util.createPasswdFile(usernames[2], passwords[2], passwdFileName, tokens[0]);
        Util.createPasswdFile(usernames[3], passwords[3], passwdFileName, tokens[1]);
        Util.createPasswdFile(usernames[4], passwords[4], passwdFileName, tokens[2]);
