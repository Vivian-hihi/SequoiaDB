...
/**
* FileName: TestDeleteToJson7162.java
* test interface:
* delete (String matcher,String hint);
* and test:match records not exist
* @author wuyan
    * @Date    2016.9.22
* @version 1.00
*/
	...
	*/
	...
	public void deleteData(){
		try{
		    ...
		    //check record delete,query match not to record :{str:'test_1',no:1}
