...
/**
* FileName: TimestampTestEquals10345.java* 
* test interface:
* equals (Object obj)
...
public class TimestampTestEquals10345 extends SdbTestBase{
	...
	public void testGetDateAndToString() {
		try{
			...
			Assert.assertEquals(timestamp.equals(timestamp),true,"check timestamp self fail");
			Assert.assertEquals(timestamp.equals(timestamp1),true,"check timestamp self fail");
			Assert.assertEquals(timestamp.equals(obj.get("time")),false,"check the get object");
			Assert.assertEquals(timestamp.equals(null),false,"check null fail");			        
		}catch(BaseException  e){
