...
/**
* FileName: TestLockLobInterfaceParameter13407.java
* test content:lock lob interface parameter checking,test interface:lock()/lockAndSeek()
* testlink case:seqDB-13407/13408
* @author wuyan
    * @Date    2017.11.23
* @version 1.00
*/
