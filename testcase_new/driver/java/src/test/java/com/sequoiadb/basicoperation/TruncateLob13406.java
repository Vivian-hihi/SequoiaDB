...
/**
* FileName: TruncateLob13406.java
* test content:truncate the lob,test the interface:truncateLob() 
* testlink case:seqDB-13406
* @author wuyan
    * @Date    2017.11.23
* @version 1.00
*/
public class TruncateLob13406 extends SdbTestBase {
	...
	private void checkResult( DBCollection cl, ObjectId oid, byte[] lobBuff, int truncateLength) {
