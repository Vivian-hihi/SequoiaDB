...
/**
* FileName: TruncateLobInterfaceParameter13409.java
* test content:truncate lob interface parameter checking,test interface:truncateLob()
* testlink case:seqDB-13409
* @author wuyan
    * @Date    2017.11.23
* @version 1.00
*/
public class TruncateLobInterfaceParameter13409 extends SdbTestBase {
	...
	public void testLob(){	
		...
		try{
			...
			Assert.assertEquals(-4,e.getErrorCode(),e.getErrorCode()+e.getMessage());
		}		
	}
