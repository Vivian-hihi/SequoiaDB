...
/**
* FileName: SeekAndWriteLob13403.java
* test content:seek to write lob of create only mode ,than read lob of read mode
* testlink case:seqDB-13403
* @author wuyan
    * @Date    2017.11.23
* @version 1.00
*/
public class SeekAndWriteLob13403 extends SdbTestBase {	
	...
	private void readAndcheckResult( ObjectId oid, byte[] rewriteBuff,int offset,int rewriteoffset) {
		testLobBuff = Commlib.appendBuff(testLobBuff, rewriteBuff, rewriteoffset-offset);
