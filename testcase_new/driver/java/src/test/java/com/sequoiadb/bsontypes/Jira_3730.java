...
public class Jira_3730 extends SdbTestBase{
    ...
    public void jira_3348_BsonTimestampTest()
    {
        ...
        int secmin = 0;
        int secmax = 999999;
        BSONObject insertor1 = new BasicBSONObject("a", new BSONTimestamp(maxIntSec, secmax)).append( "b", 1);
        BSONObject insertor2 = new BasicBSONObject("a", new BSONTimestamp(maxIntSec, secmin)).append( "b", 2);
        BSONObject insertor3 = new BasicBSONObject("a", new BSONTimestamp(minIntSec, secmax)).append( "b", 3);
        BSONObject insertor4 = new BasicBSONObject("a", new BSONTimestamp(minIntSec, secmin)).append( "b", 4);
        BSONObject insertor5 = new BasicBSONObject("a", new BSONTimestamp(minIntSec, -1)).append( "b", 5);
        BSONObject insertor6 = new BasicBSONObject("a", new BSONTimestamp(minIntSec, 1000000)).append( "b", 6);
        BSONObject insertor7 = new BasicBSONObject("a", new BSONTimestamp(maxIntSec, -1)).append( "b", 7);
        BSONObject insertor8 = new BasicBSONObject("a", new BSONTimestamp(maxIntSec, 1000000)).append( "b", 8);
        cl.insert(insertor1);
        cl.insert(insertor2);
        cl.insert(insertor3);
        cl.insert(insertor4);
