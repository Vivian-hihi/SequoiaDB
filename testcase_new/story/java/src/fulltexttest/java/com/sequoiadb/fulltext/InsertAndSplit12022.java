...
/**
 * @Description seqDB-12022:hash切分表中创建全文索引并插入记录后再切分 
 * @author xiaoni Zhao
 * @date 2018/11/23
 */
public class InsertAndSplit12022 extends SdbTestBase {
	private Sequoiadb sdb = null;
	private DBCollection cl;
	private String clName = "cl_12022";
	private String fullTextIndexName = "fullIndex12022";
