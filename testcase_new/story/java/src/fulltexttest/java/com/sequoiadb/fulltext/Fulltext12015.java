...
public class Fulltext12015 extends SdbTestBase {
    ...
    public void test() throws Exception {
        ...
        Assert.assertTrue(
                FullTextUtils.isMainCLIndexCreated(esClient, maincl, textIndexName, FullTextUtils.INSERT_NUMS + 10000));

        // delete
        remove(maincl);
        Assert.assertTrue(FullTextUtils.isMainCLIndexCreated(esClient, maincl, textIndexName, (int) maincl.getCount()));
