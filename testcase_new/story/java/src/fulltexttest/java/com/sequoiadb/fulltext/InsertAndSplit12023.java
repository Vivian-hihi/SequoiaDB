...
/**
 * @Description seqDB-12023:range切分表中创建全文索引并插入记录后再切分
 * @author xiaoni Zhao
 * @date 2018/11/23
 */
public class InsertAndSplit12023 extends SdbTestBase {
	private Sequoiadb sdb = null;
	private DBCollection cl;
	private String clName = "cl_12023";
	private String fullTextIndexName = "fullIndex12023";
    ...
    public void test() {
		...
		Assert.assertEquals(srcCount, desCount, "Split count is wrong!");
