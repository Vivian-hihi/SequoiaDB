...
public class FullTextDBUtils {
     ...
     /**
      * @param cl
      * @param textIndexName bug#SEQUOIADBMAINSTAREM-3778：drop full index will cause
      *                      error -147 sometimes
      */
     ...
     /**
      * @param db
      * @param csName bug#SEQUOIADBMAINSTAREM-3778：drop cs contains full index will
     ...
     /**
      * @param cs
      * @param clName bug#SEQUOIADBMAINSTAREM-3778：drop cl contains full index will
      *               cause error -147 sometimes
      */
