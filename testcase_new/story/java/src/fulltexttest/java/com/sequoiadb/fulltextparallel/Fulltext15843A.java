...
public class Fulltext15843A extends SdbTestBase {
    ...
    public void test() throws Exception {
        ...
        // TODO :单个全文索引调用获取单个全文索引的方法，其他用例一并检查修改
    ...
    class DropTextIndexThread extends ResultStore {
        ...
        public void dropTextIndex() {
            ...
            try (Sequoiadb sdb = new Sequoiadb(SdbTestBase.coordUrl, "", "")) {
                ...
                // TODO
                // :这里应该要捕获异常，删除全文索引，不一定会成功，导致用例随机失败，这里应该要设置线程返回值吧，删除成功则判断索引被删除，删除失败，则判断记录正确
    ...
    class CurdThread {
        ...
        // TODO
        // :确认不是并发的，需要分开写多个class，而且，这里如果是并发的话，为什么可以用同一个连接？在本地调试的时候，添加的打印信息是并发的吗？
