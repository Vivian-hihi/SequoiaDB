...
public class DropCollectionSpace12065 extends SdbTestBase {
    ...
    public void test() {
        ...
        this.cl.createIndex(fullIndexName, "{\"a\":\"text\",\"b\":\"text\",\"c\":\"text\",\"d\":\"text\",\"e\":\"text\",\"f\":\"text\"}", false, false);
        ...
        FullTextUtils.checkConsistency(sdb, csName12065, clName);
        ...
        try {
            for(int i = 0; i < 100; i++) {
                for(int j = 0; j < insertNums/100; j++) {
                    BSONObject record = (BSONObject) JSON.parse("{a: 'test_12065_" + i*j + "', b: '" + FullTextUtils.getRandomString(32)
