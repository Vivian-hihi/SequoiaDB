...
/**
* FileName: CurdProcessingIndex14376.java
* test content: 正在处理固定集合中记录，插入/修改/删除/查询集合中的记录  
* @author liuxiaoxuan
    * @Date    2018.11.21
*/
           ...
           try {
                for(int i = 0; i < 100; i++){
                    for (int j = 0; j < insertNums/100; j++) {
                         insertObjs.add((BSONObject) JSON.parse("{a: 'test_14376_" + i*j + "', b: '" + FullTextUtils.getRandomString(32)
