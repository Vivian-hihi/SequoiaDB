...
public class Fulltext12127 extends SdbTestBase {
    ...
    public void setUp() {
        ...
        // TODO :是否可以优化成，创建集合空间，在该集合空间下创建集合，集合下创建索引及插入记录，时不是2个for循环就可以解决了？
    ...
    public void test() throws Exception {
        ...
        // TODO :不能通过for循环去添加线程吗？csNames和clNames的定义为什么要有关联？
        // TODO :删除集合及删除全文索引的线程不一定会成功吧？
        // TODO :删除的集合中存在全文索引，同时删除全文索引；创建集合及创建全文索引应该在不同的集合上执行，按照这个逻辑重写用例；
