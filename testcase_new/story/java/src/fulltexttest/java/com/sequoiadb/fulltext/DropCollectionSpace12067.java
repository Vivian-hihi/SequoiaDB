...
public class DropCollectionSpace12067 extends SdbTestBase {
    ...
    public void test() {
        ...
        cl1.createIndex(fullIndexName, "{\"a\":\"text\",\"b\":\"text\",\"c\":\"text\",\"d\":\"text\",\"e\":\"text\",\"f\":\"text\"}", false, false);
        this.insertData(cl1, FullTextUtils.INSERT_NUMS);
        cl2.createIndex(fullIndexName, "{\"a\":\"text\",\"b\":\"text\",\"c\":\"text\",\"d\":\"text\",\"e\":\"text\",\"f\":\"text\"}", false, false);
        this.insertData(cl2, FullTextUtils.INSERT_NUMS);
        cl3.createIndex(fullIndexName, "{\"a\":\"text\",\"b\":\"text\",\"c\":\"text\",\"d\":\"text\",\"e\":\"text\",\"f\":\"text\"}", false, false);
        ...
        try {
            for(int i = 0; i < 100; i++) {
                for(int j = 0; j < insertNums/100; j++) {
                    BSONObject record = (BSONObject) JSON.parse("{a: 'test_12067_" + i*j + "', b: '" + FullTextUtils.getRandomString(32)
