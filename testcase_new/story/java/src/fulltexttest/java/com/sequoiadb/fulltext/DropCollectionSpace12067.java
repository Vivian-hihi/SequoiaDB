...
public class DropCollectionSpace12067 extends SdbTestBase {
     ...
     public void test() {
          ...
          FullTextUtils.checkFullSyncToES(esClient, sdb, csName12067, clName1, fullIndexName,
          ...
          FullTextUtils.checkFullSyncToES(esClient, sdb, csName12067, clName2, fullIndexName,
                    FullTextUtils.INSERT_NUMS);
          ...
          FullTextUtils.checkFullSyncToES(esClient, sdb, csName12067, clName3, fullIndexName,
                    FullTextUtils.INSERT_NUMS);
