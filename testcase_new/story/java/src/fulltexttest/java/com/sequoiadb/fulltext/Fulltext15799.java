...
public class Fulltext15799 extends SdbTestBase {
    ...
    public void test() {
        ...
        DBCollection cl = cs.createCollection( subCLName2, (BSONObject) JSON
        ...
        Assert.assertTrue(
                FullTextUtils.isMainCLFullSyncToES( esClient, mainCL, fullIndexName, FullTextUtils.INSERT_NUMS ) );

        try {
            mainCL.truncate();
            Assert.assertTrue( FullTextUtils.isMainCLFullSyncToES( esClient, mainCL, fullIndexName, 0 ) );
