...
/**
 * FileName: Fulltext12018.java test content: 插入记录并执行hash切分再创建全文索引
 * 
 * @author liuxiaoxuan
 * @Date 2018.11.20
 */
public class Fulltext12018 extends SdbTestBase {
    ...
    public void test() throws Exception {
        ...
        Assert.assertEquals(FullTextESUtils.getCountFromES(esClient, srcESIndexName) - 1, srcCL.getCount());
        Assert.assertEquals(FullTextESUtils.getCountFromES(esClient, destESIndexName) - 1, destCL.getCount());
    }
