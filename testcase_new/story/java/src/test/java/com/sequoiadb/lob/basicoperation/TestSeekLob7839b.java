...
/**
 * @Description seqDB-7839:lob seek:seek read lob from more than one group testlink case:seqDB-7839
 * @author wuyan
 * @Date 2017.12.19
 * @version 1.00
 */
...
public class TestSeekLob7839b extends SdbTestBase {
    ...
    public void setUp() {
        ...
        BSONObject options = (BSONObject) JSON
                .parse("{ShardingKey:{a:1,b:-1}," + "ShardingType:'hash',Partition:4096,ReplSize:0}");
