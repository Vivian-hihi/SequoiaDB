...
/**
* FileName: DivideIsSelector12576.java
* test content:Numeric value overflow for single character using $divide operation,
* 				and the $divide is used as a selector.
* testlink case:seqDB-12576
* @author wuyan
    * @Date    2017.9.11
* @version 1.00
*/
...
public class DivideIsSelector12576 extends SdbTestBase{
	...
	public Object[][] generateDatas(){
		...
		return new Object[][]{
			//the parameters: matcherValue,subValue,selectorName,expRecords,expType,isVerifyTypeTojava,expTypeToJava
			//---int32 and int32
			...
			new Object[]{1, -1, "no.$[0]",expRecords2,expLongType,false,null},			
			//array: no.$[1].$[0] / -1,the result is 2147483648(int64)
			//new Object[]{3, -1, "no.$[1].$[0]",expRecords3,expLongType,true},	
			//the obj  obj.a / -1,the result is 2147483648(int64)
			new Object[]{1, -1, "obj.a",expRecords4,expLongType,false,null},	
			//the obj obj.a.b.int /-1 ,the result is 2147483648(int64)
			new Object[]{2, -1, "obj.a.b.int",expRecords5,expLongType,false,null},
			//not divisible:33/4=8
			new Object[]{2, 4, "no",expRecords6,expLongType,false,null},
			
			//---int64 and int64
			//-9223372036854775808 / -1,the result is {'$decimal':'9223372036854775808'}
			...
			new Object[]{1, new Long(-1), "no.$[1]",expRecords02,expDecimalType,false,null},
			//the obj obj.a.b.long /-1,the result is {'$decimal':'9223372036854775808'}
			new Object[]{2, new Long(-1), "obj.a.b.long",expRecords03,expDecimalType,false,null},
			//the arr.1 of obj:obj.a.$[1] /-1 ,the result is {'$decimal':'9223372036854775808'}
			new Object[]{3, new Long(-1), "obj.a.$[1]",expRecords04,expDecimalType,false,null},			
		};
	}	
