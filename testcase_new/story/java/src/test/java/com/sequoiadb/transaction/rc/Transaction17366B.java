...
public class Transaction17366B extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17366B_1',a:2,b:2,c:2}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17366B_2',a:1,b:1,c:1}");
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] { { "{'a': 1}", expReadList1 }, { "{'a': 1, b: 1}", expReadList1 },
                { "{'a': 1, b: -1}", expReadList1 }, { "{'a': -1}", expReadList2 },
                { "{'a': -1, b: 1}", expReadList2, }, { "{'a': -1, b: -1}", expReadList2 },
