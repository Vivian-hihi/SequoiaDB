...
/**
 * @FileName seqDB-13247: 多次锁定写lob，其中不连续范围重复写入为连续数据段 
 * @Author linsuqiang
 * @Date 2017-11-08
 * @Version 1.00
 */
...
/*
 * 1、打开已存在lob对象 
 * 2、多次执行锁定（lockAndSeek）、写lob操作，其中锁定数据段范围不连续，如写入范围分别为1-4/6-8/11-12 
 * 3、多次执行锁定、写lob操作，其中锁定数据段写入后为连续数据，如写入范围分别为5/9-10 
 * 4、读取lob数据，检查lob数据操作结果
 */

public class LockAndWrite13247 extends SdbTestBase {
