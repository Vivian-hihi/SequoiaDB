...
public class BigRecordRead17161 extends SdbTestBase {
    ...
    public void test(){
		...
		//事务1对同一条记录执行多个操作
		cl1.insert("{_id:3, a:'aaaaaa', b:3}");
		BSONObject insertR2 = (BSONObject)JSON.parse("{_id:2, a:'bbbbbbbb', b:2}");
		cl1.insert(insertR2);
		...
		cl1.delete("{_id:3}","{'':'a'}");
		BSONObject updateR1 = (BSONObject)JSON.parse("{_id:1,a:'cccccccc',b:1}");
