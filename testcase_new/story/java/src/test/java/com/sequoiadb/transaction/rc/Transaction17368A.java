...
public class Transaction17368A extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17368A_1',a:1,b:1,c:1}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17368A_2',a:2,b:2,c:2}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17368A_2',a:3,b:3,c:2}");
    }
