...
public class Transaction17765F extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17765F_1',a:3,b:3}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17765F_2',a:2,b:2}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17765F_1',a:1,b:1}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17765F_2',a:5,b:5}");
        updateR3 = (BSONObject) JSON.parse("{_id:'insertID17765F_1',a:4,b:4}");
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expPositiveReadList4, expReverseReadList4, expPositiveReadList2, expReverseReadList2,
    ...
    public void test(String indexKey, List<BSONObject> expPositiveReadList1, List<BSONObject> expReverseReadList1,
        ...
        try {
            ...
            try {
                // 校验事务3读返回的记录（正序）
                actDataList = (ArrayList<BSONObject>) queryThread1.getExecResult();
                Assert.assertEquals(actDataList, expPositiveReadList3);
                actDataList.clear();

                // 校验事务4读返回的记录(逆序)
                actDataList = (ArrayList<BSONObject>) queryThread2.getExecResult();
