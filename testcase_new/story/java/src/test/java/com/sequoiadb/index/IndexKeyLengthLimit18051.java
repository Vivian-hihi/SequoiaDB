...
/**
* FileName: IndexKeyLengthLimit18051.java
* test content:create index, Insert index key length is maximum.insert multiple records.
* testlink case:seqDB-18051
* @author wuyan
    * @Date    2019.3.27
* @version 1.00
*/
...
public class IndexKeyLengthLimit18051 extends SdbTestBase {
	...
	public Object[][] generatePageSize(){
		return new Object[][]{
			//the parameter : Pagesize / the field value length of the index key/ insertNums
	...
	public void testIndexInAnyPageSize(int pageSize, int length, int recordNum){
