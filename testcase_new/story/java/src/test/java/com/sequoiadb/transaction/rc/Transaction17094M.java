 ...
 */
@Test(groups = "rc")
public class Transaction17094M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17094m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117094");
        sdb.getCollectionSpace(csName).createCollection("sub217094");
        cl.attachCollection(csName + ".sub117094",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217094",
