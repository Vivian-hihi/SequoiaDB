...
@Test(groups = "ru")
public class UpdateRead17195_3 extends SdbTestBase {
	private String clName = "cl_17195_3";
    ...
    public void test(){
		...
		//记录新增索引字段
  	    cl1.update("{_id:1}", "{$set:{c:1}}", "{'':null}");
		BSONObject updateR1 = (BSONObject)JSON.parse("{_id:1,a:1,b:1,c:1}");
