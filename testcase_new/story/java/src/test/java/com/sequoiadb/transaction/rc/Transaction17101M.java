 ...
 */
@Test(groups = "rc")
public class Transaction17101M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17101m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117101");
        sdb.getCollectionSpace(csName).createCollection("sub217101");
        cl.attachCollection(csName + ".sub117101",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217101",
