...
public class FullText15856 extends FullTestBase {
    ...
    private void test() throws Exception {
        ...
        for (int i = 0; i < THREAD_NUM; i++) {
            ...
            BSONObject obj1 = new BasicBSONObject("recordId", new BasicBSONObject("$gte", batchRecsNum * i));
            BSONObject obj2 = new BasicBSONObject("recordId", new BasicBSONObject("$lt", batchRecsNum * (i + 1)));
        ...
        for (int i = 0; i < THREAD_NUM; i++) {
            BSONObject matcher = new BasicBSONObject("", new BasicBSONObject("$Text",
                    new BasicBSONObject("query", new BasicBSONObject("match", new BasicBSONObject("b", modVal + i)))));
