...
/**
 * @@Description seqDB-13260: 设置不同lobpagesize加锁写lob
 * @Author linsuqiang
 * @Date 2017-11-08
 * @Version 1.00
 */

public class RewriteLob13260 extends SdbTestBase {
    @DataProvider
    public Object[][] pageSizeProvider() {
        // all legal LobPageSize
        return new Object[][] { new Object[] { 0 }, new Object[] { 4 * 1024 }, new Object[] { 8 * 1024 },
                new Object[] { 16 * 1024 }, new Object[] { 32 * 1024 }, new Object[] { 64 * 1024 },
                new Object[] { 128 * 1024 }, new Object[] { 256 * 1024 }, new Object[] { 512 * 1024 } };
    }
