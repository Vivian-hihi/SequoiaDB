...
/**
 * @Description seqDB-17963.java 插入与删除并发， 删除的记录同时匹配已提交记录及其他事务插入的记录，事务回滚，过程中读
 * @author luweikang
 * @date 2019年1月15日
 */
//@Test(groups = "rc")
public class Transaction17963B extends SdbTestBase {

    private String clName = "transCL_17963B";
