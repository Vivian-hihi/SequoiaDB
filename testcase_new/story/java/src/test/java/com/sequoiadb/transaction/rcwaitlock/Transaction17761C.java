...
public class Transaction17761C extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17761C_1',a:3,b:3}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17761C_2',a:1,b:1}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17761C_1',a:2,b:2}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17761C_2',a:0,b:0}");
    }
