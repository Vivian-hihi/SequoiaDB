 ...
 */
@Test(groups = "rc")
public class Transaction17096M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17096m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117096");
        sdb.getCollectionSpace(csName).createCollection("sub217096",
                (BSONObject) JSON.parse("{ShardingKey:{b:1}, ShardingType:'hash', AutoSplit:true}"));
        cl.attachCollection(csName + ".sub117096",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217096",
