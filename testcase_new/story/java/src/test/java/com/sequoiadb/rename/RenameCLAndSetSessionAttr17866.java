...
public class RenameCLAndSetSessionAttr17866 extends SdbTestBase {
    ...
    public void test() {
        ...
        //the slave node has no synchronous rename CL, query of new clname must be access master node
    ...
    private String getAccessNode(Sequoiadb sdb, String clName){
    	DBCollection dbcl = sdb.getCollectionSpace(csName).getCollection(clName);
 		DBCursor cursor = dbcl.explain(null, null, null, null, 0, 5, DBQuery.FLG_QUERY_FORCE_HINT, null);		
 		String nodeName = "";
