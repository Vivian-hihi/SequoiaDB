...
public class Transaction17765C extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17765C_1',a:2,b:2}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17765C_2',a:3,b:3}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17765C_1',a:1,b:1}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17765C_2',a:6,b:6}");
        updateR3 = (BSONObject) JSON.parse("{_id:'insertID17765C_1',a:4,b:4}");
    }
