...
@Test(groups = "rc")
public class Transaction17089M extends SdbTestBase {
    private String clName = "cl_17089m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117089");
        sdb.getCollectionSpace(csName).createCollection("sub217089");
        cl.attachCollection(csName + ".sub117089",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:25000}}"));
        cl.attachCollection(csName + ".sub217089",
