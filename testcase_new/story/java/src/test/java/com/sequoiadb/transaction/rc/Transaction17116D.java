...
@Test(groups = "rc")
public class Transaction17116D extends SdbTestBase {
    private String clName = "cl_17116D";
    ...
    public void test() {
        ...
        for(int i=0; i<15000; i++){
            insertR1s.add((BSONObject)JSON.parse("{_id:"+ i +", a:"+ i +", b:"+ (i+2) +"}"));
            BSONObject updateR1 = (BSONObject) JSON.parse("{_id:"+ (14999-i) +", a:"+ (15000-i) +", b:"+ (15001-i) +"}");
            invExpList.add(updateR1);
            invInsertR1s.add((BSONObject) JSON.parse("{_id:"+ (14999-i) +", a:"+ (14999-i) +", b:"+ (15001-i) +"}"));
        }
    ...
    private class UpdateThread extends SdbThreadBase{
        ...
        public void exec() throws Exception {
            ...
            try{
                ...
                for(int i=0; i<15000; i++){
                    cl1.update("{_id:"+ i +"}", "{$set:{a:"+ (i+1) +"}}", null);
                }
    ...
    private class ReadThread extends SdbThreadBase{
        ...
        public void exec() throws Exception {
            ...
            // 事务2走索引扫描记录、逆序   SEQUOIADBMAINSTREAM-4262
