...
public class LobTruncate13388 extends SdbTestBase {
    ...
    /**
     * 1、指定oid执行truncateLob操作，删除超过指定长度部分的数据 2、检查操作结果（读取lob，查看lob对象长度，执行listLobs查看lobsize信息）
     * 1、执行truncateLob成功，读取lob数据为truncate后的数据一致 2、执行listLobs查看lob大小为truncate操作时指定大小
     */
    @Test
