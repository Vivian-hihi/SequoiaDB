...
public class Transaction17362E extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17362E_1',a:3,b:3,c:3}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17362E_2',a:1,b:1,c:1}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17362E_1',a:2,b:2,c:3}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17362E_2',a:4,b:4,c:1}");
        updateR3 = (BSONObject) JSON.parse("{_id:'insertID17362E_1',a:5,b:5,c:3}");
