...
public class UpdateAsInc12610 extends SdbTestBase{	
	...
	public Object[][] generateDatas(){
		String []expRecords1 = {"{no:2147483649,a:{'$numberLong':'-9223372036854775808'},test:0}"};		
		String []expRecords2 = {"{no:[-2147483649,{'$numberLong':'-8223372036854775800'}],a:[1,[2147483648],3],test:1}"};	
		String []expRecords3 = {"{no:[-2147483649,{'$numberLong':'-8223372036854775800'}],a:[1,[2147483649],3],test:1}"};		
		String []expRecords01 = {"{no:2147483649,a:{'$decimal':'-9223372036854775809'},test:0}"};
		String []expRecords02 = {"{no:[-2147483649,{'$decimal':'-9223372036854775809'}],a:[1,[2147483649],3],test:1}"};	
		String []expRecords03 = {"{no:2147,a:[1,{a:{b:{c:{'$decimal':'9223372036854775808'}}}},2],test:2}"};		
		...
		return new Object[][]{
			//the parameters: matcherValue,updateName,incValue,expRecords,expType,isVerifyTypeTojava,expTypeToJava
			//---int32 and int32
			//-2147483648 inc 1,the result is -2147483649(int64)
			new Object[]{0, "no", 2147483001, expRecords1,expLongType,true,expLongTypeToJava},			
			//array: no.0 inc -1,the result is -2147483649(int64)
			new Object[]{1, "no.0", -1, expRecords2,expLongType,false,null},			
			//array: no.1.0 inc 1,the result is 2147483649(int64)
			new Object[]{1, "a.1.0",1, expRecords3,expLongType,false,null},				
			
			//---int64 and int64
			//-9223372036854775808 inc -1,the result is {'$decimal':'-9223372036854775809'}
			new Object[]{0, "a", new Long(-1),expRecords01,expDecimalType,true,expDecimalTypeToJava},
			//arr.1 inc -1,the result is {'$decimal':'-9223372036854775809'}
			new Object[]{1, "no.1", new Long(-1000000000000000009L),expRecords02,expDecimalType,false,null},
			//a.1.a.b.c inc 1,the result is {'$decimal':'9223372036854775808'}
			new Object[]{2,  "a.1.a.b.c", new Long(1), expRecords03,expDecimalType,false,null},						
		};
	}	
	...
	public void testUpdate(int matcherValue,String updateName, Object incValue,String []expRecords,
