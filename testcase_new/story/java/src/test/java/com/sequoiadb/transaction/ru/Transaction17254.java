...
/**
 * @Description Transaction17254.java 更新已提交记录与其他事务更新的记录重复
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "ru")
public class Transaction17254 extends SdbTestBase {

    private String clName = "transCL_17254";
    ...
    public void setUp() {
        ...
        data.put("_id", "insert1725401");
        data.put("a", 1);
        data.put("b", "testTrans_17254");
        data.put("c", 13700000000L);
        data.put("d", "customer transaction type data application.");
        expDataList.add(data);

        data2 = new BasicBSONObject();
        data2.put("_id", "insert1725402");
        data2.put("a", 2);
        data2.put("b", 1024);
    ...
    public void test1() {
        ...
        // 1 trans1 update record R1 to R3
        ...
        try {
            ...
            // 2 trans2 update record R2 to R4 same as the R3
