 ...
 */
@Test(groups = "rc")
public class Transaction17105M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17105m";
    ...
    public void setUp() {
        ...
        cl.attachCollection(csName + ".sub117105",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217105",
