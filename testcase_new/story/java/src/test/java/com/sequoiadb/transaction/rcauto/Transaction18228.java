...
public class Transaction18228 extends SdbTestBase {
    ...
    public void test() {
        ...
        cl.split(groupNames.get(0), groupNames.get(1), (BSONObject) JSON.parse("{b:100}"),
        ...
        try {
            cl.update("{$and:[{a:{$gte:0}},{a:{$lt:200}}]}", "{$inc:{a:100}}", "{'':'idx18228'}");
    ...
    private void insertData() {
        ...
        records.add(151, (BSONObject) JSON.parse("{_id:200, a:150, b:250}"));
