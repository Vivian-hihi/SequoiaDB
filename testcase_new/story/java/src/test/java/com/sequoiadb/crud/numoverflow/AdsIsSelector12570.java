...
public class AdsIsSelector12570 extends SdbTestBase{
	...
	public Object[][] generateDatas(){
		String []expRecords1 = {"{'no':2147483648,'tlong':-9223372036854775808,'tdouble':-1.7E+308,'test':0}"}; 		
		String []expRecords2 = {"{'no':-2147483648,'tlong':{ '$decimal' : '9223372036854775808'},'tdouble':-1.7E+308,'test':0}"};
		String []expRecords3 = {"{'no':-2147483648,'tlong':-9223372036854775808,'tdouble':1.7E+308,'test':0}"};
		String []expRecords4 = {"{no:1,numarry:[2147483648],obj:{a:-2147483648},test:1}"};
		String []expRecords5 = {"{no:1,numarry:[2147483648,{ '$decimal' : '9223372036854775808'} , null],obj:{a:-2147483648},test:1}"};
		String []expRecords6 = {"{no:2147483647,obj:{a:{b:{'$decimal':'9223372036854775808'}}},test:3}"};
		...
		return new Object[][]{
			//parameters: matcherValue,selectorName,expRecords,expType,isVerifyTypeToJava, expTypeTojava			
			//test int32 type numberflow
			new Object[]{0, "no",expRecords1,expLongType,true,expLongTypeToJava},			
			//test int64 type numberflow
			new Object[]{0, "tlong",expRecords2,expDecimalType,true,expDecimalTypeToJava},		
			//test double type
			new Object[]{0, "tdouble",expRecords3,expDoubleType,true,expDoubleTypeToJava},	
			//the arr.0 use $abs,the numberflow is int32 To int64
			new Object[]{1, "numarry.$[0]",expRecords4,expLongType,false,null},	
			//the arr use $abs
			new Object[]{1, "numarry",expRecords5,expArrayType,false,null},			
			//test obj type use $abs
			new Object[]{3, "obj.a.b",expRecords6,expDecimalType,false,null},									
		};
	}
	...
	public void testAbs(int matcherValue,String selectorName, String []expRecords,String expTypeToSdb,Boolean isVerifyTypeToJava,String typeToJava){
		try{		
