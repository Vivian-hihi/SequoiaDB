...
public class Transaction17366A extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17366A_1',a:1,b:1,c:1}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17366A_2',a:2,b:2,c:2}");
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] { { "{'a': 1}", expPositiveReadList1, expReverseReadList1 },
                ...
                { "{'a': 1, b: -1}", expPositiveReadList1, expReverseReadList1 },
                { "{'a': -1}", expReadList1, expReadList1 }, { "{'a': -1, b: 1}", expReadList1, expReadList1 },
    ...
    public void test(String indexKey, List<BSONObject> expPositiveReadList1, List<BSONObject> expReverseReadList1) {
        try {
            ...
            // 非事务逆序记录读
            TransUtils.queryAndCheck(cl, orderBy2, hintTbScan, expPositiveReadList1);

            // 非事务逆序索引读
            TransUtils.queryAndCheck(cl, orderBy2, hintIxScan, expPositiveReadList1);
