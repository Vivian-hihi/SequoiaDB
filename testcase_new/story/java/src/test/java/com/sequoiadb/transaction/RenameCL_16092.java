 ...
 * @date 2018年10月17日
 */
public class RenameCL_16092 extends SdbConfTestBase{
    ...
    private void checkRecordNum(Sequoiadb db, String clName, int expRecoreNum){
        
        DBCollection checkCL = db.getCollectionSpace(csName).getCollection(clName);
