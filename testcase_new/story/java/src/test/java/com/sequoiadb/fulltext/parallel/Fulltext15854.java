...
public class Fulltext15854 extends FullTestBase {
    ...
    private class ThreadFullTextSearch {
        ...
        private void waitSync() throws Exception {
            Assert.assertTrue(
                    FullTextUtils.isIndexCreated(cl2, FULLTEXT_IDX_NAME, INSERT_RECS_NUM * 2 - INSERT_RECS_NUM / 2));
        }
    ...
    private class ThreadSplit {
        ...
        private void checkResults() {
            ...
            try {
                ...
                DBCollection srcCL = srcRG.getCollectionSpace(SdbTestBase.csName).getCollection(CL_NAME);
                DBCollection dstCL = dstRG.getCollectionSpace(SdbTestBase.csName).getCollection(CL_NAME);
