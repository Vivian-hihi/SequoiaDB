...
/**
* FileName: IndexKeyLengthLimit18052.java
* test content:create index, the index field value exceeds the limit.
* testlink case:seqDB-18052
* @author wuyan
    * @Date    2019.3.28
* @version 1.00
*/
...
public class IndexKeyLengthLimit18052 extends SdbTestBase {
	...
	public Object[][] generatePageSize(){
		return new Object[][]{
			//the parameter : Pagesize / the field value length of the index key
