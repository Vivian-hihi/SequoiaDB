...
public class Alter14996 extends SdbTestBase {
    ...
    public void test() {
        ...
        if (alterCSResult && createCLResult) {
            ...
            DBCursor snapCur = sdb.getSnapshot(Sequoiadb.SDB_SNAP_COLLECTIONSPACES, new BasicBSONObject("Name", csName),
                    null, null);
            ...
            Assert.fail("setAttr and createCL all failed, setAttr: " + alterCS.getErrorMsg() + ", createCL: "
