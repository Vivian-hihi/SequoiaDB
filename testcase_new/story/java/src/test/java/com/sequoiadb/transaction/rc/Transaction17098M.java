 ...
 */
@Test(groups = "rc")
public class Transaction17098M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17098m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117098");
        sdb.getCollectionSpace(csName).createCollection("sub217098");
        cl.attachCollection(csName + ".sub117098",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217098",
