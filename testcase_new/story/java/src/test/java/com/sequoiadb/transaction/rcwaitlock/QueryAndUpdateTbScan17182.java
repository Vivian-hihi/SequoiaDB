...
public class QueryAndUpdateTbScan17182 extends SdbTestBase {
     private Sequoiadb sdb = null;
     private String clName = "cl17182tb";
     ...
     public void test() {
          ...
          explainCursor = cl1.explain((BSONObject) JSON.parse("{a:{$exists:1}}"), null, null,
                    (BSONObject) JSON.parse("{'':'textIndex17182'}"), 0, 1, DBQuery.FLG_QUERY_FOR_UPDATE, null);
          while (explainCursor.hasNext()) {
               String scanType = (String) explainCursor.getNext().get("ScanType");
