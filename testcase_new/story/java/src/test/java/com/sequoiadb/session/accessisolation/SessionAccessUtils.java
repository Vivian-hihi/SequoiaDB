...
public class SessionAccessUtils extends SdbTestBase {
	...
	public static void createRGAndNode(Sequoiadb sdb, String groupName, Object[] instanceidarr, int nodeNum,
	...
	public static void checkMasterExist(Sequoiadb sdb, String groupName) {
		...
		String queryMasterNode = "select IsPrimary,NodeName from $SNAPSHOT_SYSTEM where GroupName='" + groupName
				+ "' and IsPrimary=true ";
