...
public class Transaction17359A extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17359A_1',a:1,b:1,c:1}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17359A_2',a:2,b:2,c:2}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17359A_1',a:3,b:3,c:1}");
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expPositiveReadList1, expReverseReadList1, expPositiveReadList2, expPositiveReadList2 },
                { "{'a': 1, b: 1}", expPositiveReadList1, expReverseReadList1, expPositiveReadList2,
                        expPositiveReadList2 },
                { "{'a': 1, b: -1}", expPositiveReadList1, expReverseReadList1, expPositiveReadList2,
                        expPositiveReadList2 },
                { "{'a': -1}", expPositiveReadList3, expReverseReadList3, expPositiveReadList2, expPositiveReadList2 },
    ...
    public void test(String indexKey, List<BSONObject> expPositiveReadList1, List<BSONObject> expReverseReadList1,
        ...
        try {
            ...
            // 非事务记录读，逆序查询
            TransUtils.queryAndCheck(cl, orderBy2, hintTbScan, expPositiveReadList2);
