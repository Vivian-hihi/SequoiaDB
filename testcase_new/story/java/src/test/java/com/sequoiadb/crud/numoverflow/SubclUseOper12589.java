...
/**
* FileName: SubclUseOper12589.java
* test content:Numeric value overflow for subcl using operators,
* 				and these operators are used as a selector.
* testlink case:seqDB-12589
* @author luweikang
    * @Date    2017.9.14
* @version 1.00
*/
...
public class SubclUseOper12589 extends SdbTestBase{
	...
	public Object[][] generateIntDatas(){
		String []expRecords1 = {"{'no':{$numberLong:'-2147483649'},'test':3}"};
		String []expRecords2 = {"{'no':{'$decimal':'9223372036854775808'},'test':7}"};
		String []expRecords3 = {"{'no':[{'$decimal':'9223372036854775808'}],'test':8}"};
//		String []expRecords4 = {"{'no':[[{$numberLong:'21474836478'}]],'test':12}"};
		String []expRecords5 = {"{'no':{a:{b:{'$decimal':'18446744073709551614'}}},'test':13}"};
		String []expRecords6 = {"{'no':[{$numberLong:'4294967294'}],'test':8}"};
		String []expRecords7 = {"{'no':{'$numberLong':'27577318434033'},'test':7}"};
		
		return new Object[][]{
			//the parameters: matcherValue, opertors, operValue, selectorName, expRecord
			new Object[]{3, "$add", new Integer(-1), "no", expRecords1},
			new Object[]{7, "$subtract", new Integer(-1), "no", expRecords2},
			new Object[]{8, "$multiply", new Long(-1), "no.$[1]", expRecords3},
			//SEQUOIADBMAINSTREAM-2795
//			new Object[]{12, "$divide", new Long(-1), "no.$[1].$[0]", expRecords4},
			new Object[]{13, "$multiply", new BigDecimal(2), "no.a.b", expRecords5},
			new Object[]{8, "$add", new Long(2147483647), "no.$[0]", expRecords6},
			new Object[]{7, "$divide", new Integer(334455), "no", expRecords7}
		};
	}
	...
	public void testSubclOper(int matcherValue, String opertors, Object operValue, String selectorName, String[] expRecords ){
		try {
	...
	public void attachCL(DBCollection clName,String attachCLFullName,String skey, Object lowBound, Object upBound){
