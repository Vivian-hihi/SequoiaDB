...
public class Transaction17761D extends SdbTestBase {
    ...
    public void test(){
        ...
        // 7 trans2 read
        recordCur = cl2.query(null, null, "{'_id': 1}", "{'': null}");
        actDataList = TransUtils.getReadActList(recordCur);
        Assert.assertEquals(actDataList, expDataList);
        actDataList.clear();

        recordCur = cl2.query(null, null, "{'_id': 1}", "{'': 'a'}");
        actDataList = TransUtils.getReadActList(recordCur);
        Assert.assertEquals(actDataList, expDataList);
        actDataList.clear();
        ...
        // 9 trans3 read
        recordCur = cl3.query(null, null, "{'_id': 1}", "{'': null}");
        actDataList = TransUtils.getReadActList(recordCur);
        Assert.assertEquals(actDataList, expDataList);
        actDataList.clear();

        recordCur = cl3.query(null, null, "{'_id': 1}", "{'': 'a'}");
        actDataList = TransUtils.getReadActList(recordCur);
        Assert.assertEquals(actDataList, expDataList);
        actDataList.clear();
