...
public class Transaction17761D extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17761D_1',a:2,b:2}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17761D_2',a:1,b:1}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17761D_1',a:4,b:4}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17761D_2',a:3,b:3}");
    }
