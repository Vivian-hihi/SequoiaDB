 ...
 */
@Test(groups = "rc")
public class Transaction17102M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17102m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117102");
        sdb.getCollectionSpace(csName).createCollection("sub217102");
        cl.attachCollection(csName + ".sub117102",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217102",
