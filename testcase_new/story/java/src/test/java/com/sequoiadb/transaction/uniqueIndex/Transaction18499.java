...
public class Transaction18499 extends SdbTestBase {
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub318499",
                (BSONObject) JSON.parse("{ShardingKey:{b:1}, ShardingType:'hash', AutoSplit:true}"));
        cl.attachCollection(csName + ".sub118499",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:10000}}"));
        cl.attachCollection(csName + ".sub218499", (BSONObject) JSON.parse("{LowBound:{b:10000}, UpBound:{b:20000}}"));
        cl.attachCollection(csName + ".sub318499",
                (BSONObject) JSON.parse("{LowBound:{b:20000}, UpBound:{b:{'$maxKey':1}}}"));
