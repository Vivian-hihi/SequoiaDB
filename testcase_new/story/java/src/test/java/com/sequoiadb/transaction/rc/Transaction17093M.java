 ...
 */
@Test(groups = "rc")
public class Transaction17093M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17093m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117093");
        sdb.getCollectionSpace(csName).createCollection("sub217093",
                (BSONObject) JSON.parse("{ShardingKey:{b:1}, ShardingType:'hash', AutoSplit:true}"));
        cl.attachCollection(csName + ".sub117093",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217093",
