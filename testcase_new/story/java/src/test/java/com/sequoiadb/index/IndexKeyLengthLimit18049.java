...
/**
 * FileName: IndexKeyLengthLimit18049.java test content:create index, Insert index key length is maximum. 
 * testlink case:seqDB-18049 *
 * @author wuyan
 * @Date 2019.3.27
 * @version 1.00
 */
...
public class IndexKeyLengthLimit18049 extends SdbTestBase {
	...
	public void testIndexInAnyPageSize(int pageSize, int length) {
		try (Sequoiadb sdb = new Sequoiadb(SdbTestBase.coordUrl, "", "");) {
			...
			ArrayList<BSONObject> insertRecords = insertData(cl, recordNum, length);
