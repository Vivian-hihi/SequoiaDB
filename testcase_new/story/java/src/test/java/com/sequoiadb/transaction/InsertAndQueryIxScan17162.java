...
public class InsertAndQueryIxScan17162 extends SdbTestBase {
     private Sequoiadb sdb = null;
     private String clName = "cl17162ix";
     ...
     public void test() {
       ...
       // 非事务表扫描
          ...
          // 非事务索引扫描
          recordsCursor = cl.query("{a:{$exists:1}}", null, null, "{'':'textIndex17162'}");
          actList = TransUtils.getReadActList(recordsCursor);
          Assert.assertEquals(actList, expList);
          ...
          // 事务2读记录走索引扫描
          recordsCursor = cl2.query("{a:{$exists:1}}", null, null, "{'':'textIndex17162'}");
          actList = TransUtils.getReadActList(recordsCursor);
          Assert.assertEquals(actList, expList);
