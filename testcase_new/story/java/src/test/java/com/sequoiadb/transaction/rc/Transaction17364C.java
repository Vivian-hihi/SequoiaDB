...
public class Transaction17364C extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17364C_1',a:2,b:2,c:2}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17364C_2',a:3,b:3,c:3}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17364C_1',a:1,b:1,c:2}");
