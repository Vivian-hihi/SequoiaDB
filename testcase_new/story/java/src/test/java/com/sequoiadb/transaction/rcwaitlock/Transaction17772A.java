...
public class Transaction17772A extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17772A_1',a:1,b:1}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17772A_2',a:2,b:2}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17772A_1',a:3,b:3}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17772A_2',a:4,b:4}");
    }
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] {
                { "{'a': 1}", expPositiveReadList1, expPositiveReadList1, expPositiveReadList2, expReverseReadList2,
                        expPositiveReadList2, expPositiveReadList1 },
                { "{'a': -1}", expPositiveReadList3, expPositiveReadList3, expPositiveReadList2, expReverseReadList2,
    ...
    private class TransactionQueryThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            ...
            List<BSONObject> actQueryList = TransUtils.getReadActList(indexCursor);
