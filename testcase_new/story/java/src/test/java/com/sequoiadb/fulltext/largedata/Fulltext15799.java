...
public class Fulltext15799 extends SdbTestBase {
    ...
    public void test() throws Exception {
        ...
        Assert.assertTrue(FullTextUtils.isMainCLIndexCreated(mainCL, fullIndexName, FullTextUtils.INSERT_NUMS));
    ...
    public void tearDown() throws Exception {
        ...
        Assert.assertTrue(FullTextUtils.isIndexDeleted(sdb, esIndexNames01, cappedNames));
    }
