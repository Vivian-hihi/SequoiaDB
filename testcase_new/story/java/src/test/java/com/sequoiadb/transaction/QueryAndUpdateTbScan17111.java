 ...
 */
@Test(groups = "rc")
public class QueryAndUpdateTbScan17111 extends SdbTestBase {
     private Sequoiadb sdb = null;
     private String clName = "cl17111tb";
     ...
     public void test() {
          ...
          explainCursor = cl1.explain((BSONObject) JSON.parse("{a:{$exists:1}}"), null, null,
                    (BSONObject) JSON.parse("{'':'textIndex17111'}"), 0, 1, DBQuery.FLG_QUERY_FOR_UPDATE, null);
          while (explainCursor.hasNext()) {
               String scanType = (String) explainCursor.getNext().get("ScanType");
