...
public class LobTest13228 extends SdbTestBase {  
    ...
    private void testLob13228a(int appendDataSize, int seekSize, int seekType) {
        ...
        if (appendPosition > initDataSize) { 
            ...
            String prevappendMd5 = RandomWriteLobUtil.getMd5(Arrays.copyOfRange(actual, appendPosition, appendPosition + appendDataSize));
    ...
    private void testLob13228b(int appendDataSize, int seekSize, int seekType) {
        ...
        byte[] actual = RandomWriteLobUtil.readLob(dbcl, id);        
        if(seekType != DBLob.SDB_LOB_SEEK_END){
        	String previnitMd5 = RandomWriteLobUtil.getMd5(Arrays.copyOfRange(actual, seekSize, seekSize + appendDataSize));
