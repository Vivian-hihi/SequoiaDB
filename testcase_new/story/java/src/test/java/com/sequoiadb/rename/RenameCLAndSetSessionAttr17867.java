 ...
 *          no synchronous rename CL,the operator access the master node. *                
...
public class RenameCLAndSetSessionAttr17867 extends SdbTestBase {
    ...
    public void testInsertAndRename() {
        ...
        //the slave node has no synchronous rename CL, query of new csname must be access master node
    ...
    public class InsertThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            try ( Sequoiadb db = new Sequoiadb( SdbTestBase.coordUrl, "", "" ) ) {
                DBCollection dbcl = db.getCollectionSpace( csName ).getCollection( oldCLName ) ;
    ...
    public class CountThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {        	
            try {
            	DBCollection dbcl = db.getCollectionSpace( csName ).getCollection( newCLName ) ;
