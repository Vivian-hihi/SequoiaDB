...
public class Transaction17358C extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17358C_1',a:2,b:2,c:2}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17358C_2',a:3,b:3,c:3}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17358C_1',a:0,b:0,c:2}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17358C_2',a:1,b:1,c:3}");
