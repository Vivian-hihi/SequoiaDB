...
/**
 * @Description seqDB-17962.java 插入与删除并发，
 *              删除的记录同时匹配已提交记录及其他事务插入的记录，删除走索引，事务提交，过程中读
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "rc")
public class Transaction17962B extends SdbTestBase {

    private String clName = "transCL_17962B";
    ...
    public void test(){
        ...
        //7 trans1 commit check trans2 success, no trans query
        sdb1.commit();
