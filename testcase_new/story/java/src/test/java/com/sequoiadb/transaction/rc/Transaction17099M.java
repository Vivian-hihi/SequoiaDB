 ...
 */
@Test(groups = "rc")
public class Transaction17099M extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String clName = "cl_17099m";
    ...
    public void setUp() {
        ...
        sdb.getCollectionSpace(csName).createCollection("sub117099");
        sdb.getCollectionSpace(csName).createCollection("sub217099",
                (BSONObject) JSON.parse("{ShardingKey:{b:1}, ShardingType:'hash', AutoSplit:true}"));
        cl.attachCollection(csName + ".sub117099",
                (BSONObject) JSON.parse("{LowBound:{b:{'$minKey':1}}, UpBound:{b:500}}"));
        cl.attachCollection(csName + ".sub217099",
    ...
    private class UpdateThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            hint = "{\"\":\"a\"}";
            cl2.update("{a: {$gte: " + (startId + updateValue1) + ", $lt: " + (stopId + updateValue1) + "}}",
