...
/**
* FileName: AddIsMatcher12594.java
* test content:Numeric value overflow for many character using $add operation,
* 				and the $add is used as a matcher.
* testlink case:seqDB-12594
* @author luweikang
    * @Date    2017.9.13
* @version 1.00
*/
...
public class AddIsMatcher12594 extends SdbTestBase{
	...
	public void setUp(){
		...
		String []records = {"{'int32':-2147483648,'long':{'$numberLong':'-9223372036854775808'},"
	...
	public void testAdd(){
		...
		String []expRecords = {"{'int32':-2147483648,'long':{'$numberLong':'-9223372036854775808'},"
							+ "'arr':[2147483647,{'$numberLong':'-9223372036854775808'}],"
							+ "obj:{a:{b:{'$numberLong':'9223372036854775807'}}}}"};
