...
/**
 * @Description Transaction17255.java   更新已提交记录与其他事务删除的记录重复 
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "ru")
public class Transaction17255 extends SdbTestBase {
    
    private String clName = "transCL_17255";
    ...
    public void setUp(){
        ...
        data.put("_id", "insert1725501");
        data.put("a", 1);
        data.put("b", "testTrans_17255");
        data.put("c", 13700000000L);
        data.put("d", "customer transaction type data application.");
        expDataList.add(data);
        
        data2 = new BasicBSONObject();
        data2.put("_id", "insert1725502");
        data2.put("a", 2);
        data2.put("b", 1024);
        ...
        updateData.put("_id", "insert1725501");
        updateData.put("a", 1);
    ...
    public void test1(){
        ...
        try {
            ...
            //2 trans2 update R2 to R3 same as the R1
