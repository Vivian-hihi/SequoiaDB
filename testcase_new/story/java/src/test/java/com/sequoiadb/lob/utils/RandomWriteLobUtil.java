...
public class RandomWriteLobUtil {
	...
	return readLob(db.getCollectionSpace(csName).getCollection(clName), id);
    }
    ...
    public static void checkRewriteLobResult(DBCollection cl, ObjectId oid, int offset, byte[] rewriteBuff,
	    byte[] lobBuff) {
	...
	public static Object[][] lobSizeDataProvider() {
	    return new Object[][] { { 1024 * 1024 }, { 1024 * 1024 * 10 }, { 1024 * 1024 * 100 } };
	}
    }
}
