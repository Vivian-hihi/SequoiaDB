...
public class Transaction17364E extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17364E_1',a:3,b:3,c:3}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17364E_2',a:1,b:1,c:1}");
        updateR1 = (BSONObject) JSON.parse("{_id:'insertID17364E_1',a:2,b:2,c:3}");
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] { { "{'a': 1}", expReadList1, expReadList1 },
                { "{'a': 1, b: 1}", expReadList1, expReadList1 }, { "{'a': 1, b: -1}", expReadList1, expReadList1 },
    ...
    public void test(String indexKey, List<BSONObject> expPositiveReadList1, List<BSONObject> expReverseReadList1) {
        try {
            ...
            // 非事务正序记录读
            TransUtils.queryAndCheck(cl, orderBy1, hintTbScan, expPositiveReadList1);

            // 非事务正序索引读
            TransUtils.queryAndCheck(cl, orderBy1, hintIxScan, expPositiveReadList1);

            // 非事务逆序记录读
            TransUtils.queryAndCheck(cl, orderBy2, hintTbScan, expReverseReadList1);

            // 非事务逆序索引读
            TransUtils.queryAndCheck(cl, orderBy2, hintIxScan, expReverseReadList1);
            ...
            // 非事务正序记录读
            TransUtils.queryAndCheck(cl, orderBy1, hintTbScan, new ArrayList<BSONObject>());

            // 非事务正序索引读
            TransUtils.queryAndCheck(cl, orderBy1, hintIxScan, new ArrayList<BSONObject>());

            // 非事务逆序记录读
            TransUtils.queryAndCheck(cl, orderBy2, hintTbScan, new ArrayList<BSONObject>());

            // 非事务逆序索引读
            TransUtils.queryAndCheck(cl, orderBy2, hintIxScan, new ArrayList<BSONObject>());

            // 事务2正序记录读
            TransUtils.queryAndCheck(cl2, orderBy1, hintTbScan, new ArrayList<BSONObject>());

            // 事务2正序索引读
            TransUtils.queryAndCheck(cl2, orderBy1, hintIxScan, new ArrayList<BSONObject>());

            // 事务2逆序记录读
            TransUtils.queryAndCheck(cl2, orderBy2, hintTbScan, new ArrayList<BSONObject>());

            // 事务2逆序索引读
            TransUtils.queryAndCheck(cl2, orderBy2, hintIxScan, new ArrayList<BSONObject>());
            ...
            // 事务3正序记录读
            TransUtils.queryAndCheck(cl3, orderBy1, hintTbScan, new ArrayList<BSONObject>());

            // 事务3正序索引读
            TransUtils.queryAndCheck(cl3, orderBy1, hintIxScan, new ArrayList<BSONObject>());

            // 事务3逆序记录读
            TransUtils.queryAndCheck(cl3, orderBy2, hintTbScan, new ArrayList<BSONObject>());

            // 事务3逆序索引读
            TransUtils.queryAndCheck(cl3, orderBy2, hintIxScan, new ArrayList<BSONObject>());
