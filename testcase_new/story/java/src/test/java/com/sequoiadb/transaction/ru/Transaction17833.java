...
/**
 * @Description seqDB-17833.java  插入与更新并发，更新的记录同时匹配已提交记录及其他事务插入的记录，更新走表扫描,事务回滚，过程中读 
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "ru")
public class Transaction17833 extends SdbTestBase {
    
    private String clName = "transCL_17833";
    ...
    private class UpdateThread extends SdbThreadBase {
        ...
        public void exec() throws BaseException {
            CLTrans2.update(new BasicBSONObject("a", 1), modifier3, null);
            CLTrans2.update(new BasicBSONObject("a", 2), modifier4, null);
        }
    }
