...
public class Insert15966 extends SdbTestBase {
    ...
    public void setUp() {
        ...
        DBCollection cl = commSdb.getCollectionSpace(csName).createCollection(
        		clName,(BSONObject)JSON.parse("{AutoIncrement:{Field:'id', Increment:"+increment+",AcquireSize:"+acquireSize+"}}"));
	}
	...
	public void test() {
		...
		if(!(insertThread.isSuccess() && truncateThread.isSuccess())){
            Assert.fail(insertThread.getErrorMsg() + truncateThread.getErrorMsg());
		}
