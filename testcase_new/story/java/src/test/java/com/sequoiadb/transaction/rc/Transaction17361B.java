...
public class Transaction17361B extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17361B_1',a:1,b:1,c:1}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17361B_2',a:2,b:2,c:2}");
    ...
    public Object[][] createIndex() {
        ...
        return new Object[][] { { "{'a': 1}", expReadList3, expReadList3 },
                { "{'a': 1, b: 1}", expReadList3, expReadList3 }, { "{'a': 1, b: -1}", expReadList3, expReadList3 },
