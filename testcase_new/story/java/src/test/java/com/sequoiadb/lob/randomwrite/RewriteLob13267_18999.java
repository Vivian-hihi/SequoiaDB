...
public class RewriteLob13267_18999 extends SdbTestBase {
    ...
    public void testLob(String clName) {
        ...
        RewriteLobTask rewriteLob1 = new RewriteLobTask(clName, oid, offset1, rewriteBuff1);
        RewriteLobTask rewriteLob2 = new RewriteLobTask(clName, oid, offset2, rewriteBuff2);
        rewriteLob1.start();
        rewriteLob2.start();
        ...
        if (!rewriteLob1.isSuccess()) {
            ...
            readLobAndcheckWriteResult(cl, oid, testLobBuff, rewriteBuff2, offset2);
        } else {
            if (!rewriteLob2.isSuccess()) {
                ...
                readLobAndcheckWriteResult(cl, oid, testLobBuff, rewriteBuff1, offset1);
            } else {
    ...
    private class RewriteLobTask extends SdbThreadBase {
        ...
        public RewriteLobTask(String clName, ObjectId oid, int offset, byte[] rewriteLobBuff) {
            this.clNamet = clName;
            this.oid = oid;
            this.offset = offset;
