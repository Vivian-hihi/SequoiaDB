...
public class Transaction17368F extends SdbTestBase {
    ...
    public void setUp() {
        ...
        insertR1 = (BSONObject) JSON.parse("{_id:'insertID17368F_1',a:3,b:3,c:3}");
        insertR2 = (BSONObject) JSON.parse("{_id:'insertID17368F_2',a:2,b:2,c:2}");
        updateR2 = (BSONObject) JSON.parse("{_id:'insertID17368F_2',a:1,b:1,c:2}");
    }
