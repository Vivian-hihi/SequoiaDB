...
/**
 * @Description seqDB-17251 : 更新已提交记录与本事务中更新的记录唯一索引重复
 * @author luweikang
 * @date 2019年1月15日
 */
@Test(groups = "ru")
public class Transaction17251 extends SdbTestBase {

    private String clName = "transCL_17251";
    ...
    public void setUp() {
        ...
        updateData.put("_id", "id17251");
        updateData.put("a", "testTrans_17251Update");
        updateData.put("b", 1);
    ...
    public void test() {
        try (Sequoiadb transDB = new Sequoiadb(SdbTestBase.coordUrl, "", "");) {
            ...
            // update R2 to R4 same as the R3
