...
/**
 * @FileName seqDB-13265: 并发加锁写lob，其中写数据范围连续
 *           seqDB-13272: 并发读lob，其中读数据范围不连续 
 * @Author linsuqiang
 * @Date 2017-11-08
 * @Version 1.00
 */
 ...
 *    (1)打开已存在lob对象，seek指定偏移范围，执行lock锁定数据段，
 *    向锁定数据段写入lob 多个并发线程中锁定数据段为连续范围，
 *    如线程1锁定数据范围为1-3、线程2锁定数据范围为4-5、线程3锁定数据范围为5-9 
 * 2、读取lob，检查操作结果
 */
 ...
 *    多个并发线程中指定数据范围不连续，如线程1读数据范围为1-3、线程2读数据范围
 *    为6-15、线程3锁定数据范围为25-29 
 * 2、检查操作结果
 */

public class LockAndWriteDiscontinuous13265_13272 extends SdbTestBase {

    private final String csName = "writelob13265";
    private final String clName = "writelob13265";
