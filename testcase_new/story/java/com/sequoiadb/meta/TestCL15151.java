...
public class TestCL15151 extends SdbTestBase{
    ...
    */
    ...
    public void testNormalCL()
    {
        ...
        alterBson.put("Args", new BasicBSONObject("CompressionType", "lzw"));
        ...
        options.put("Options", new BasicBSONObject("IgnoreException", true));
        options.put("Alter", alterList);
        cl.alterCollection(options);
        checkCLAlter("normal", expected);
        cs.dropCollection(clName);
    ...
    private void checkCLAlter(String cltype, BSONObject expected)
    {
        ...
        if (cltype.equals("normal"))
        {
            ...
            Assert.assertEquals(actual.get("ShardingType").toString(), expected.get("ShardingType").toString());
        ...
        else
        {
            ...
            Assert.assertEquals(actual.get("OverWrite").toString(), expected.get("OverWrite").toString());
            cur.close();
        }
    }
