...
public class TestCSSetAttributes15233 extends SdbTestBase{
    ...
    */
    ...
    private void CheckCSAttribute(BSONObject expected)
    {
        ...
        Assert.assertEquals(actual.get("PageSize").toString(), expected.get("PageSize").toString());
        Assert.assertEquals(actual.get("LobPageSize").toString(), expected.get("LobPageSize").toString());
        Assert.assertEquals(actual.get("Domain").toString(), expected.get("Domain").toString());
        cur.close();
    }
