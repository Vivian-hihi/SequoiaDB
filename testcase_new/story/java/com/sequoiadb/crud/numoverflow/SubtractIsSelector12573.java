...
public class SubtractIsSelector12573 extends SdbTestBase{
	...
	@DataProvider(name = "operIntData")
	public Object[][] generateIntDatas1(){
		...
		String []expRecords5 = {"{no:1147483147,long:-8223372036854775807,arr:[ -2147483649],test:2}}"};	
		...
		return new Object[][]{
			...
			//the arr -2100 $substract 2147481549,the result is -2147483649(int64)
			new Object[]{2, 2147481549, "arr",expRecords4,null,false},	
			//the arr.1 -2100 $substract 2147481549,the result is -2147483649(int64)
			new Object[]{2, 2147481549, "arr.$[1]",expRecords5,null,false}			
		};
	}
	
	@DataProvider(name = "operLongData")
	public Object[][] generateLongDatas(){		
		String []expRecords01 = {"{'no':-2147483648,'tlong':{'$decimal':'-9223372036854775809'},'test':0}"};
		String []expRecords02 = {"{'no':2147483647,'long':{'$decimal':'9223372036854775808'},'test':1}"};	
		String []expRecords03 = {"{no:1147483147,'long':{'$decimal':'-9223372036854775809'},"
									+ "arr:[1000000000,-2100],test:2}"};
		String []expRecords04 = {"{no:1147483147,'long':{'$numberLong':'-8223372036854775807'},"
							+ "arr:[{'$decimal':'9223372036854775808'},9223372035854773708],test:2}"};
		String []expRecords05 = {"{no:[{'$decimal':'9223372036854775809'}],arr:[1000000000,-2147483648],test:3}"};
		...
		return new Object[][]{
			...
			new Object[]{0, 1l, "tlong",expRecords01,expDecimalType,true},
			//9223372036854775807 $substract -1,the result is {'$decimal':'9223372036854775809'}
			new Object[]{1, -1l, "long",expRecords02,expDecimalType,true},
			//-8223372036854775807 $substract 1000000000000000002,the result is {'$decimal':'-9223372036854775809'}
			new Object[]{2, 1000000000000000002l, "long",expRecords03,expDecimalType,true},
			//arr:[1000000000,-2147483648] $substract -8223372036854775809
			new Object[]{2, -9223372035854775808l, "arr",expRecords04,null,false},
			//8223372036854775807 $substract -1000000000000000002,the result is {'$decimal':'9223372036854775809'}
			new Object[]{3, -1000000000000000002l, "no.$[1]",expRecords05,null,false},			                  
		};
	}
	...
	@Test(dataProvider = "operIntData")
	public void testSubtract(int matcherValue,int subValue,String selectorName, String []expRecords,String expType,Boolean isVerifyDataType){
		try{			
			
			BSONObject sValue = new BasicBSONObject();
			sValue.put("$subtract", subValue);
			Commlib.selectorOper(cl,matcherValue, sValue, selectorName, expRecords, expType,isVerifyDataType);
	...
	@Test(dataProvider = "operLongData")
	public void testSubtract(int matcherValue,long subValue,String selectorName, String []expRecords,String expType,Boolean isVerifyDataType){
		try{			
			System.out.println("test subvalue="+subValue);
			BSONObject sValue = new BasicBSONObject();
			...
			Assert.assertTrue(false,"subtract longData is used as selector oper failed,"+e.getMessage());
		}		
	}	
