...
/**
* FileName: SelectSQL12622.java
* test content:Numeric value overflow for single character,and execute sql in database.
* testlink case:seqDB-12622
* @author luweikang
    * @Date    2017.9.15
* @version 1.00
*/
public class SelectSQL12622 extends SdbTestBase{
	...
	public Object[][] generateIntDatas(){
		...
		String []expRecords2 = {"{'long':{$decimal:'-18446744073709551616'} }"};
		String []expRecords3 = {"{'no':{$numberLong:'414272144277504'}}"};
		String []expRecords4 = {"{'long':{$decimal:'99035203580122776972318'} }"};
		
		return new Object[][]{
			//the parameters: matcherName,matcherValue,expRecords
			new Object[]{"(no + 1024)*(no + 2147483644)",1,expRecords1},
			new Object[]{"(long / 9223372036854775807) * (long / 4611686018427387904) * long",1,expRecords2},
			new Object[]{"(no / 5566) * (no - 1073741823)",2,expRecords3},
			new Object[]{"(long * 2147483648) - (long / 2147483648)",2,expRecords4}
		};
	}
	...
	public void testSQL(String condition, int mValue, String[] expRecords){
		...
		try{			
			...
			Assert.assertTrue(false,"execute sql oper failed,"+e.getMessage());
		}		
	}
