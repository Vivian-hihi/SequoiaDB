...
/**
* FileName: DivideIsMatcher12600.java
...
public class DivideIsMatcher12600 extends SdbTestBase{
	...
	public Object[][] generateDatas(){
		...
		return new Object[][]{
			...
			new Object[]{"a",  new Double(-3.0), new Double(715827882.66666666666666666666667), expRecords1},			
			//int32(arr) + int64 --result is int64: 2147483647/53=40518559
			new Object[]{"a.1.2.1",new Long(53),new Long(40518559),expRecords2},			
			//int64 + double --result is double
			new Object[]{"b", new Double(123456.01),new Double(-8301087287739.8694563350945814627),expRecords1},
			//int32(arr) + decimal --result is decimal
			new Object[]{"a.1", new BSONDecimal("1.234"), new BSONDecimal("2.4311183144246353"), expRecords3},	
			//int64(obj) + int32 --result is int64
			new Object[]{"b.0.a", new Integer(-15789), new Long(-584164420600087L), expRecords3},
		};
	}
