...
public class MultiplyIsMatcher12599 extends SdbTestBase{
	...
	public Object[][] generateDatas(){
		...
		return new Object[][]{
			...
			new Object[]{"a",  new Double(-1.0), new Double(2147483648.0), expRecords1},			
			//int32(arr) + int64 --result is int64
			new Object[]{"a.1.2.0",new Long(9223372034707292160L),new Long(-9223372034707292160L),expRecords2},			
			//int64 + double --result is double
			new Object[]{"b", new Double(-1.3e+30),new Double(1.332264849767912e+48),expRecords1},
			//int64(arr) + decimal --result is decimal
			new Object[]{"a.0", new BSONDecimal("1.234"), new BSONDecimal("-11381641093478793347.072"), expRecords3},	
			//int64(obj) + int32 --result is int64
			new Object[]{"b.0.a", new Integer(-1), new Long(-9223372036854775807L), expRecords3},
		};
	}
