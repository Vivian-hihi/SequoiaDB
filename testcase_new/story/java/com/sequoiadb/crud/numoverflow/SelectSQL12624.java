...
public class SelectSQL12624 extends SdbTestBase{
	...
	public Object[][] generateIntDatas(){
		String []expRecords1 = {"{'a':-2147483649}","{'a':{'$decimal':'-9223372036854775809'}}"};
		String []expRecords2 = {"{'a':2147483648}","{'a':{'$decimal':'9223372036854775808'}}"};
		String []expRecords3 = {"{'a':4294967294}","{'a':{'$decimal':'18446744073709551614'}}"};
		String []expRecords4 = {"{'a':-4294967296.0}","{'a':-18446744073709551616.0}"};
	...
	public void testSQL(String condition, int mValue, String[] expRecords){
		String sql = "select " + condition + " from ( select no as a from " + cl.getFullName() + " where test = " + mValue + " split by no) as t";
		try{			
