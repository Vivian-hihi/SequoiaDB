...
/**
* FileName: MultiplyIsMatcher12596.java
* test content:Numeric value overflow for many character using $multiply operation,
* 				and the $multiply is used as a matcher.
* testlink case:seqDB-12596
* @author wuyan
    * @Date    2017.9.12
* @version 1.00
*/
