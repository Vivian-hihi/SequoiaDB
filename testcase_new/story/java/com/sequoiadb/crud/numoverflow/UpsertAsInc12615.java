...
public class UpsertAsInc12615 extends SdbTestBase{	
	...
	public Object[][] generateDatas(){
		String []expRecords1 = {"{no:{'$decimal':'9223372036854775808'},test:0}"};		
		String []expRecords2 = {"{no:{a:{'$decimal':'-9223372036854775809'}},test:1}"};	
		String []expRecords3 = {"{no:{a:{b:{c:{'$decimal':'9223372036854775808'}}}},test:2}"};			
		String expDecimalType = "decimal";			
		String expDecimalTypeToJava = "class org.bson.types.BSONDecimal";
		return new Object[][]{
			//the parameters:setInsertValue, updateName,matcherValue,incValue,expRecords,expType,isVerifyTypeTojava,expTypeToJava
			//---int32 and int64
			//-2147483648 inc 1,the result is -2147483649(int64)
			new Object[]{0, "no", new Long(9223372034707292161L), new Integer(2147483647), expRecords1,expDecimalType,true,expDecimalTypeToJava},			
			//obj: no.a inc -1,the result is -2147483649(int64)
			new Object[]{1, "no.a", new Integer(-5), new Long(-9223372036854775804L),expRecords2,expDecimalType,false,null},	
			//-9223372036854775808 inc -1,the result is {'$decimal':'-9223372036854775809'}
			new Object[]{2, "no.a.b.c", new Integer(4), new Long(9223372036854775804L),expRecords3,expDecimalType,true,expDecimalTypeToJava},
	...
	public Object[][] generateDatas1(){
		String []expRecords = {"{no:[{'$decimal':'9223372036854775808'},3],test:10}"};		
		String []expRecords1 = {"{no:{a:[{'$decimal':'-9223372036854775809'},3]},test:11}"};	
		String []expRecords2 = {"{no:[-9,{a:{'$decimal':'9223372036854775808'}}],test:12}"};	
		String []expRecords3 = {"{no:[-9,[3,{'$decimal':'9223372036854779000'}]],test:13}"};			
		//String []expRecords4 = {"{no:[23,{'$decimal':'-9223372036854775809'}],test:4}"};
		...
		return new Object[][]{
			//the parameters:setInsertValue, matcher,updateName,incValue,expRecords			
			//array
			new Object[]{10, matcher, "no.0", new Long(9223372034707292161L), expRecords},			
			//obj.arr
			new Object[]{11, matcher1, "no.a.0", new Long(-9223372036854775800L), expRecords1},			
			//arr.obj
			new Object[]{12, matcher2, "no.1.a", new Integer(8), expRecords2},
			//arr.arr
			new Object[]{13, matcher3, "no.1.1", new Long(9223372036854775000L), expRecords3},
			//arr boundary:SEQUOIADBMAINSTREAM-2829
			//new Object[]{4, matcher4, "no.1", new Long(-9223372036854775808L), expRecords4},									
		};
	}	
	...
	public void testUpsert(int setInsertValue,String updateName, Object matcherValue,Object incValue,String []expRecords,
		...
		try{			
			...
			Assert.assertTrue(false,"update numeric value overflowoper failed,"+e.getMessage()+e.getErrorCode());
		}		
	}	
