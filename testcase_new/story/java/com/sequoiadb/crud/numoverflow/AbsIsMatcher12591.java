...
public class AbsIsMatcher12591 extends SdbTestBase{
	...
	public Object[][] generateIntDatas(){
		...
		String []expRecords3 = {"{'no3':[-2147483648,{'$numberLong':'-8223372036854775808'}]}"};
		
		return new Object[][]{
			//the parameters: matcherName,matcherValue,expRecords
			new Object[]{"no1",new Long(2147483648L),expRecords1},
			new Object[]{"long",new BigDecimal("9223372036854775808"),expRecords1},
			new Object[]{"no2.a.b",new Long(2147483648L),expRecords2},
			new Object[]{"string",null,expRecords2},
			new Object[]{"no3.0",new Long(2147483648L),expRecords3},
			new Object[]{"no3.1",new BigDecimal("8223372036854775808"),expRecords3},
	...
	public void testAbs(String matcherName,Object resultValue, String []expRecords){
		try{			
			...
			Assert.assertTrue(false,"abs data is used as matcher oper failed,"+e.getMessage());
		}		
	}
