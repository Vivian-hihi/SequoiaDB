...
/**
* FileName: UpsertAsInc12616.java
* test content:Numeric value overflow for update shardingKey using $inc operation,* 				
* testlink case:seqDB-12616
* @author wuyan
    * @Date    2017.9.14
* @version 1.00
*/
...
public class UpsertAsInc12616 extends SdbTestBase{	
	...
	public Object[][] generateDatas(){
		...
		return new Object[][]{
			...
			new Object[]{0, "no", new Integer(1), new Integer(2147483647), expRecords1,expLongType,true,expLongTypeToJava},			
	...
	public Object[][] generateDatas1(){
		...
		return new Object[][]{
			...
			//obj.arr
			new Object[]{11, matcher1, "no.a.0", new Long(-8223372036854775800L), expRecords1},			
			//arr.obj
