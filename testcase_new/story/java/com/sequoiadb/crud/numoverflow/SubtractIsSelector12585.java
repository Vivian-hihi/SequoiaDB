...
public class SubtractIsSelector12585 extends SdbTestBase{
	...
	public Object[][] generateDatas(){
		...
		return new Object[][]{
			...
			new Object[]{0, 1, "no",expRecords1,expLongType,true,expLongTypeToJava},			
			//2147483647 $substract -1,the result is 2147483648(int64)
			new Object[]{1, -1, "no",expRecords2,expLongType,true,expLongTypeToJava},		
			//1147483147 $substract -1047483147,the result is 2194966294(int64)
			new Object[]{2, -1047483147, "no",expRecords3,expLongType,true,expLongTypeToJava},	
			////the arr -2100 $substract 2147481549,the result is -2147483649(int64)
			new Object[]{2, 2147481549, "arr",expRecords4,expArrayType,false,null},	
			//the arr.1 -2100 $substract 2147481549,the result is -2147483649(int64)
			new Object[]{2, 2147481549, "arr.$[1]",expRecords5,null,false,null},
			
			//---int64 and int64
			//tlong:-9223372036854775808 $substract 1,the result is {'$decimal':'-9223372036854775809'}
			new Object[]{0, new Long(1), "tlong",expRecords01,expDecimalType,true,expDecimalTypeToJava},
			//long:9223372036854775807 $substract -1,the result is {'$decimal':'9223372036854775809'}
			new Object[]{1, new Long(-1), "long",expRecords02,expDecimalType,true,expDecimalTypeToJava},
			//long:-8223372036854775807 $substract 1000000000000000002,the result is {'$decimal':'-9223372036854775809'}
			new Object[]{2, new Long(1000000000000000002L), "long",expRecords03,expDecimalType,true,expDecimalTypeToJava},
			//arr:[1000000000,-2147483648] $substract -8223372036854775809
			new Object[]{2, new Long(-9223372035854775808L), "arr",expRecords04,expArrayType,false,null},
			//no.$[1]:8223372036854775807 $substract -1000000000000000002,the result is {'$decimal':'9223372036854775809'}
			new Object[]{3, new Long(-1000000000000000002L), "no.$[1]",expRecords05,expDecimalType,false,null},		
		};
	}
