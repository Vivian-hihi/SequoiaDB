...
/**
* FileName: UpdateAsInc12613.java
* test content:Numeric value overflow for shardingKey using $inc operation, 				
* testlink case:seqDB-12613
* @author wuyan
    * @Date    2017.9.14
* @version 1.00
*/
...
public class UpdateAsInc12613 extends SdbTestBase{	
	...
	public Object[][] generateDatas(){
		...
		String []expRecords2 = {"{no:[-2147483648,{'$decimal':'-9223372036854775809'}],a:1,test:1}"};	
		String []expRecords3 = {"{no:2147483649,a:{'$decimal':'-9223372036854775809'},test:0}"};		
		String []expRecords4 = {"{no:2147,a:{b:{c:{'$decimal':'9223372036854775808'}}},test:2}"};
		...
		return new Object[][]{
			...
			//	
			new Object[]{0, "no",   new Integer(2147483001), expRecords1,expLongType,true,expLongTypeToJava},
			//int64(arr.1)/int64:the result is {'$decimal':'-9223372036854775809'}
			new Object[]{1, "no.1", new Long(-1000000000000000009L),expRecords2,expDecimalType,false,null},
			//int64/int32:the result is {'$decimal':'-9223372036854775809'}
			new Object[]{0, "a",    new Integer(-1), expRecords3,expDecimalType,true,expDecimalTypeToJava},			
			//a.b.c inc 1,the result is {'$decimal':'9223372036854775808'}
			new Object[]{2,  "a.b.c", new Long(1), expRecords4,expDecimalType,false,null},						
		};
	}	
	...
	public void testUpdateShardingKey(int matcherValue,String updateName, Object incValue,String []expRecords,
		...
		try{			
			...
			NumOverflowUtils.updateOper(cl, matcherValue, updateValue, "updateShardingKey");
