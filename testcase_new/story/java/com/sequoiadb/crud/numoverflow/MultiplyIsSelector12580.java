...
/**
* FileName: MultiplyIsSelector12580.java
* test content:Numeric value overflow for single character using $multiply operation,
* 				and the $multiply is used as a selector.
* testlink case:seqDB-12580
* @author luweikang
    * @Date    2017.9.11
* @version 1.00
*/
...
public class MultiplyIsSelector12580 extends SdbTestBase{
	...
	public Object[][] generateIntDatas(){
		...
		String []expRecords3 = {"{'no':2147483647,'long':{'$decimal':'-18446744073709551614'},test:1}"};
		String []expRecords4 = {"{'no':246.0,'double':123.5,'test':2}"};
		String []expRecords5 = {"{'no':123.0,'double':247.0,'test':2}"};
		String []expRecords6 = {"{'no':[2147483147,{'$numberLong':'8223372036854775807'}],'arr':[2147483648],'obj':{a:'123'},'test':3}"};
		String []expRecords7 = {"{'no':[2147483147,{'$numberLong':'8223372036854775807'}],'arr':[1000000000,-2147483648],'obj':null,'test':3}"};
		...
		return new Object[][]{
			...
			//-9223372036854775808 $multiply -1 the result is 9223372036854775808(decimal)
			new Object[]{0, new Integer(-1), "tlong", expRecords2, expDecimalType, true, expJavaDecimal},
			//9223372036854775807 $multiply -2 the result is {'$decimal':'-18446744073709551614'}
			new Object[]{1, new Long(-2), "long", expRecords3, expDecimalType, true, expJavaDecimal},
			//123.0 $multiply 2 the result is 246.0
			new Object[]{2, new Integer(2), "no", expRecords4, expDoubleType, true, expJavaDouble},
			//123.5 $multiply 2(int64) the result is 247.0
			new Object[]{2, new Integer(2), "double", expRecords5, expDoubleType, true, expJavaDouble},
			//arr $multiply -1 the result is [2147483648]
			new Object[]{3, new Integer(-1), "arr.$[1]", expRecords6, expLongType, false, expJavaLong},
			//obj $multiply 1 the result is null
			new Object[]{3, new Integer(-1), "obj", expRecords7, "null", false, null},
		};
	}
	...
	public void testMultiply(int matcherValue,Object mulValue,String selectorName, String []expRecords,String expType,Boolean isVerifyTypeToJava, String expTypeToJava){
		try{			
