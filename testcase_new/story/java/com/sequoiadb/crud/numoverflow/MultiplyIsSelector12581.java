...
/**
* FileName: MultiplyIsSelector12581.java
* test content:set StrictDataType=true,Numeric value overflow for single character using $multiply operation,
* 				and the $multiply is used as a selector.
* testlink case:seqDB-12581
* @author luweikang
    * @Date    2017.9.12
* @version 1.00
*/
