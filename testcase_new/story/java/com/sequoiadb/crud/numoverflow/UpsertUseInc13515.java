...
public class UpsertUseInc13515 extends SdbTestBase {
	...
	public Object[][] generateDatas(){
		...
		return new Object[][]{
			...
			new Object[]{ "no", new Long(-9223372036854775807L), new Integer(-10)},			
			
			new Object[]{ "no", new Long(9223372036854775807L), new Integer(10)},	
			
			new Object[]{ "no.a", new Integer(-2147483648), new Integer(-10)},	
			
			new Object[]{ "no", new Integer(-2147483648), new Integer(-10)},	
			
			new Object[]{ "no.1", new Integer(2147483647), new Integer(10)},	
			
			new Object[]{ "no.a.b.c", new Integer(2147483647), new Integer(10) },
