...
public class TestSplit10886 extends SdbTestBase{
    ...
    public void test() {
        try {
            ...
            BSONObject option = (BSONObject) JSON.parse("{ShardingKey:{nulltype:1},ShardingType:\"hash\",Partition:1024,Group:\"" + rgNames.get(0) + "\"}");
            this.cl = Util.createCL(this.cs, this.clName1, option); 
            this.insertRecords = (ArrayList<BSONObject>) Util.insertData(this.cl, 100);
