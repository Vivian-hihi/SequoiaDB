...
function main()
{
   var csName = CHANGEDPREFIX + "_11784_CS";
   var clName = CHANGEDPREFIX + "_11784_CL";
   ...
   //insertData
   println("---insert data---")
   insertData( csName, clName );
   
   //pop data Direction:1
   println("---pop data direction:1---")
   popData( csName, clName, 1, 1 );
   popData( csName, clName, 3, 1 );
   ...
   {
      checkData( csName, clName );
   }
   else
   {
      standaloneCheckData( csName, clName, 0 );
   }
