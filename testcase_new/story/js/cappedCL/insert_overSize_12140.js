...
function main()
{
   ...
   for(var j = 0 ; j< repeatNum; j++)
   {
      ...
      //var lastLogicalID = getLogicalID(dbcl, null, null, {_id:1}, 1, max - 1);
      //println("lastLogicalID:" + lastLogicalID[0]);
      //var expectLogicalID = parseInt(lastLogicalID[0]) + stringLength + 55;
      println("--overturn times :"+ overturn +" --");
      //下一块第一条记录的id等于块大小32M减去块头36字节
      var expectLogicalID = 1024 * 1024 * 32 * overturn - 36 * overturn;
      println("expectLogicalID:" + expectLogicalID);
      ...
      var lastLogicalID = getLogicalID(dbcl, null, null, {_id:-1}, 1, null);
