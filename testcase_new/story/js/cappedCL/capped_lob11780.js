...
function main( )
{
   ...
   var csName = CHANGEDPREFIX + "_11780_CS";
   var clName = CHANGEDPREFIX + "_11780_CL";
   var putNum = 10;
   var cmd = new Cmd();
   var oids = new Array();
   ...
   var cl = commCreateCLByOption( db, csName, clName, optionObj, false, false, "create cappedCL" );
