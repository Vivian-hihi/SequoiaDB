/************************************
*@Description: 创建固定集合空间集合，参数Size校验
*@author:      luweikang
...
function main()
{
   ...
   //check Size : 33554432
   var options1 = { Capped : true, Size:33554432, Max:10000000, AutoIndexId:false };
   checkCreateCLOptions( csName, clName1, options1, true );
   
   //check Size : 8796093022208
   var options2 = { Capped : true, Size:8796093022208, Max:10000000, AutoIndexId:false };
   checkCreateCLOptions( csName, clName2, options2, true );
   
   //check Size : 123.456
   var options3 = { Capped : true, Size:123.456, Max:10000000, AutoIndexId:false };
   checkCreateCLOptions( csName, clName3, options3, false );
   
   //check Size : 8796093022209
   var options4 = { Capped : true, Size:8796093022209, Max:10000000, AutoIndexId:false };
   ...
   //check Sie : -1
   var options8 = { Capped : true, Sie:1024000000, Max:10000000, AutoIndexId:false };
