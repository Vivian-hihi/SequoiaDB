...
function main()
{
   ...
   println("--end check data after pop block in the tail!");
   ...
   checkLogicalID( dbcl, null, null, {_id:-1}, 1, null, expectID);
   checkRecords( dbcl, null, null, {_id:-1}, 1, null, lastExpRec );
   println("--end check data after pop block in the middle!");
   ...
   checkLogicalID( dbcl, null, null, {_id:-1}, 1, null, expectID);
   checkRecords( dbcl, null, null, {_id:-1}, 1, null, lastExpRec );
   println("--end check data after pop block in the head");
