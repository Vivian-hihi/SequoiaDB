...
function testTruncateCompareRemveDelete( db )
{
   ...
   try
   {
      ...
      var lobSize = 2049;
      var lobNumber = 5;
      var clName1 = CHANGEDPREFIX + "_truncate_tbl1";
      var clName2 = CHANGEDPREFIX + "_truncate_tbl2";
      var recordNumber = 5;
      ...
      var cursor1 = truncatePutLob( cl1, lobSize, lobNumber );
      var cursor2 = truncatePutLob( cl2, lobSize, lobNumber );
      ...
      {
         //println( "lob oid: " + cursor1[i] );
         cl1.deleteLob( cursor1[i] );
      }
      truncateVerify( db, tableName1, verfify1 );   // verify records
      ...
      truncateVerify( db, tableName1, verfify1 );   // verify lobs
