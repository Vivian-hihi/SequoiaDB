...
function testTruncateNormalCLMultiIndexKey( db )
{
   ...
   try
   {
      var clName = CHANGEDPREFIX + "_normal_cl_index";
...
function testTruncateMixtureCLMultiIndex( db )
{
   ...
   try
   {
      ...
      var mainCLOption = { "ShardingKey": {"id": 1}, "ShardingType": "range",
                           "ReplSize": 0, "IsMainCL": true };
      var subCLOption = { "ShardingKey": {"id": 1}, "ShardingType": "hash",
                          "ReplSize": 0 };
      var recordNum = 4000;
      ...
      mainCL.attachCL( subTable1, {"LowBound":{"id": 0},
                                   "UpBound": {"id": 2000}} );
      mainCL.attachCL( subTable2, {"LowBound":{"id": 2000},
                                   "UpBound": {"id": 4000}} );
...
/*
      ...
      commDropCS( db, mainCS, false, "drop main cs end" );
      truncateDropDomain( db, domainName, false);
      commDropIndex( mainCL, indexName1, false )
      commDropIndex( mainCL, indexName2, false )
      commDropIndex( mainCL, indexName3, false )
*/
   }
}
