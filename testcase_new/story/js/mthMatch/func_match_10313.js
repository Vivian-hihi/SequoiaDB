...
function main()
{
   ...
   var explainRecs13 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
   ...
   var explainRecs14 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
   ...
   var explainRecs15 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
   ...
   var explainRecs16 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
   ...
   var explainRecs17 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
   ...
   var explainRecs18 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
   ...
   var explainRecs19 = [{Name:COMMCSNAME + "." + COMMCLNAME,
	                    ScanType:"tbscan",
	                    IndexName:"",
