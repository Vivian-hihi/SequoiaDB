...
function main()
{
   ...
   dbcl.insert(objs);
   dbcl.update({$set:{a:{0:"update", 1:"update", 2:1}}});
   ...
   var expResult = [{a:{0:"update", 1:"update", 2:1}, b:"string"},
                    {a:{0:"update", 1:"update", 2:1}, b: 1},
                    {a:{0:"update", 1:"update", 2:1}, b:{0:"obj3", 1:"obj4", 2:"obj5"}}];
