...
function main()
{
	...
	{
		throw buildException( "listSession", e, "listSession by session=2 options="+JSON.stringify({Global:true, Type:{$nin:["Agent","ShardAgent","CoordAgent","ReplAgent","HTTPAgent"]}}));
	}
	...
	{
		throw buildException( "listSession", e, "forceBefore:listSession by session=2 options="+JSON.stringify({Global:true, SessionID:sessionID}));
	}
	...
	{
		throw buildException( "listSession", e, "forceAfter:listSession by session=2 options="+JSON.stringify({Global:true, SessionID:sessionID}));
	}
