...
function main()
{
   ...
   var dbcl = commCreateCL( db, COMMCSNAME, COMMCLNAME, 0 );
	...
	var updateCondition1 = {$push_all:{object1:[10,50,"string"],
	                                   "object4.1":[5,{$date:"2016-05-16"},7,4]}};
	updateData( dbcl, updateCondition1 );
	
	//check result
   var expRecs1 =[{object0:[10,-30,20],
