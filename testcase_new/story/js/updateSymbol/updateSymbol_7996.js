...
function main()
{
   ...
   var upsertCondition1 = {$addtoset:{arr1:[100,105,99,20],
                                    "arr2.1":[15,10,35],
                                    "arr3.1":[55,40,60]}};
   var findCondition1 = {$and:[{"arr2.1":{$et:{$decimal:"2"}}},
   ...
   //check result
   var expRecs1 = [{arr1:[10,30,20,10,99,100,105],
                    arr2:{1:{$decimal:"2"}},
                    d:1000,
                    e:{name:{firstName:"han"}},
   ...
   var upsertCondition2 = {$addtoset:{arr1:[100,105,99,20],
                                    "arr2.1":[15,10,35],
                                    "arr3.1":[55,40,60]}};
   var findCondition2 = {$or:[{"arr2.1":{$et:{$decimal:"5"}}},
   ...
   //check result
   var expRecs2 = [{arr1:[10,30,20,10,99,100,105],
                    arr2:{1:{$decimal:"2"}},
                    d:1000,
                    e:{name:{firstName:"han"}},
                    arr3:[55,[35,25,40,55,60],50,45,70]},
   ...
   var upsertCondition3 = {$addtoset:{arr1:[100,105,99,20],
                                      "arr2.1":[15,10,35],
                                      "arr3.1":[55,40,60]}};
   var findCondition3 = {$not:[{"arr2.1":{$et:{$decimal:"5"}}},
                               {arr1:{$all:[1000,30,20,10]}},
                               {c:{$gt:100}},
                               {d:1001},
                               {"e.name.lastName":"meimei"},
   ...
   //check result
   var expRecs3 = [{arr1:[20,99,100,105],
                    arr2:{1:[10,15,35]},
                    arr3:{1:[40,55,60]}}];
