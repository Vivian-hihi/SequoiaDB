...
function twoName(){  //"XXXX&nam=foo&name=foo1" 
...
function formatError1(){  //"XXXX&a=1=2&XXXX"   a value is 1=2
	var word="create collectionspace";
...
function formatError2(){  //"XXXX&a&b=1"   can't get a value
	var word="create collectionspace";
	tryCatch(["cmd="+word,'name','b='+csName] , [-6] , getFuncName()+"error occurs!!");
}

function formatError3(){  //"XXXX&a==1&XXXX"   a value is =1
	var word="create collectionspace";
...
function formatError4(){  //"XXXX&&&a=1"   a value is 1
	var word="create collectionspace";
