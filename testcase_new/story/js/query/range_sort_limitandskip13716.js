...
function main()
{
	try
   {
	   ...
	   var clName = COMMCLNAME+"_13716";

	   var varCS = commCreateCS( db, csName, true, "create CS in the beginning" );
	   var rangeCL = varCS.createCL(clName,{ShardingKey:{a:1},ShardingType:'range',ReplSize:0});
