...
function main(){
   ...
   //insert all type data 
	var doc = [{a:100},
	           ...
	           {a:{$regex:"^a",$options:"i"}},
	           {a:{b:1}},
	           {a:[1,20,30]},{a:[1,20,30]},{a:[20,1,30]},{a:[1,20,40]},{a:[1,25,10]},{a:[2,30,40]},{a:["a",60,70]},
   ...
   var expRecs6 = [ {a:100},
      	           ...
      	           {a:{$regex:"^a",$options:"i"}},
      	           {a:{b:1}},
      	           {a:[20,1,30]},{a:[1,20,40]},{a:[1,25,10]},{a:[2,30,40]},{a:["a",60,70]},
      	           {a:[0,-10,-20]},{a:[0,30,40]},{a:[1,20]},
      	           {a:null},
      	           {a:{$minKey:1}},
      	           {a:{$maxKey:1}},
