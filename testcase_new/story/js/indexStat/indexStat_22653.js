...
function test()
{
   ...
   delete( actResult.StatTimestamp );
   expResult = { "Collection": COMMCSNAME + "." + subCLName2, "Index": "index_22653", "Unique": false, "KeyPattern": { "b": 1 }, "TotalIndexLevels": 1, "TotalIndexPages": 3, "DistinctValNum": [ 3 ], "MinValue": null, "MaxValue": null, "NullFrac": 5000, "UndefFrac": 5000, "SampleRecords": 80, "TotalRecords": 80 };
   if( !commCompareObject( expResult, actResult ) )
   {
      throw new Error( "\nExpected:\n" + JSON.stringify( expResult ) + "\nactual:\n" + JSON.stringify( actResult ) );
   }
   ...
   delete( actResult.StatTimestamp );
   expResult = { "Collection": COMMCSNAME + "." + mainCLName, "Index": "index_22653", "Unique": false, "KeyPattern": { "b": 1 }, "TotalIndexLevels": 1, "TotalIndexPages": 4, "DistinctValNum": [4], "MinValue": null, "MaxValue": null, "NullFrac": 5000, "UndefFrac": 5000, "SampleRecords": 180, "TotalRecords": 180 }; 
   if( !commCompareObject( expResult, actResult ) )
   {
      throw new Error( "\nExpected:\n" + JSON.stringify( expResult ) + "\nactual:\n" + JSON.stringify( actResult ) );
   }  
