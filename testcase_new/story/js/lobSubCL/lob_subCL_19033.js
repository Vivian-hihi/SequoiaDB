...
function main()
{
    ...
    var filePath = WORKDIR + "/testfile19033";
    ...
    var lobOids1 = insertLob(subCL, filePath, "YYYYMMDD", 5, 10, 1, "20190801");
    var lobOids2 = insertLob(subCL, filePath, "YYYYMMDD", 5, 10, 1, "20190901");
