...
function main()
{
    ...
    var filePath = WORKDIR + "/testfile19037";
    ...
    var lobOids1 = insertLob(mainCL, filePath, "YYYYMMDD", 5, 10, 1, "20190501");
    var lobOids2 = insertLob(mainCL, filePath, "YYYYMMDD", 5, 10, 1, "20190701");
