...
SecureSdb.prototype._getTraceInfo=function(){try{return tmpSecureSdb._getTraceInfo.apply(this,arguments);}catch(e){var msg = e.message || e; throw new Error(msg);}};
...
SecureSdb.prototype._traceOff=function(){try{return tmpSecureSdb._traceOff.apply(this,arguments);}catch(e){var msg = e.message || e; throw new Error(msg);}};
