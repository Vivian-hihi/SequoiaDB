/*******************************************************************************
*@Description : add new type for migrate. new type is : $oid, $binary, $regex
*               [SEQUOIADBMAINSTREAM-467]
*@Modify list :
...
function main( db )
{
   try
   {
      var FILENAME = LocalPath + "/" + CHANGEDPREFIX + "_csvMig_newType_Jira467.file",
...
*******************************************************************************/
      var expCmdOption = "--hostname "+COORDHOSTNAME+" --svcname "+COORDSVCNAME+
                         ...
                         " --fields '_id, key_oid, key_binary, key_regex'" ;
      try
      {
...
*******************************************************************************/
      ...
      var impCmdOption = "--hostname "+COORDHOSTNAME+" --svcname "+COORDSVCNAME+
                         ...
                         " --fields '_id oid,key_oid oid,key_binary binary,key_regex regex'" ;
      try
      {
         // import data
