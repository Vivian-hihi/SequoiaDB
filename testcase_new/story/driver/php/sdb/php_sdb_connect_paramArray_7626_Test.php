...
@input:        1 connect, $address: array, $useSSL: false
...
class SdbConnect01 extends BaseOperator 
{  
   ...
   function connect()
   {  
      $address  = array( $this -> COORDHOSTNAME .":". $this -> COORDSVCNAME );
		$userName = '';
		$password = '';
		$useSSL   = false;
...
class testSdbConnect01 extends PHPUnit_Framework_TestCase
{
   protected static $dbh;
   
   public static function setUpBeforeClass()
   {
      self::$dbh = new SdbConnect01();
   }
