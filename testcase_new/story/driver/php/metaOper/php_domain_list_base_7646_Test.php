/****************************************************
@description:      listCS / listCL / listGroups, cover required parameter
@testlink cases:   seqDB-7645 / seqDB-7646
@input:      1 test_createDomain, $options: multi groups
             2 test_createCL
             3 test_createCS
             4 test_listCS, all param: null
             5 test_listCL, all param: null
             6 test_listGroups, all param: null
             7 test_dropDomain
@output:     success
@modify list:
...
class TestDomain03 extends PHPUnit_Framework_TestCase
{
   ...
   function test_createDomain()
   {
      ...
      $this -> assertEquals( 0, $errno, 'Failed to create domain, errCode:'. $errno ); 
   }
