...
/**
 * test content: 指定vesion查询对象，其中指定key不存在
 * testlink-case: seqDB-16689 
 * @author wangkexin
 * @Date 2018.12.10
 * @version 1.00
 */
...
public class TestGetObjectMetadata16689  extends S3TestBase{
	...
	private void testGetObjectMetadata() throws Exception {
		...
		try{
			s3Client.getObjectMetadata(new GetObjectMetadataRequest(bucketName, nonExistKeyName, versionid));
