...
/**
 * test content: enabling bucket versioning,get object with ifMatch and specify versionId
 * testlink-case: seqDB-16369
 * @author wuyan
 * @Date 2018.11.14
 * @version 1.00
 */
public class GetObjectWithIfMatch16369 extends S3TestBase{
	...
	public void testGetObject() throws Exception {		
		...
		getObjectWithIfMatchAndCheckContent(S3TestBase.enableVerBucketName, key, 
	...
	private void getObjectWithIfMatchAndCheckContent(String bucketName, String key, String versionId, String filePath) throws Exception{
