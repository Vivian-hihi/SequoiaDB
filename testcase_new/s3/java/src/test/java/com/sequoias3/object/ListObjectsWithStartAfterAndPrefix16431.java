...
/**
 * test content:  To get a list of objects within a bucket.specify startAfter/prefix/delimiter. 
 *                match prefix and startAfter, no match delimiter
 * testlink-case: seqDB-16431              
 * @author wuyan
 * @Date 2018.11.27
 * @version 1.00
 */
public class ListObjectsWithStartAfterAndPrefix16431 extends S3TestBase{
	...
	private void listObjectsAndCheckResult( List<String> keyList, int startAfterNo,String delimiter) throws IOException{
