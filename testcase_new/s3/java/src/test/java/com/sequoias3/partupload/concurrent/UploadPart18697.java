...
/**
 * @Description seqDB-18697: upload multiple parts concurrently,the length of the parts is different and there is partNum of 1.
 * @author wuyan
 * @Date 2019.07.29
 * @version 1.00
 */
public class UploadPart18697 extends S3TestBase {	
	...
	public void uploadParts() throws Exception {			
		...
		int partNums = 5;
		int[] partSizes = {1024 * 1024 * 6,1024 * 1024 * 8,1024 * 1024 * 5,1024 * 1024 * 10,1024 * 1024 * 7};
		int[] offSets =  {0, 1024 * 1024 * 6, 1024 * 1024 * 14,1024 * 1024 * 19,1024 * 1024 * 29 };
		...
		private void partUpload() {	
			try{		
				UploadPartRequest partRequest = new UploadPartRequest().withFile(file)
							.withFileOffset(filePosition).withPartNumber(partNum ).withPartSize(partSize)
