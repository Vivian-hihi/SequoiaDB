...
public class AbortMultipartUpload18726 extends S3TestBase {
    ...
    private void test() throws Exception {
        ...
        List<PartETag> partETags = PartUploadUtils.partUpload(s3ClientA, bucketName, key, uploadId, 
        ...
        PartUploadUtils.listPartsAndCheckPartNumbers(s3ClientA, bucketName, key, 
                partETags, uploadId);
