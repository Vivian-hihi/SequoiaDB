...
/**
 * test content: 带分隔符查询桶中对象版本列表，匹配部分记录
 * testlink-case: seqDB-18139
 * @author wangkexin
 * @Date 2019.04.24
 * @version 1.00
 */
...
public class ListObjectVersionsWithDelimiter18139 extends S3TestBase {
	...
	public void testGetObjectList() throws Exception {
		...
		Assert.assertEquals(actVersionsKeyName, versions, "the returned result by versions is wrong, act: " + actVersionsKeyName.toString() + ", exp: " + versions.toString());
