...
public class ListVersionsByPrefixDelimiter18960 extends S3TestBase {
	...
	private void checkListVSResults(VersionListing vsList, List<String> expCommonPrefixes,
		...
		for (S3VersionSummary versionSummary : vsSummaryList) {
			...
			actMap.add(versionSummary.getKey(), String.valueOf(versionSummary.isDeleteMarker()));
		}
