...
/**
 * test content:  不开启版本控制，带分隔符查询桶中对象版本列表 
 * testlink-case: seqDB-18140
 * @author wangkexin
 * @Date 2019.04.25
 * @version 1.00
 */
...
public class ListObjectVersionsWithDelimiter18140 extends S3TestBase {
	...
	private String sameDirKeyName[] = {"dir1?test123","dir10?test123","dir50?test123"};
	...
	private void setUp() throws Exception {
		...
		for(int i = 0 ; i < objectNames.length ; i++){
			...
			s3Client.putObject(bucketName, currentKeyName, "object_file18140");
