    ...
    private void testDoesObjectExist() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage()
                    .equals("The bucket name parameter must be specified when requesting an object's metadata"));
        }
        ...
        try {
            ...
            Assert.assertTrue(
                    e.getMessage().equals("The key parameter must be specified when requesting an object's metadata"));
        }
