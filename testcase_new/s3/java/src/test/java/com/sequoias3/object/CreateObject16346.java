...
public class CreateObject16346 extends S3TestBase {
    ...
    public void testCreateBucket() throws Exception {
        ...
        Assert.assertEquals(object.getObjectMetadata().getContentEncoding(), content_encoding,
                "ContentEncoding is wrong");
        ...
        Assert.assertEquals(object.getObjectMetadata().getContentDisposition(), content_disposition,
                "ContentDisposition is wrong");
        Assert.assertEquals(getGMTDate(object.getObjectMetadata().getHttpExpiresDate()), expires, "Expires is wrong");
        Assert.assertEquals(object.getObjectMetadata().getUserMetadata().get("myparameter"), x_amz_meta_x,
                "x-amz-meta-* is wrong");
