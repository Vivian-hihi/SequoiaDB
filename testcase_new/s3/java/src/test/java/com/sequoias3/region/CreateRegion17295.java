...
/**
 * @Description seqDB-17295: create Region and specify cs and cl. the metaCL and metaHisCL no unique index
 * @author wuyan
 * @Date 2019.1.21
 * @version 1.00
 */
public class CreateRegion17295 extends S3TestBase{
	...
	private void setUp() throws Exception {	
		...
		RegionUtils.createCSAndCL(sdb,csNames[1], dataclNames);		
