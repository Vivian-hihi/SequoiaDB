...
/**
 * test content:  GetBucketVersion2接口参数校验
 * testlink-case: seqDB-16480
 * @author wangkexin
 * @Date 2019.01.08
 * @version 1.00
 */
public class TestGetBucketVersion2_16480 extends S3TestBase {
	...
	private void setUp() throws Exception {
		...
		s3Client.putObject(bucketName, "aa/bb/key16480_1/123", "content16480_1");
		s3Client.putObject(bucketName, "aa/bb/key16480_2/456", "content16480_2");
	}
	...
	public void testListObjectsV2(){
		...
		try{
			...
			Assert.assertEquals(e.getMessage(), "The bucket name parameter must be specified when listing objects in a bucket");
		}
