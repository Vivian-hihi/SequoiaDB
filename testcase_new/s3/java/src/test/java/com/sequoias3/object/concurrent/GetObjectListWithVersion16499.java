        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                Assert.assertEquals(actVersionsKeyName, expresultList1,
                        "the returned result by versions is wrong, act: " + actVersionsKeyName.toString() + ", exp: "
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                Assert.assertEquals(actCommonPrefixes, expresultList3,
                        "the returned result by commonperfixes is wrong, act: " + actCommonPrefixes.toString()
                                + ", exp: " + expresultList3.toString());
            } finally {
                if (s3Client != null) {
                    s3Client.shutdown();
                }
