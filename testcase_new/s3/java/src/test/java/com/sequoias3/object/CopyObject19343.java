...
public class CopyObject19343 extends S3TestBase {
    ...
    private void setUp() {
        ...
        PutObjectResult result = s3Client.putObject(bucketName, srcKeyName, srcKeyContent);
    ...
    public void testCopyObject() throws Exception {
        ...
        try {
            ...
            request.withModifiedSinceConstraint(date).withNonmatchingETagConstraint(etag);
