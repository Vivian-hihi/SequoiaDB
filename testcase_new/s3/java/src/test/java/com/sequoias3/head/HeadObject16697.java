...
/**
 * @Description seqDB-16697:head object with match conditions: ifNoneMatch and ifUnModifiedSince
 * @author wuyan
 * @Date 2018.12.18
 * @version 1.00
 */
...
public class HeadObject16697  extends S3TestBase{
	...
	private void testHeadObject() throws Exception {		
		PutObjectResult resultV1 =  s3Client.putObject(S3TestBase.enableVerBucketName, key, "testobject16697v100");
		String etagV1 = resultV1.getETag();		
		s3Client.putObject(S3TestBase.enableVerBucketName, key, "testobject16697v2");			
		s3Client.putObject(S3TestBase.enableVerBucketName, key, "testobject16697v3");	
	
		GetObjectMetadataRequest getRequest = new GetObjectMetadataRequest(S3TestBase.enableVerBucketName, key);
