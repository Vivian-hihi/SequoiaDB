...
/**
 * @Description seqDB-16696:head object with match conditions: ifMatch and ifNoneMatch,mismatch ifMatch
 * @author wuyan
 * @Date 2018.12.18
 * @version 1.00
 */
...
public class HeadObject16696  extends S3TestBase{
	...
	private void testHeadObject() throws Exception {
		...
		PutObjectResult resultV1 =  s3Client.putObject(bucketName, key, "testobject16696v100");
		String etagV1 = resultV1.getETag();
		String versionidV1 = resultV1.getVersionId();
		PutObjectResult resultV2 =  s3Client.putObject(bucketName, key, "testobject16696v2");
	    ...
	    try{
			...
			Assert.assertTrue(e.getMessage().contains("errcode=412"),"errorMsg is:" + e.getMessage());
		}	    
    	runSuccess = true;
	}
