...
public class CompleteMultipartUploadRequest18811 extends S3TestBase {
    ...
    public Object[][] generateKeyName() {
        return new Object[][] { new Object[] { ObjectUtils.getRandomString(1) },
    ...
    public void testIllegalParameter() throws Exception {
        ...
        request = new CompleteMultipartUploadRequest(bucketName, ObjectUtils.getRandomString(901), uploadId, partEtags);
        try {
            s3Client.completeMultipartUpload(request);
