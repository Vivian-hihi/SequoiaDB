...
public class ListMultipartUploadsWithDelimiter18742 extends S3TestBase {
	...
	private String[] keyNames = { "atest0_18742.png", "dir1/a/test1_18742.png", "dir1/dir2/a/test2_18742.png",
			"/a/test3_18742.png", "dir4/test4_18742.png" };
	...
	private void listPartUploadsMatchedDelimiter(MultiValueMap<String, String> uploadIds, String delimiter) {
	...
	private void listPartUploadsMisMatchedDelimiter(MultiValueMap<String, String> uploadIds, String delimiter) {
		ListMultipartUploadsRequest request = new ListMultipartUploadsRequest(bucketName).withDelimiter(delimiter);
		MultipartUploadListing result = s3Client.listMultipartUploads(request);

		List<String> expCommonPrefixes = new ArrayList<>();
		PartUploadUtils.checkListMultipartUploadsResults(result, expCommonPrefixes, uploadIds);
	}
