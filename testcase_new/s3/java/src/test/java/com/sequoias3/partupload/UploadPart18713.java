...
public class UploadPart18713 extends S3TestBase {
    ...
    private void setUp() throws Exception {
        ...
        filePath = localPath + File.separator + "localFile_" + oldFileSize + ".txt";
        ...
        filePath = localPath + File.separator + "localFile_" + newFileSize + ".txt";
    ...
    private List<PartETag> partUpload(String uploadId, long partSizes[], File file) {
