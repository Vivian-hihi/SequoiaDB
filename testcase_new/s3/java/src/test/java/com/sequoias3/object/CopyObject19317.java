...
public class CopyObject19317 extends S3TestBase {
    ...
    private void setUp() throws IOException {
        ...
        PutObjectResult objResultA = s3Client.putObject(bucketName, keyNameA, new File(filePath));
        xMeta.put("def", "test");
        metadata.setUserMetadata(xMeta);
        objResultA.setMetadata(metadata);
        PutObjectRequest request = new PutObjectRequest(bucketName, keyNameA, new File(filePath));
    ...
    private void testCopyObject_A() throws Exception {
        CopyObjectRequest request = new CopyObjectRequest(bucketName, keyNameA, bucketName, keyNameB);
    ...
    private void checkObjectAttribute(String keyName, Map<String, String> expMeta) throws IOException {
