...
/**
 * test content: create object,the key name of the same name already exists
 * testlink-case: seqDB-16338
 * @author wuyan
 * @Date 2018.11.12
 * @version 1.00
 */
public class CreateSameObject16338 extends S3TestBase{
	...
	private void setUp() throws IOException {	
		...
		CommLib.deleteAllObjects(s3Client, S3TestBase.bucketName);		
	}
