...
public class UploadPartAndCompleteMultipartUpload19437 extends S3TestBase {
    ...
    private Object[][] generateFirstPartSize() {
        ...
        return new Object[][] { new Object[] { 20 * 1024 * 1024 }, new Object[] { 30 * 1024 * 1024 },
                new Object[] { 0 } };
    }
    ...
    public void uploadParts(long thirdPartSize) throws Exception {
        ...
        String expMd5WithPart3 = TestTools.getLargeFilePartMD5(file, 0, 2 * partSize + thirdPartSize);
        String expMd5WithoutPart3 = TestTools.getLargeFilePartMD5(file, 0, 2 * partSize);
        ...
        private void partUpload() {
            try {
                ...
                UploadPartRequest partRequest = new UploadPartRequest().withFile(file).withFileOffset(filePosition)
                        .withPartNumber(3).withPartSize(partSize).withBucketName(S3TestBase.bucketName).withKey(keyName)
