...
public class GetObjectByUnModifiedSince16372 extends S3TestBase {
    ...
    private void test() throws Exception {
        ...
        S3Object object = s3Client.getObject(new GetObjectRequest(bucketName, objectName).withVersionId(randomVersionId)
        ...
        S3Object object1 = s3Client.getObject(new GetObjectRequest(bucketName, objectName)
                .withVersionId(randomVersionId).withUnmodifiedSinceConstraint(cal.getTime()));
        // check the content
