...
public class UploadPart18674 extends S3TestBase {
	...
	private void testUpload3(String keyName, long setPartSize) throws Exception {
		String uploadId = PartUploadUtils.initPartUpload(s3Client, bucketName, keyName);
	...
	private String[] getMD5s(File file, long offset, long partsize) throws IOException {
