...
public class GetObjectList16440 extends S3TestBase {
    ...
    private String[] keyNames = { "%6Ftest!_ST.-(test0|0.txt", "%6Ftest!_、/abc*st/ab）|1.txt",
            "%6Ftest!_@#$%~^@><|2.txt" };
    ...
    public void testGetObject() throws Exception {
        ...
        ObjectUtils.checkListObjectsV2Commprefixes(commprefixesResult, expCommprefixList);

        List<S3ObjectSummary> content = result.getObjectSummaries();
        Assert.assertEquals(content.get(0).getKey(), contentKey, "contents is wrong");
        runSuccess = true;
    }
