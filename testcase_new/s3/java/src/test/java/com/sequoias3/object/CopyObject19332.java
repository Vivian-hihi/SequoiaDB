...
public class CopyObject19332 extends S3TestBase {
    ...
    public void testCopyObject() throws Exception {
        ...
        String hisVersionETag = TestTools.getMD5(hisVersionContent.getBytes());
        CopyObjectRequest request = new CopyObjectRequest(bucketName, srcKeyName, bucketName, destKeyName);
        request.withMatchingETagConstraint(curVersionEtag).withNonmatchingETagConstraint(hisVersionETag);
