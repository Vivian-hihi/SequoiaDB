...
public class DeleteAndGetSameObject16505 extends S3TestBase {
    ...
    private void setUp() throws Exception {
        ...
        versionId2Etg.put("1", TestTools.getMD5((content + "v2").getBytes()));
        versionId2Etg.put("0", TestTools.getMD5((content + "v1").getBytes()));
    }
    ...
    private class GetObjectThread extends S3ThreadBase {
        ...
        public void exec() throws Exception {
            ...
            try {
                ...
                Assert.assertEquals(getObjectMd5, TestTools.getMD5((content + "v2").getBytes()), "md5 is wrong!");
                Assert.assertEquals(object.getObjectMetadata().getVersionId(), "1");
    ...
    private void checkDeleteResult() {
        ...
        VersionListing verList = s3Client.listVersions(new ListVersionsRequest().withBucketName(bucketName));
        List<S3VersionSummary> objectVersionList = verList.getVersionSummaries();
