...
/**
 * @Description seqDB-18675: upload multiple parts,all parts are of equal length(default size is 5M)
 * @author wuyan
 * @Date 2019.07.25
 * @version 1.00
 */
public class UploadPart18675 extends S3TestBase {
	...
	public Object[][] generateFileSize(){
		return new Object[][]{
			...
			//test b: the last part length is 1,the fileSize is 1024 * 1024 * 5 * 10 + 1
			//new Object[]{1024 * 1024 * 50 + 1},
			//test c: the last part length is 5M - 1,,the fileSize is 1024 * 1024 * 5 * 5 - 1
