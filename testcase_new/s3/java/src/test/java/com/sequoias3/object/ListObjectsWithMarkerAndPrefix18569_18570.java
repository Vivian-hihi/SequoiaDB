...
public class ListObjectsWithMarkerAndPrefix18569_18570 extends S3TestBase {
    ...
    // no mathch prefix
    private void listObjectsAndCheckResultA(String matchMarker, String matchPrefix, String matchDelimiter) {
        ListObjectsRequest request = new ListObjectsRequest().withBucketName(bucketName).withMarker(matchMarker)
        ...
        Assert.assertEquals(queryKeyList.size(), 0, "queryKey=" + queryKeyList.toString());
    }

    // no match delimiter
    private void listObjectsAndCheckResultB(int startPosition, String matchPrefix, String matchDelimiter) {
