...
/**
 * test content: test 16442:delete object 
 *               test 16443:delete objects that do not exist 
 * testlink-case: seqDB-16442/16443
 * @author wuyan
 * @Date 2018.11.21
 * @version 1.00
 */
public class DeleteObject16442_16443 extends S3TestBase{
	...
	public void testDeleteObject() {
		...
		//test 16442:delete object that do not exist 
		s3Client.deleteObject(S3TestBase.bucketName, key);
		runSuccess = true;
	}
