...
public class ListObjects18575 extends S3TestBase {
	...
	private String[] keyList = { "dir/atest%_18575.png", "dir1?/dir2?%test1_18575.png",
			"dir1??dir2??%/dir3/test2_18575", "dir1?a%test3_18575", "dir1?dir2?aa?%test4_18575",
			"dir1?%dir2?aa?cc?%test5_18575", "dir1?dir2?aa?%dd?test6_18575", "dir1_18575" };
	...
	private void listObjectsAndCheckResult() {
		...
		request.withDelimiter(delimiter1).withPrefix(prefix).withMarker(marker).withMaxKeys(maxKeys);
		...
		Assert.assertEquals(commonPrefixes, matchPrefixList1,
				"actPrefixes:" + commonPrefixes.toString() + "\n expPrefixes:" + matchPrefixList1.toString());
		...
		String prefix2 = "dir";
		int maxKeys2 = 5;
		request.withDelimiter(delimiter2).withPrefix(prefix2).withMaxKeys(maxKeys2);
