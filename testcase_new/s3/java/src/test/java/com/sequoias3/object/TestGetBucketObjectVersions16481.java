...
/**
 * test content:  GetBucketObjectVersion接口参数校验
 * testlink-case: seqDB-16481
 * @author wangkexin
 * @Date 2019.01.08
 * @version 1.00
 */
public class TestGetBucketObjectVersions16481 extends S3TestBase {
	...
	private void setUp() throws Exception {
		...
		s3Client.putObject(bucketName, "aa/bb/key16481_1/123", "content16481_1");
		s3Client.putObject(bucketName, "aa/bb/key16481_2/456", "content16481_2");
		s3Client.putObject(bucketName, "aa/bb/key16481_3/789", "content16481_3");
		s3Client.putObject(bucketName, "aa/bb/key16481_4/000", "content16481_4");
	}
	...
	public void testListObjectsV2() throws UnsupportedEncodingException{
		...
		Assert.assertEquals(commonPrefixes.get(0), URLEncoder.encode("aa/bb/key16481_3/", "UTF-8"));
		...
		try{
			...
			Assert.assertEquals(e.getMessage(), "The bucket name parameter must be specified when listing versions in a bucket");
		}
		runSuccess = true;
	}
