...
public class CopyObject19440 extends S3TestBase {
    ...
    private void setUp() throws IOException {
        ...
        PutObjectRequest request = new PutObjectRequest(bucketName, srcKeyName, new File(filePath));
    ...
    private void copyObjectWithInvalidMeta(String destKeyName, String metadataDirective) throws Exception {
        try {
            ...
            Assert.assertEquals(e.getErrorCode(), "InvalidArgument", e.getStatusCode() + e.getErrorMessage());
        }
