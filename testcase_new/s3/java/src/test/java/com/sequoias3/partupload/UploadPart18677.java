...
/**
 * @Description seqDB-18677: upload multiple parts,the length of the first part is different form the other parts.
 * @author wuyan
 * @Date 2019.07.26
 * @version 1.00
 */
public class UploadPart18677 extends S3TestBase {
	...
	public Object[][] generateFileSize(){
		return new Object[][]{
			...
			//test a: the length of the first part is greater than the other parts			
			new Object[]{1024 * 1024 * 26, 1024 * 1024 * 6, 1024 * 1024 * 5},
			//test b: the length of the first part is smaller than the other parts
			new Object[]{1024 * 1024 * 27, 1024 * 1024 * 6, 1024 * 1024 * 7},
			//test c: the length of the first part is different from the last part
			//the first part length is 1024 * 1024 * 5 + 1024, the last part length is 1024 * 1024 ,other pasts is 1024 * 1024 * 5
			new Object[]{1024 * 1024 * 5 + 1024 + 1024 * 1024 * 5 * 4 + 1024 * 1024 , 1024 * 1024 * 5 + 1024, 1024 * 1024 * 5},			
		};
	}
	...
	public void uploadParts( int fileSize,long firstPartSize, long eachPartSize ) throws Exception {	
		...
		System.out.println("--filemd5="+TestTools.getMD5(filePath));
		String uploadId = PartUploadUtils.initPartUpload(s3Client, S3TestBase.bucketName, keyName);
		List<PartETag> partEtags = partUpload( s3Client, bucketName, keyName, uploadId, file,firstPartSize,eachPartSize);		
	...
	private  List<PartETag> partUpload(AmazonS3 s3Client, String bucketName, String key, String uploadId, File file,Long firstPartSize,long partSize){
