...
public class GetRegionMessage17313 extends S3TestBase {
    ...
    public void testGetRegionMessage() throws Exception {
        ...
        specifiedModeRegion.withName(specifiedRegionName).withMetaLocation(metaLocation)
                .withMetaHisLocation(metaHisLocation).withDataLocation(dataLocation);
        ...
        shardingTypeModeRegion.withName(shardingTypeRegionName).withDataCSShardingType("quarter")
                .withDataCLShardingType("month").withDataDomain(dataDomain).withMetaDomain(metaDomain);
