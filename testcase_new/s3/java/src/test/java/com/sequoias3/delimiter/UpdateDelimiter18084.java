...
/**
 * test content: 上传多个对象（对象名包含分隔符），更新分隔符
 * testlink-case: seqDB-18084
 * @author wangkexin
 * @Date 2019.04.12
 * @version 1.00
 */
public class UpdateDelimiter18084 extends S3TestBase {
	...
	private void testUpdateDelimiter(int keyNum) throws Exception {
		...
		DelimiterUtils.listObjectsWithDelimiter(s3Client, bucketName, delimiter2, expCommonPrefixes, new ArrayList<String>());
		runSuccess = true;
		if (runSuccess) {
