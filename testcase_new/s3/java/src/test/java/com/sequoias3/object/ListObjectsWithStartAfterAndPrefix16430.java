...
/**
 * test content:  To get a list of objects within a bucket.specify startAfter/prefix/maxkeys. 
 *                match prefix , startAfter and maxkeys.
 * testlink-case: seqDB-16430              
 * @author wuyan
 * @Date 2018.11.27
 * @version 1.00
 */
public class ListObjectsWithStartAfterAndPrefix16430 extends S3TestBase{
	...
	public void testListObjects() throws Exception {	
		...
		//test b: query returns results multiple times, each return nums is maxkeys
		int startAfterNoB = 4;
		int maxKeysB = 5;
	...
	private void listObjectsAndCheckResult( List<String> keyList, int startAfterNo,
		...
		do{		
			...
			if ( maxKeys < keyList.size()){
				...
				Assert.assertEquals(oneQueryKeyList.size(), expMatchObjectNums);	
			}
