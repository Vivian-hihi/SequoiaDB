...
/**
 * test content: 带versionId查询对象，不匹配ifModifiedSince条件 
 * testlink-case: seqDB-16684 
 * @author wangkexin
 * @Date 2018.12.10
 * @version 1.00
 */
...
public class TestGetObjectMetadata16684  extends S3TestBase{
	...
	private void testGetObjectMetadata() throws Exception {
	    ...
	    try{
	    	...
	    	Assert.fail("getting objects that have not been modified within a specified time should fail!");
	    } catch(Exception e){
