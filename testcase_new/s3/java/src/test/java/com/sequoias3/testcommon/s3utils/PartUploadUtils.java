...
public class PartUploadUtils extends S3TestBase {
	 ...
	 */
	public static List<PartETag> partUpload(AmazonS3 s3Client, String bucketName, String key, String uploadId,
			File file) {
	 ...
	 */
	public static CompleteMultipartUploadResult completeMultipartUpload(AmazonS3 s3Client, String bucketName,
			String key, String uploadId, List<PartETag> partEtags) {
		CompleteMultipartUploadRequest completeRequest = new CompleteMultipartUploadRequest().withBucketName(bucketName)
				.withKey(key).withUploadId(uploadId).withPartETags(partEtags);
	 ...
	 * @param uploadId
	 */
	public static void checkAbortMultipartUploadResult(AmazonS3 s3Client, String bucketName, String keyName,
			String uploadId) {
	 ...
	 *            *
	 */
	public static void listPartsAndCheckPartNumbers(AmazonS3 s3Client, String bucketName, String keyName,
	 ...
	 */
	public static void checkListMultipartUploadsResults(MultipartUploadListing result, List<String> expCommonPrefixes,
