...
public class ListMultipartUploads18740 extends S3TestBase {
    ...
    public void uploadParts() throws Exception {
        ...
        List<PartETag> partEtags = PartUploadUtils.partUpload(s3Client, bucketName, keyName, uploadIdA, file);
        PartUploadUtils.completeMultipartUpload(s3Client, bucketName, keyName, uploadIdA, partEtags);
        ...
        PartUploadUtils.partUpload(s3Client, bucketName, keyName, uploadIdB, file);
