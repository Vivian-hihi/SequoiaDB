...
public class ChangeConfigurationMode17312 extends S3TestBase {
    ...
    public void testCreateRegion() throws Exception {
        ...
        oldRegion_1.withName(specifiedRegionName).withMetaLocation(metaCSName + "." + metaClNames[0])
        ...
        newRegion_1.withName(specifiedRegionName).withDataCSShardingType("year").withDataCLShardingType("month");
        ...
        newRegion_2.withName(shardingTypeRegionName).withMetaLocation(metaCSName + "." + metaClNames[0])
                .withMetaHisLocation(metaCSName + "." + metaClNames[1])
                .withDataLocation(dataCSName + "." + dataClName[0]);
