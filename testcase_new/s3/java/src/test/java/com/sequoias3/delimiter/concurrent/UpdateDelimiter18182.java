...
public class UpdateDelimiter18182 extends S3TestBase {
	...
	private String[] objectNames = { "dir1/dir2/test18182_1%aa.txt", "dir1/dir2/%test18182_2?bb.txt",
			"dir1/dir2?test%18182_3.txt", "test18182_4.txt" };
	...
	private void setUp() throws Exception {
		...
		for (int i = 0; i < objectNames.length; i++) {
			s3Client.putObject(bucketName, objectNames[i], "object_file18182");
		}
	}
