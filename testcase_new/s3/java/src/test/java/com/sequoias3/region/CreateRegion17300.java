...
public class CreateRegion17300 extends S3TestBase {
    ...
    private void test(String regionName, String dataDomain, String metaDomain, String expDataDomain,
        ...
        Region expRegion = new Region().withDataCSShardingType("year").withDataCLShardingType("year")
                .withDataDomain(expDataDomain).withMetaDomain(expMeatDomain).withName(regionName).withDataLocation("")
                .withMetaHisLocation("").withMetaLocation("").withDataLobPageSize("262144").withDataReplSize("-1");
