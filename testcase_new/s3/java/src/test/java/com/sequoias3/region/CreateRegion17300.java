...
public class CreateRegion17300 extends S3TestBase{
    ...
    private void test(String regionName,String dataDomain, String metaDomain, String expDataDomain, String expMeatDomain) throws Exception {
        //create region
        ...
        //expResult
        Region expRegion = new Region().withDataCSShardingType("year").withDataCLShardingType("year")
                .withDataDomain(expDataDomain)
                .withMetaDomain(expMeatDomain)
                .withName(regionName)
                .withDataLocation("")
                .withMetaHisLocation("")
                .withMetaLocation("");
    ...
    private void checkGetResult( GetRegionResult result,Region expRegion,List<String> expBuckets){
       ...
       for(int i = 0; i < expBuckets.size(); i++){
           Assert.assertEquals(buckets.get(i).getName(),expBuckets.get(i));
       }
    }
}
