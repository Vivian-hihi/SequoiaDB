...
/**
 * test content: 并发不同条件查询对象列表 
 * testlink-case: seqDB-16486
 * @author wangkexin
 * @Date 2019.01.03
 * @version 1.00
 */
public class GetObjectList16486 extends S3TestBase {
	...
	private void setUp() throws Exception {
		...
		s3Client.putObject(bucketName, "/testa", "object_file16486");
		s3Client.putObject(bucketName, "/testb", "object_file16486");
