...
public class UploadPart18678 extends S3TestBase {
	...
	public Object[][] generateFileSize() {
		return new Object[][] {
				...
				// small
				new Object[] { 1024 * 1024 * 40, 1024 * 1024 * 5, 1024 * 1024 * 9, 1024 * 1024 * 8, 1024 * 1024 * 7,
						1024 * 1024 * 6 }, };
	}
	...
	public void uploadParts(int fileSize, long eachPartSize, long secondPartSize, long thirdPartSize,
			long fourthPartSize, long fifthPartSize) throws Exception {
		...
		List<PartETag> partEtags = partUpload(uploadId, file, eachPartSize, secondPartSize, thirdPartSize,
				fourthPartSize, fifthPartSize);
	...
	private List<PartETag> partUpload(String uploadId, File file, long partSize, long secondPartSize,
			long thirdPartSize, long fourthPartSize, long fifthPartSize) {
