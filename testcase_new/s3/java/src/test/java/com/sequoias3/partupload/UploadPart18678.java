...
public class UploadPart18678 extends S3TestBase {
	...
	public Object[][] generateFileSize(){
		return new Object[][]{
			//the parameter : fileSize,eachPartSize,secondPartSize,thirdPartSize,fourthPartSize,fifthPartSize
			//test a: the length of the middle parts is inconsistent
			new Object[]{1024 * 1024 * 45, 1024 * 1024 * 8, 1024 * 1024 * 5, 1024 * 1024 * 9, 1024 * 1024 * 9, 1024 * 1024 * 6},
			//test b: the length of the middle parts grows from samll to large
			new Object[]{1024 * 1024 * 40, 1024 * 1024 * 7, 1024 * 1024 * 5, 1024 * 1024 * 6, 1024 * 1024 * 7, 1024 * 1024 * 8},
			//test c: the length of the middle parts grows from large to small			
			new Object[]{1024 * 1024 * 40, 1024 * 1024 * 5, 1024 * 1024 * 9, 1024 * 1024 * 8, 1024 * 1024 * 7, 1024 * 1024 * 6},			
		};
	}
	...
	public void uploadParts( int fileSize,long eachPartSize,long secondPartSize,long thirdPartSize,long fourthPartSize,long fifthPartSize ) throws Exception {	
		...
		List<PartETag> partEtags = partUpload(uploadId, file,eachPartSize,secondPartSize,thirdPartSize,fourthPartSize,fifthPartSize);
		PartUploadUtils.completeMultipartUpload(s3Client, bucketName, keyName, uploadId, partEtags);
		
		
		// down file,SEQUOIADBMAINSTREAM-4758		
	...
	private  List<PartETag> partUpload(String uploadId, File file,long partSize,long secondPartSize,long thirdPartSize,long fourthPartSize,long fifthPartSize){
		...
		for( int i = 1; filePosition < fileSize; i++){
			...
			System.out.println("--i="+i+"--partnum="+uploadPartResult.getPartNumber()+"--postition="+filePosition +"--uploadSize="+eachPartSize);
		}	
		return partEtags;
	}
}
