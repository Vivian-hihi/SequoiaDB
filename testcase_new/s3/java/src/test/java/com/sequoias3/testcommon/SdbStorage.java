...
public class SdbStorage implements StorageInterface {
    ...
    public void envPrePare(String coordUrl) {
        ...
        System.out.println("Start preparing for the operating environment...");
        modifyNodeConf(coordUrl, configs, null);
        System.out.println("Preparing for operation environment is completed....");
    }
    ...
    public void envRestore(String coordUrl) {
        ...
        System.out.println("Restoring the sequoiadb environment is complete...");
    }
    ...
    public String getUrls(String coordUrl) {
        ...
        try (Sequoiadb sdb = new Sequoiadb(coordUrl, "", "")) {
            ...
            for (Object gtoupObj : groupInfo.toArray()) {
                ...
                BSONObject service = (BSONObject) ((BasicBSONList) groupObj.get("Service")).get(0);
    ...
    private static void modifyNodeConf(String coordUrl, BSONObject configs, BSONObject options) {
        if (options == null) {
