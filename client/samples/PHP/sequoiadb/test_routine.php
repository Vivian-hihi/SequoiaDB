...
if ( $sdb )
{
   ...
   if ( $cs )
   {
      ...
      if ( $cl )
      {
         ...
         echo '<p>17. update current record</p>' ;
         ...
         echo '<p>18. get current record</p>' ;
         // get current record
         ...
         echo '<p>19. delete current record</p>' ;
         // get current record
         var_dump ( $cl_cursor->deleteCurrent() ) ;
         echo "<br><br>" ;
         
         echo '<p>20. remove all record</p>' ;
         // remove all record
         var_dump ( $cl->remove() ) ;
         echo "<br><br>" ;
         
         echo '<p>21. delete collection</p>' ;
         // delete collection
         var_dump ( $cl->drop() ) ;
         echo "<br><br>" ;
      }// if $cl
      echo '<p>22. delete collection space</p>' ;
      // delete collection
      var_dump ( $cs->drop() ) ;
      echo "<br><br>" ;
   }// if $cs
   
   echo '<p>23. reset snapshot</p>' ;
   // reset Snapshot
   var_dump ( $sdb->resetSnapshot() ) ;
   echo "<br><br>" ;
   
   echo '<p>24. get snapshot</p>' ;
   // reset Snapshot
