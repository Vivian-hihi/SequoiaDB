...
class Domain_Test extends PHPUnit_Framework_TestCase
{
    ...
    */
   public function test_alter( $db, $domain )
   {
    ...
    * @depends test_getDomain
    */
   public function test_listCS( $db, $domain )
   {
    ...
    * @depends test_getDomain
    */
   public function test_listCL( $db, $domain )
   {
    ...
    * @depends test_getDomain
    */
   public function test_listGroup( $db, $domain )
   {
