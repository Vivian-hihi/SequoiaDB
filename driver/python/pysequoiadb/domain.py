...
class domain(object):
    ...
    def add_groups(self, options):
        ...
        rc = sdb.domain_add_groups(self._domain, bson_options)
        raise_if_error(rc, "Failed to add groups of domain: %s" % self._domain_name)

    def set_groups(self, options):
        ...
        raise_if_error(rc, "Failed to set groups of domain: %s" % self._domain_name)

    def remove_groups(self, options):
    ...
    def set_attributes(self, options):
        ...
        rc = sdb.domain_set_attributes(self._domain, bson_options)
        raise_if_error(rc, "Failed to set attributes of domain: %s" % self._domain_name)
