...
public:
   ...
   /** \fn SequoiaCollection selectCollection ( string $name, [array|string $options] )
   ...
   */
   SequoiaCollection selectCollection ( string $name, array|string $options ) ;
