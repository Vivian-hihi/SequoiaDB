...
PHP_MINIT_FUNCTION(sequoiadb)
{
   ...
   PHP_REGISTER_LONG_CONSTANT( "SDB_LIST_CS_IN_DOMAIN",     11 ) ;
   PHP_REGISTER_LONG_CONSTANT( "SDB_LIST_CL_IN_DOMAIN",     12 ) ;
   ...
   //explain
   PHP_REGISTER_LONG_CONSTANT( "SDB_FLG_QUERY_EXPLAIN",        0x00000400 ) ;
