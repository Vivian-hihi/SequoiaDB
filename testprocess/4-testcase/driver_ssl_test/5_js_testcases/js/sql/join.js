...
try
{
	var cur = db.exec("select s.Sname,s.Sdept,g.Cno,g.Grade from "+CSPREFIX_CS+"."+CSPREFIX_CL+" as s"+" inner join "+CSPREFIX_CS+"."+CSPREFIX_CL1+" as g"+" on s.Sno=g.Sno order by g.Cno");
}
catch(e)
{
