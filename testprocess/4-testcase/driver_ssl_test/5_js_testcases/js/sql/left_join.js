...
try{
   ...
   var res = db.exec("select A.name , B.user , A.id from "+CSPREFIX_CS+"."+CSPREFIX_CL+" as A left outer join "+CSPREFIX_CS+"."+CSPREFIX_CL1+ " as B on A.id=B.id order by A.id asc");	
}catch( e ){
...
try{
   ...
   var res = db.exec("select A.name , B.user , B.id from "+CSPREFIX_CS+"."+CSPREFIX_CL+" as A left outer join "+CSPREFIX_CS+"."+CSPREFIX_CL1+ " as B on A.id=B.id order by A.id desc");	
}catch( e ){
