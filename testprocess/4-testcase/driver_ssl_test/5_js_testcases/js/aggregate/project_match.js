...
try
{
	var rc = cl.aggregate({$project:{no:1,"info.name":1,major:1,dep:1}},{$match:{$and:[{no:{$gt:1001,$lt:1012}},{dep:"计算机学院"}]}});
}
catch(e)
{
...
if( i != 4 )
{
	...
	println(cl.aggregate({$project:{no:1,"info.name":1,major:1,dep:1}},{$match:{$and:[{no:{$gt:1001,$lt:1012}},{dep:"计算机学院"}]}}));
	throw -1 ;
}
