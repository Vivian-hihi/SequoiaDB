...
println("********************************************");
try{
	var sel1 = varCL.find({$or:[{a:1},{a:{$exists:0}}]}).sort({b:1}).hint({"":CSPREFIX_IDX});
}catch(e){
...
println("********************************************");
try{
	var sel2 = varCL.find({$or:[{a:{$gt:0}},{b:{$lt:2}}]}).sort({b:1}).hint({"":CSPREFIX_IDX});
}catch(e){
...
println("********************************************");
try{
	var sel3 = varCL.find({$not:[{a:{$ne:1}},{b:{$lt:101}}]}).sort({b:1}).hint({"":CSPREFIX_IDX});
}catch(e){
