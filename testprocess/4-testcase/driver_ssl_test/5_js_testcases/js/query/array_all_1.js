/* *****************************************************************************
@discretion: array: $all without index
@modify list:
...
println("********************************************");
try{
	var sel1 = varCL.find({a:{$all:[1,2,3]}}).sort({b:1});
}catch(e){
...
println("********************************************");
try{
	var sel2 = varCL.find({a:{$all:[3,1]}}).sort({b:1});
}catch(e){
...
println("********************************************");
try{
	var sel3 = varCL.find({a:{$all:[1,2,3,4]}});
}catch(e){
