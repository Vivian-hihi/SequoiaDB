/* *****************************************************************************
@discretion: array: match with index
@modify list:
...
println("********************************************");
try{
	var sel1 = varCL.find({a:[1,2,3]}).hint({"":CSPREFIX_IDX});
}catch(e){
...
println("********************************************");
try{
	var sel2 = varCL.find({a:[1]}).hint({"":CSPREFIX_IDX});
}catch(e){
...
println("********************************************");
try{
	var sel3 = varCL.find({a:[1,2,3,4]}).hint({"":CSPREFIX_IDX});
}catch(e){
...
println("********************************************");
try{
	var sel4 = varCL.find({a:[]}).hint({"":CSPREFIX_IDX});
}catch(e){
