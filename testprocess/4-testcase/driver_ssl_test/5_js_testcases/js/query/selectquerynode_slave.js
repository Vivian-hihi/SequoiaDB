/*******************************************************************************
*@Description : test query ['db.setSessionAttr({"PreferedInstance":'A'})'].
*               Using db.snapshot(6) inspect
*@Modify list :
*               2014-11-20  xiaojun Hu  changed
*******************************************************************************/
...
function main( db )
{
   ...
   // set session attribution [TestPoint]
   db.setSessionAttr({"PreferedInstance":'S'});
   println("SessionAttr({\"PreferedInstance\":\'S\'})");
   // 原来的读次数
