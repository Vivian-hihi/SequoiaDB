...
//createCL , split in a
var varCL = varCS.createCL(CSPREFIX_CL,{ShardingKey:{name:1} , ReplSize:claSize.ReplSize(),Compressed:true});
...
var json_in = [{first:"James",last:"Queeen"} , {first:"James",last:"Band"} , {first:"Queeen",last:"Queeen"} , {first:"Queeen",last:"Band"} , {first:"Band",last:"Queeen"}];
...
if( 2 == arrGroupName.length )
{
        for(var i=0; i !=arrGroupName.length ;++i){
                ...
                if( PGname != arrGroupName[i][0] ){
                        ...
                        try{
                           varCL.split( PGname,arrGroupName[i][0],{name:{first:"James",last:"Band"}} );
                ...
                if( PGname != arrGroupName[i][0] ){
                        ...
                        if( _PGname != arrGroupName[i][0] ){
                                ...
                                try{
                                        ...
                                        varCL.split( PGname,arrGroupName[i][0],{name:json_in[t]} );
                                        while( catadb.SYSCAT.SYSTASKS.find().count() != 0 );
