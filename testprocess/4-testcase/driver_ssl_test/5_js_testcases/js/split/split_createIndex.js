...
try
{
	db.getCS(CSPREFIX_CS).getCL(CSPREFIX_CL).dropIndex("id_Index");
}
catch(e)
{
	println("first drop Index:"+e);
}
try //create Index
{
	db.getCS(CSPREFIX_CS).getCL(CSPREFIX_CL).createIndex("id_Index",{id:1},true);
}
catch(e)
{
	println(e);
