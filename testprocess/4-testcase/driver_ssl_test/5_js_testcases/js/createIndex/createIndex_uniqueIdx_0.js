...
function main( db )
{
   ...
   createIndex( idxCL, "nameIndex", {name:-1}, true, false ) ;
   createIndex( idxCL, "姓名索引", {"姓名":1}, true, false ) ;
   createIndex( idxCL, "ageIndex", {"age":1}, true, false ) ;
   ...
   try
   {
      ...
      idxCL.insert({no:004,name:"D","姓名":"庄"}) ;
