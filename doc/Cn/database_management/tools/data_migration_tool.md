...
###CSV类型###
 ...
 | autodate | - | 日期类型，取值范围为-9999-01-01~9999-12-31，不支持类型自动判断 |
 | timestamp | - | 时间戳类型，取值范围为1901-12-15-00.00.00.000000~2038-01-18-23.59.59.999999，不支持类型自动判断 | 
 | autotimestamp | - | 时间戳类型，取值范围为1901-12-15-00.00.00.000000~2038-01-18-23.59.59.999999，不支持类型自动判断 | 
