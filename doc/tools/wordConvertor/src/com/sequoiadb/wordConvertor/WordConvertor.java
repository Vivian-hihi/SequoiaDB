...
public class WordConvertor {
    ...
    public void htmlToWord(String htmlFile, String outWordFile){
        ...
        try{
            ...
            Dispatch doc = Dispatch.invoke(documents, "Open", Dispatch.Method, 
                    new Object[]{htmlFile, new Variant(false), new Variant(true)}, 
                    new int[1]).toDispatch();
            
            Dispatch.invoke(doc, "SaveAs", Dispatch.Method, new Object[]{
                    outWordFile, new Variant(1) }, new int[1]);
    ...
    private void setHeaderFooter(ActiveXComponent app, Dispatch doc, String headerText){
        ...
        //the page number
        Dispatch.call(fields, "Add", Dispatch.get(selection, "Range").toDispatch(), 
                new Variant(-1), "Page", true).toDispatch();
        Dispatch.call(selection, "TypeText", "/");
        //total page numbers
        Dispatch.call(fields, "Add", Dispatch.get(selection, "Range").toDispatch(), 
                new Variant(-1), "NumPages", true).toDispatch();
    }
    ...
    private void adjustPicture(Dispatch doc) {
        ...
        for(int i = 1; i <= count; i++){
            ...
            if( type == 4 || type == 3){
                ...
                logger.debug("picture[" + i + "]:width=" + width + ",height=" + height
    ...
    private void addTablesOfContent(ActiveXComponent app){
        ...
        Dispatch tableOfContent = Dispatch.get(activeDocument, 
                "TablesOfContents").toDispatch();
        
        Dispatch.put(tableOfContent, "Format", new Variant(0));
        Dispatch.call(tableOfContent, "Add", range, new Variant(true),
...
//                + "basic_operation\\indexes.doc";
    ...
    private Dispatch saveAndReopen(Dispatch documents, Dispatch doc, 
            String wordFile){
    ...
    public void adjust(String wordFile, Boolean hasTableOfContent) {
        ActiveXComponent app = new ActiveXComponent("Word.Application");
        Dispatch doc = null;
        try{
            app.setProperty("Visible", new Variant(false));
            ...
            logger.info("start to adjust tables");
            adjustTables(doc);
        }
        catch(Exception e){
            e.printStackTrace();
