...
[^_^]:
     本文使用的所有链接和引用
[authentication_algorithm]:manual/Security/authentication_algorithm.md
[network_security]:manual/Security/network_security.md
[auditlog]:manual/DiagLog/auditlog.md
[passwd]:manual/database_management/tools/sdbpasswd.md
