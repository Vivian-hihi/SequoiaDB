...
- 用于更新操作的更新规则中，支持的更新符包括 [$inc](reference/operator/update_operator/inc.md)、[$set](reference/operator/update_operator/set.md)、[$pop](reference/operator/update_operator/pop.md)、[$pull](reference/operator/update_operator/pull.md)、[$pull_by](reference/operator/update_operator/pull_by.md) 及 [$push](reference/operator/update_operator/push.md)，语法格式如下：
