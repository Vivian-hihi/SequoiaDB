...
1. 进入 **部署 - 主机** 页面。
   ...
   ![删除主机](images/sac/deployment/host/uninstall_host_1.png)

2. 选择要删除的主机，可以点击 **全选** 按钮选择全部。

   ![删除主机](images/sac/deployment/host/uninstall_host_2.png)

3. 点击 **删除主机 - 卸载主机**。

   ![删除主机](images/sac/deployment/host/uninstall_host_3.png)

4. 等待任务完成。

   ![删除主机](images/sac/deployment/host/uninstall_host_4.png)

5. 卸载完成。

   ![删除主机](images/sac/deployment/host/uninstall_host_5.png)