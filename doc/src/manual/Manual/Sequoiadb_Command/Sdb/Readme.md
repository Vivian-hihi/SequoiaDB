...
| [setCharsets()][setCharsets] | 设置客户端及返回结果集的字符集 |
| [setClientCharset()][setClientCharset] | 设置客户端的字符集 |
| [setResultsCharset()][setResultsCharset] | 设置返回结果集的字符集 |
...
[setCharsets]:manual/Manual/Sequoiadb_Command/Sdb/setCharsets.md
[setClientCharset]:manual/Manual/Sequoiadb_Command/Sdb/setClientCharset.md
[setResultsCharset]:manual/Manual/Sequoiadb_Command/Sdb/setResultsCharset.md
