...
setClientCharset - Set character set for client

##SYNOPSIS##

**db.setClientCharset(\<charset\>)**
...
This function is used to set character set for client.

## PARAMETERS ##

charset (*string, required*)

Specifies the character set name of the client. The optional value of this parameter is UTF8 or GB18030, which is not case sensitive.
...
Set character set for the client to GB18030.
