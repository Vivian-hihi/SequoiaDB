...
setResultsCharset - Set character set for result set

##SYNOPSIS##

**db.setResultsCharset(\<charset\>)**
...
This function is used to set character set for result set.
...
Set character set for the result set to GB18030.
