...
- MySQL 实例支持自增字段，MySQL 表自增字段对应 SequoiaDB 的集合[自增字段][sequence]，只保证趋势递增，不保证连续递增，使用时需注意以下事项:
...
[setAttributes]:reference/Sequoiadb_command/SdbCollection/setAttributes.md