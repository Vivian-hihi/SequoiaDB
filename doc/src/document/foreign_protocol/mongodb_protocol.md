...
- 配置连接器 fap
  ...
  > **Note:**  
  >
  > * 如兼容 mongodb 2.6 版本，请添加配置“fap=fapmongo”；如兼容 mongodb 3.4 版本请添加配置“fap=fapmongo3”
...
- 查看 fap 端口
 ...
 $ netstat -anp | grep 11817
  ...
  tcp        0      0 127.0.0.1:11817         127.0.0.1:59606         ESTABLISHED 20462/sequoiadb(118
  ```
...
| create user | 是 | 是 |
| drop user | 是 | 是 |
| auth | 只支持 MONGODB-CR 算法 | 只支持 MONGODB-CR 算法 |
| logout | 是 | 是 |
