...
1. 从部署首页选择需要扩容的业务。
![业务选择](sac/deployment/extend_module/extend_1.jpg)
...
3. 进入修改业务页面，可以修改扩容的节点配置。
![修改业务](sac/deployment/extend_module/extend_3.jpg)
...
![修改业务](sac/deployment/extend_module/extend_edit_2.jpg)

6. 修改后的配置，点击下一步，开始安装。
![修改业务](sac/deployment/extend_module/extend_edit_3.jpg)

7. 等待安装完成。
![安装业务](sac/deployment/extend_module/extend_install_1.jpg)

8. 安装完成。
![安装业务](sac/deployment/extend_module/extend_install_2.jpg)
