...
2. 点击 **删除索引**，集合选 foo.bar，索引名选 Name，点击 **确定**。

   ![删除索引](sac/data_operation/index/drop_index_2.jpg)

3. 删除完成，foo.bar 的索引数变成1。

   ![删除索引](sac/data_operation/index/drop_index_3.jpg)
