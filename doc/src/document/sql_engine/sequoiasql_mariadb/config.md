...
| sql_mode               | Set    | Yes | Global, Session | STRICT_TRANS_TABLES,<br>ERROR_FOR_DIVISION_BY_ZERO,<br>NO_AUTO_CREATE_USER,<br>NO_ENGINE_SUBSTITUTION | SQL 模式，取值意义可参考[MariaDB SQL 模式](https://mariadb.com/kb/en/library/sql-mode/) |
