...
- 下载 [SequoiaDB 3.2 数据库安装包](http://cdn.sequoiadb.com/images/sequoiadb/x86_64/sequoiadb-3.2.1-linux_x86_64.tar.gz)，并上传到目标主机上
...
SequoiaDB 部署方案可以选择部署在单台机器上，或者部署在多台机器上。
