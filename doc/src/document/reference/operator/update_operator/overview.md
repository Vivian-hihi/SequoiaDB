...
| [$pull](reference/operator/update_operator/pull.md) | 清除指定数组中的指定值 | db.foo.bar.update({ $pull: {arr: 2, name: "Tom" } }) |
| [$pull_all](reference/operator/update_operator/pull_all.md) | 清除指定数组中的指定值 | db.foo.bar.update({ $pull_all: { arr: [2,3], name: ["Tom"] } }) |
