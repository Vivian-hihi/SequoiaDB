...
if guess_os == "linux":
	...
	# lz4 and zlib
    #env.Append( EXTRALIBPATH=[lz4_lib_dir] )
    #env.Append( EXTRALIBPATH=[zlib_lib_dir] )
    env.Append( LIBS=['lz4'] )
    env.Append( LIBS=['z'] )
    ...
    # TBD: Add libbraries for lz4 and zlib
...
# --- append lz4 and zlib library to env ---
#env.Append ( LIBS= [join(lz4_dir, "liblz4.a"] )
#env.Append ( LIBS= [join(zlib_dir, "libz.a"] )
testEnv = env.Clone()
